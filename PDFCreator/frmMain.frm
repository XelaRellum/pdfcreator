...
On Error GoTo ErrPtnr_OnError
'---ErrPtnr-OnError-END--- DO NOT MODIFY ! ---
50010  Dim B(1) As Boolean
50020  Me.KeyPreview = True
50030
50040  ReadAllLanguages LanguagePath
50050  InitProgram
50060
50070  ShowPaypalMenuimage
50080  SetGSRevision
50090
50100  If NoProcessing = True Or Options.NoProcessingAtStartup = 1 Then
50110   SetMenuPrinterStop
50120  End If
50130  If PrinterStop = True Then
50140   mnPrinter(0).Checked = True
50150  End If
50160  If Options.OptionsEnabled = 0 Then
50170   mnPrinter(2).Enabled = False
50180   tlb(0).Buttons(2).Enabled = False
50190  End If
50200  If Options.OptionsVisible = 0 Then
50210   tlb(0).Buttons(2).Visible = False
50220   mnPrinter(2).Visible = False
50230   mnPrinter(3).Visible = False
50240  End If
50250
50260  CheckPrintJobs
50270  Call SetDocMenuAndToolbar
50280  If (Options.Toolbars And 1) = 1 Then
50290    tlb(0).Visible = True
50300   Else
50310    tlb(0).Visible = False
50320  End If
50330  If (Options.Toolbars And 2) = 2 Then
50340    tlb(1).Visible = True
50350    txtEmailAddress.Visible = True
50360   Else
50370    tlb(1).Visible = False
50380    txtEmailAddress.Visible = False
50390  End If
50400  If PDFCreatorPrinter = False Or NoProcessing = True Or _
  Options.NoProcessingAtStartup = 1 Or (PDFCreatorPrinter = True And lsv.ListItems.Count > 1) Then
50420   Visible = True
50430   SetTopMost frmMain, True, True
50440   SetTopMost frmMain, False, True
50450   SetActiveWindow frmMain.hwnd
50460  End If
50470
50480  ' Only for the first time set interval to 10 ms
50490  Timer1.Interval = 10
50500  Timer1.Enabled = True
50510  Timer2.Interval = 100
50520  Timer2.Enabled = True
'---ErrPtnr-OnError-START--- DO NOT MODIFY ! ---
Exit Sub
ErrPtnr_OnError:
...
50600   mnView(0).Caption = .DialogViewStatusbar
50610
50620   mnLanguageMain.Caption = .DialogLanguage
50630
50640   mnHelpMain.Caption = .DialogInfo
50650   mnHelp(2).Caption = .DialogInfoPaypal
50660   mnHelp(4).Caption = .DialogInfoHomepage
50670   mnHelp(5).Caption = .DialogInfoPDFCreatorSourceforge
50680   mnHelp(6).Caption = .DialogInfoCheckUpdates
50690   mnHelp(8).Caption = .DialogInfoInfo
50700
50710   lsv.ColumnHeaders("Date").Text = .ListDate
50720   lsv.ColumnHeaders("Documenttitle").Text = .ListDocumenttitle
...
50090       End If
50100      Else
50110       If lsv.ListItems(1).SubItems(1) <> LanguageStrings.ListWaiting Then
50120        lsv.ListItems(1).SubItems(1) = LanguageStrings.ListWaiting
50130       End If
50140     End If
50150    Else
50160     If lsv.ListItems(1).SubItems(1) <> LanguageStrings.ListPrinting Then
50170      lsv.ListItems(1).SubItems(1) = LanguageStrings.ListPrinting
50180     End If
50190     PDFSpoolfile = lsv.ListItems(1).SubItems(4)
50200     If PrinterStop = False Then
50210      If IsFormLoaded(frmPrinting) = False Then
50220       If InstalledAsServer Then
50230        Options = ReadOptions
50240       End If
50250       If Options.UseAutosave = 1 Then
50260         Autosave
50270        Else
50280         frmPrinting.Show , Me
50290       End If
50300      End If
50310     End If
50320     If PrinterStop = False And NoProcessing = False Then
50330       mnPrinter(0).Checked = False
50340       tlb(0).Buttons(1).Image = 1
50350      Else
50360       mnPrinter(0).Checked = True
50370       tlb(0).Buttons(1).Image = 2
50380     End If
50390   End If
50400  End If
'---ErrPtnr-OnError-START--- DO NOT MODIFY ! ---
...
50740    If CLng(tFile(2)) > GB Then
50750      LItem.SubItems(3) = Format$(CDbl(tFile(2)) / GB, "0.00 " & LanguageStrings.ListGBytes)
50760     Else
50770      If CLng(tFile(2)) > MB Then
50780        LItem.SubItems(3) = Format$(CDbl(tFile(2)) / MB, "0.00 " & LanguageStrings.ListMBytes)
50790       Else
50800        If CLng(tFile(2)) > kB Then
50810          LItem.SubItems(3) = Format$(CDbl(tFile(2)) / kB, "0.00 " & LanguageStrings.ListKBytes)
50820         Else
50830          LItem.SubItems(3) = Format$(tFile(2), "0 " & LanguageStrings.ListBytes)
50840        End If
50850     End If
50860    End If
50870    LItem.SubItems(4) = tFile(1)
50880    DoEvents
50890   End If
50900  Next j
...
50820     End If
50830     If LvwGetCountSelectedItems(lsv, True) = 1 Then
...
51020     End If
51030     If LvwGetCountSelectedItems(lsv, True) = 1 Then
...
50390   txtEmailAddress.Enabled = False
50400   txtEmailAddress.Visible = False
50410   mnDocument(14).Enabled = False
50420   mnDocument(15).Enabled = False
50430   mnDocument(16).Enabled = False
50440   mnDocument(13).Visible = False
50450   mnDocument(14).Visible = False
50460   mnDocument(15).Visible = False
50470   mnDocument(16).Visible = False
50480  End If
50490  If (Options.Toolbars And 1) = 1 Then
50500    tlb(0).Visible = True
50510   Else
50520    tlb(0).Visible = False
50530  End If
50540  If (Options.Toolbars And 2) = 2 Then
50550    tlb(1).Visible = True
50560    txtEmailAddress.Visible = True
50570   Else
50580    tlb(1).Visible = False
50590    txtEmailAddress.Visible = False
50600  End If
'---ErrPtnr-OnError-START--- DO NOT MODIFY ! ---
Exit Sub
ErrPtnr_OnError:
...
50430     tFilename = GetTempFile(CompletePath(GetPDFCreatorTempfolder) & PDFCreatorSpoolDirectory, "~PS")
50440     DoEvents
...
50060    SysTrayLeave
50070   Case Is > 1
50080    mnPrinter_Click CInt(lIndex - 2)
50090  End Select
'---ErrPtnr-OnError-START--- DO NOT MODIFY ! ---
Exit Sub
ErrPtnr_OnError:
...
50200 '    m_frmSysTray.Icon = LoadResPicture(2120, vbResIcon)
50210    Else
50220     m_frmSysTray.IconHandle = imlSystray.ListImages(2).Picture.handle
50230 '    m_frmSysTray.Icon = LoadResPicture(2121, vbResIcon)
50240   End If
50250   Me.Hide
50260 '  m_frmSysTray.ShowBalloonTip "Here I am in the SysTray", _
