...
52350   .OptionsShellIntegration = Replace$(hLang.Retrieve("ShellIntegration", .OptionsShellIntegration), "/n", vbCrLf)
52360   .OptionsShellIntegrationAdd = Replace$(hLang.Retrieve("ShellIntegrationAdd", .OptionsShellIntegrationAdd), "/n", vbCrLf)
52370   .OptionsShellIntegrationCaption = Replace$(hLang.Retrieve("ShellIntegrationCaption", .OptionsShellIntegrationCaption), "/n", vbCrLf)
52380   .OptionsShellIntegrationRemove = Replace$(hLang.Retrieve("ShellIntegrationRemove", .OptionsShellIntegrationRemove), "/n", vbCrLf)
52390   .OptionsStandardAuthorToken = Replace$(hLang.Retrieve("StandardAuthorToken", .OptionsStandardAuthorToken), "/n", vbCrLf)
52400   .OptionsTestpage = Replace$(hLang.Retrieve("Testpage", .OptionsTestpage), "/n", vbCrLf)
52410   .OptionsTIFFColorscount01 = Replace$(hLang.Retrieve("TIFFColorscount01", .OptionsTIFFColorscount01), "/n", vbCrLf)
52420   .OptionsTIFFColorscount02 = Replace$(hLang.Retrieve("TIFFColorscount02", .OptionsTIFFColorscount02), "/n", vbCrLf)
52430   .OptionsTIFFColorscount03 = Replace$(hLang.Retrieve("TIFFColorscount03", .OptionsTIFFColorscount03), "/n", vbCrLf)
52440   .OptionsTIFFColorscount04 = Replace$(hLang.Retrieve("TIFFColorscount04", .OptionsTIFFColorscount04), "/n", vbCrLf)
52450   .OptionsTIFFColorscount05 = Replace$(hLang.Retrieve("TIFFColorscount05", .OptionsTIFFColorscount05), "/n", vbCrLf)
52460   .OptionsTIFFColorscount06 = Replace$(hLang.Retrieve("TIFFColorscount06", .OptionsTIFFColorscount06), "/n", vbCrLf)
52470   .OptionsTIFFColorscount07 = Replace$(hLang.Retrieve("TIFFColorscount07", .OptionsTIFFColorscount07), "/n", vbCrLf)
52480   .OptionsTIFFColorscount08 = Replace$(hLang.Retrieve("TIFFColorscount08", .OptionsTIFFColorscount08), "/n", vbCrLf)
52490   .OptionsTIFFDescription = Replace$(hLang.Retrieve("TIFFDescription", .OptionsTIFFDescription), "/n", vbCrLf)
52500   .OptionsTIFFSymbol = Replace$(hLang.Retrieve("TIFFSymbol", .OptionsTIFFSymbol), "/n", vbCrLf)
52510   .OptionsTreeFormats = Replace$(hLang.Retrieve("TreeFormats", .OptionsTreeFormats), "/n", vbCrLf)
52520   .OptionsTreeProgram = Replace$(hLang.Retrieve("TreeProgram", .OptionsTreeProgram), "/n", vbCrLf)
52530   .OptionsUseAutosave = Replace$(hLang.Retrieve("UseAutosave", .OptionsUseAutosave), "/n", vbCrLf)
52540   .OptionsUseAutosaveDirectory = Replace$(hLang.Retrieve("UseAutosaveDirectory", .OptionsUseAutosaveDirectory), "/n", vbCrLf)
52550   .OptionsUseCreationDateNow = Replace$(hLang.Retrieve("UseCreationDateNow", .OptionsUseCreationDateNow), "/n", vbCrLf)
52560   .OptionsUserPass = Replace$(hLang.Retrieve("UserPass", .OptionsUserPass), "/n", vbCrLf)
52570   .OptionsUseStandardauthor = Replace$(hLang.Retrieve("UseStandardauthor", .OptionsUseStandardauthor), "/n", vbCrLf)
52580  End With
52590  Set hLang = Nothing
'---ErrPtnr-OnError-START--- DO NOT MODIFY ! ---
Exit Sub
ErrPtnr_OnError:
...
53280   .OptionsShellIntegration = "Shell integration"
53290   .OptionsShellIntegrationAdd = "Integrate PDFCreator into shell"
53300   .OptionsShellIntegrationCaption = "Create &PDF with PDFCreator"
53310   .OptionsShellIntegrationRemove = "Remove shell integration"
53320   .OptionsStandardAuthorToken = "Add a Author-Token"
53330   .OptionsTestpage = "PDFCreator Testpage"
53340   .OptionsTIFFColorscount01 = "16777216 (24 Bit)"
53350   .OptionsTIFFColorscount02 = "4096 (12 Bit)"
53360   .OptionsTIFFColorscount03 = "2 colors (Black/White) G3 fax encoding with no EOLs"
53370   .OptionsTIFFColorscount04 = "2 colors (Black/White) G3 fax encoding with EOLs"
53380   .OptionsTIFFColorscount05 = "2 colors (Black/White) 2-D G3 fax encoding"
53390   .OptionsTIFFColorscount06 = "2 colors (Black/White) G4 fax encoding"
53400   .OptionsTIFFColorscount07 = "2 colors (Black/White) LZW-compatible"
53410   .OptionsTIFFColorscount08 = "2 colors (Black/White) PackBits"
53420   .OptionsTIFFDescription = "TIFF Format. For multipages use the tiff-format."
53430   .OptionsTIFFSymbol = "TIFF"
53440   .OptionsTreeFormats = "Formats"
53450   .OptionsTreeProgram = "Program"
53460   .OptionsUseAutosave = "Use Auto-save"
53470   .OptionsUseAutosaveDirectory = "Use this directory for auto-save"
53480   .OptionsUseCreationDateNow = "Use the current Date/Time for 'Creation Date'"
53490   .OptionsUserPass = "User Password"
53500   .OptionsUseStandardauthor = "Use standard author"
53510
53520   .PrintingAuthor = "A&uthor:"
53530   .PrintingBMPFiles = "BMP-Files"
53540   .PrintingCancel = "&Cancel"
53550   .PrintingCollect = "&Wait - Collect"
53560   .PrintingCreationDate = "Creation &Date:"
53570   .PrintingDocumentTitle = "Document &Title:"
53580   .PrintingEMail = "&eMail"
53590   .PrintingEPSFiles = "Encapsulated Postscript-Files"
53600   .PrintingJPEGFiles = "JPEG-Files"
53610   .PrintingKeywords = "&Keywords:"
53620   .PrintingModifyDate = "&Modify Date:"
53630   .PrintingNow = "Now"
53640   .PrintingPCXFiles = "PCX-Files"
53650   .PrintingPDFFiles = "PDF-Files"
53660   .PrintingPNGFiles = "PNG-Files"
53670   .PrintingPSFiles = "Postscript-Files"
53680   .PrintingSave = "&Save"
53690   .PrintingStartStandardProgram = "&After saving open the document with the default program."
53700   .PrintingStatus = "Creating file..."
53710   .PrintingSubject = "Su&bject:"
53720   .PrintingTIFFFiles = "TIFF-Files"
53730
53740   .SaveOpenAttributes = "Attributes"
53750   .SaveOpenCancel = "Cancel"
53760   .SaveOpenFilename = "Filename"
53770   .SaveOpenOpen = "Open"
53780   .SaveOpenOpenTitle = "Open"
53790   .SaveOpenSave = "Save"
53800   .SaveOpenSaveTitle = "Save as"
53810   .SaveOpenSize = "Size"
53820
53830  End With
'---ErrPtnr-OnError-START--- DO NOT MODIFY ! ---
Exit Sub
