...
51080   .OptionsPDFCompressionColorComp09 = Replace$(hLang.Retrieve("PDFCompressionColorComp09", .OptionsPDFCompressionColorComp09), "/n", vbCrLf)
51090   .OptionsPDFCompressionColorCompFac = Replace$(hLang.Retrieve("PDFCompressionColorCompFac", .OptionsPDFCompressionColorCompFac), "/n", vbCrLf)
51100   .OptionsPDFCompressionColorRes = Replace$(hLang.Retrieve("PDFCompressionColorRes", .OptionsPDFCompressionColorRes), "/n", vbCrLf)
51110   .OptionsPDFCompressionColorResample = Replace$(hLang.Retrieve("PDFCompressionColorResample", .OptionsPDFCompressionColorResample), "/n", vbCrLf)
51120   .OptionsPDFCompressionColorResample01 = Replace$(hLang.Retrieve("PDFCompressionColorResample01", .OptionsPDFCompressionColorResample01), "/n", vbCrLf)
51130   .OptionsPDFCompressionColorResample02 = Replace$(hLang.Retrieve("PDFCompressionColorResample02", .OptionsPDFCompressionColorResample02), "/n", vbCrLf)
51140   .OptionsPDFCompressionColorResample03 = Replace$(hLang.Retrieve("PDFCompressionColorResample03", .OptionsPDFCompressionColorResample03), "/n", vbCrLf)
51150   .OptionsPDFCompressionGrey = Replace$(hLang.Retrieve("PDFCompressionGrey", .OptionsPDFCompressionGrey), "/n", vbCrLf)
51160   .OptionsPDFCompressionGreyComp = Replace$(hLang.Retrieve("PDFCompressionGreyComp", .OptionsPDFCompressionGreyComp), "/n", vbCrLf)
51170   .OptionsPDFCompressionGreyComp01 = Replace$(hLang.Retrieve("PDFCompressionGreyComp01", .OptionsPDFCompressionGreyComp01), "/n", vbCrLf)
51180   .OptionsPDFCompressionGreyComp02 = Replace$(hLang.Retrieve("PDFCompressionGreyComp02", .OptionsPDFCompressionGreyComp02), "/n", vbCrLf)
51190   .OptionsPDFCompressionGreyComp03 = Replace$(hLang.Retrieve("PDFCompressionGreyComp03", .OptionsPDFCompressionGreyComp03), "/n", vbCrLf)
51200   .OptionsPDFCompressionGreyComp04 = Replace$(hLang.Retrieve("PDFCompressionGreyComp04", .OptionsPDFCompressionGreyComp04), "/n", vbCrLf)
51210   .OptionsPDFCompressionGreyComp05 = Replace$(hLang.Retrieve("PDFCompressionGreyComp05", .OptionsPDFCompressionGreyComp05), "/n", vbCrLf)
51220   .OptionsPDFCompressionGreyComp06 = Replace$(hLang.Retrieve("PDFCompressionGreyComp06", .OptionsPDFCompressionGreyComp06), "/n", vbCrLf)
51230   .OptionsPDFCompressionGreyComp07 = Replace$(hLang.Retrieve("PDFCompressionGreyComp07", .OptionsPDFCompressionGreyComp07), "/n", vbCrLf)
51240   .OptionsPDFCompressionGreyComp08 = Replace$(hLang.Retrieve("PDFCompressionGreyComp08", .OptionsPDFCompressionGreyComp08), "/n", vbCrLf)
51250   .OptionsPDFCompressionGreyComp09 = Replace$(hLang.Retrieve("PDFCompressionGreyComp09", .OptionsPDFCompressionGreyComp09), "/n", vbCrLf)
51260   .OptionsPDFCompressionGreyCompFac = Replace$(hLang.Retrieve("PDFCompressionGreyCompFac", .OptionsPDFCompressionGreyCompFac), "/n", vbCrLf)
51270   .OptionsPDFCompressionGreyRes = Replace$(hLang.Retrieve("PDFCompressionGreyRes", .OptionsPDFCompressionGreyRes), "/n", vbCrLf)
51280   .OptionsPDFCompressionGreyResample = Replace$(hLang.Retrieve("PDFCompressionGreyResample", .OptionsPDFCompressionGreyResample), "/n", vbCrLf)
51290   .OptionsPDFCompressionGreyResample01 = Replace$(hLang.Retrieve("PDFCompressionGreyResample01", .OptionsPDFCompressionGreyResample01), "/n", vbCrLf)
51300   .OptionsPDFCompressionGreyResample02 = Replace$(hLang.Retrieve("PDFCompressionGreyResample02", .OptionsPDFCompressionGreyResample02), "/n", vbCrLf)
51310   .OptionsPDFCompressionGreyResample03 = Replace$(hLang.Retrieve("PDFCompressionGreyResample03", .OptionsPDFCompressionGreyResample03), "/n", vbCrLf)
51320   .OptionsPDFCompressionMono = Replace$(hLang.Retrieve("PDFCompressionMono", .OptionsPDFCompressionMono), "/n", vbCrLf)
51330   .OptionsPDFCompressionMonoComp = Replace$(hLang.Retrieve("PDFCompressionMonoComp", .OptionsPDFCompressionMonoComp), "/n", vbCrLf)
51340   .OptionsPDFCompressionMonoComp01 = Replace$(hLang.Retrieve("PDFCompressionMonoComp01", .OptionsPDFCompressionMonoComp01), "/n", vbCrLf)
51350   .OptionsPDFCompressionMonoComp02 = Replace$(hLang.Retrieve("PDFCompressionMonoComp02", .OptionsPDFCompressionMonoComp02), "/n", vbCrLf)
51360   .OptionsPDFCompressionMonoComp03 = Replace$(hLang.Retrieve("PDFCompressionMonoComp03", .OptionsPDFCompressionMonoComp03), "/n", vbCrLf)
51370   .OptionsPDFCompressionMonoComp04 = Replace$(hLang.Retrieve("PDFCompressionMonoComp04", .OptionsPDFCompressionMonoComp04), "/n", vbCrLf)
51380   .OptionsPDFCompressionMonoRes = Replace$(hLang.Retrieve("PDFCompressionMonoRes", .OptionsPDFCompressionMonoRes), "/n", vbCrLf)
51390   .OptionsPDFCompressionMonoResample = Replace$(hLang.Retrieve("PDFCompressionMonoResample", .OptionsPDFCompressionMonoResample), "/n", vbCrLf)
51400   .OptionsPDFCompressionMonoResample01 = Replace$(hLang.Retrieve("PDFCompressionMonoResample01", .OptionsPDFCompressionMonoResample01), "/n", vbCrLf)
51410   .OptionsPDFCompressionMonoResample02 = Replace$(hLang.Retrieve("PDFCompressionMonoResample02", .OptionsPDFCompressionMonoResample02), "/n", vbCrLf)
51420   .OptionsPDFCompressionMonoResample03 = Replace$(hLang.Retrieve("PDFCompressionMonoResample03", .OptionsPDFCompressionMonoResample03), "/n", vbCrLf)
51430   .OptionsPDFCompressionTextComp = Replace$(hLang.Retrieve("PDFCompressionTextComp", .OptionsPDFCompressionTextComp), "/n", vbCrLf)
51440   .OptionsPDFDescription = Replace$(hLang.Retrieve("PDFDescription", .OptionsPDFDescription), "/n", vbCrLf)
51450   .OptionsPDFDisallowCopy = Replace$(hLang.Retrieve("PDFDisallowCopy", .OptionsPDFDisallowCopy), "/n", vbCrLf)
51460   .OptionsPDFDisallowModify = Replace$(hLang.Retrieve("PDFDisallowModify", .OptionsPDFDisallowModify), "/n", vbCrLf)
51470   .OptionsPDFDisallowModifyComments = Replace$(hLang.Retrieve("PDFDisallowModifyComments", .OptionsPDFDisallowModifyComments), "/n", vbCrLf)
51480   .OptionsPDFDisallowPrint = Replace$(hLang.Retrieve("PDFDisallowPrint", .OptionsPDFDisallowPrint), "/n", vbCrLf)
51490   .OptionsPDFDisallowUser = Replace$(hLang.Retrieve("PDFDisallowUser", .OptionsPDFDisallowUser), "/n", vbCrLf)
...
51990   .OptionsPDFSigningP12Files = Replace$(hLang.Retrieve("PDFSigningP12Files", .OptionsPDFSigningP12Files), "/n", vbCrLf)
52000   .OptionsPDFSigningPfxFiles = Replace$(hLang.Retrieve("PDFSigningPfxFiles", .OptionsPDFSigningPfxFiles), "/n", vbCrLf)
52010   .OptionsPDFSigningPfxP12Files = Replace$(hLang.Retrieve("PDFSigningPfxP12Files", .OptionsPDFSigningPfxP12Files), "/n", vbCrLf)
52020   .OptionsPDFSigningSignatureContact = Replace$(hLang.Retrieve("PDFSigningSignatureContact", .OptionsPDFSigningSignatureContact), "/n", vbCrLf)
52030   .OptionsPDFSigningSignatureLocation = Replace$(hLang.Retrieve("PDFSigningSignatureLocation", .OptionsPDFSigningSignatureLocation), "/n", vbCrLf)
52040   .OptionsPDFSigningSignatureMultiSignature = Replace$(hLang.Retrieve("PDFSigningSignatureMultiSignature", .OptionsPDFSigningSignatureMultiSignature), "/n", vbCrLf)
52050   .OptionsPDFSigningSignatureOnPage = Replace$(hLang.Retrieve("PDFSigningSignatureOnPage", .OptionsPDFSigningSignatureOnPage), "/n", vbCrLf)
52060   .OptionsPDFSigningSignaturePosition = Replace$(hLang.Retrieve("PDFSigningSignaturePosition", .OptionsPDFSigningSignaturePosition), "/n", vbCrLf)
52070   .OptionsPDFSigningSignaturePositionLeftX = Replace$(hLang.Retrieve("PDFSigningSignaturePositionLeftX", .OptionsPDFSigningSignaturePositionLeftX), "/n", vbCrLf)
52080   .OptionsPDFSigningSignaturePositionLeftY = Replace$(hLang.Retrieve("PDFSigningSignaturePositionLeftY", .OptionsPDFSigningSignaturePositionLeftY), "/n", vbCrLf)
52090   .OptionsPDFSigningSignaturePositionRightX = Replace$(hLang.Retrieve("PDFSigningSignaturePositionRightX", .OptionsPDFSigningSignaturePositionRightX), "/n", vbCrLf)
52100   .OptionsPDFSigningSignaturePositionRightY = Replace$(hLang.Retrieve("PDFSigningSignaturePositionRightY", .OptionsPDFSigningSignaturePositionRightY), "/n", vbCrLf)
52110   .OptionsPDFSigningSignatureReason = Replace$(hLang.Retrieve("PDFSigningSignatureReason", .OptionsPDFSigningSignatureReason), "/n", vbCrLf)
52120   .OptionsPDFSigningSignatureVisible = Replace$(hLang.Retrieve("PDFSigningSignatureVisible", .OptionsPDFSigningSignatureVisible), "/n", vbCrLf)
52130   .OptionsPDFSigningSignPdfFile = Replace$(hLang.Retrieve("PDFSigningSignPdfFile", .OptionsPDFSigningSignPdfFile), "/n", vbCrLf)
52140   .OptionsPDFSymbol = Replace$(hLang.Retrieve("PDFSymbol", .OptionsPDFSymbol), "/n", vbCrLf)
52150   .OptionsPDFUserPass = Replace$(hLang.Retrieve("PDFUserPass", .OptionsPDFUserPass), "/n", vbCrLf)
52160   .OptionsPDFUseSecurity = Replace$(hLang.Retrieve("PDFUseSecurity", .OptionsPDFUseSecurity), "/n", vbCrLf)
52170   .OptionsPNGColorscount01 = Replace$(hLang.Retrieve("PNGColorscount01", .OptionsPNGColorscount01), "/n", vbCrLf)
52180   .OptionsPNGColorscount02 = Replace$(hLang.Retrieve("PNGColorscount02", .OptionsPNGColorscount02), "/n", vbCrLf)
52190   .OptionsPNGColorscount03 = Replace$(hLang.Retrieve("PNGColorscount03", .OptionsPNGColorscount03), "/n", vbCrLf)
52200   .OptionsPNGColorscount04 = Replace$(hLang.Retrieve("PNGColorscount04", .OptionsPNGColorscount04), "/n", vbCrLf)
52210   .OptionsPNGColorscount05 = Replace$(hLang.Retrieve("PNGColorscount05", .OptionsPNGColorscount05), "/n", vbCrLf)
52220   .OptionsPNGDescription = Replace$(hLang.Retrieve("PNGDescription", .OptionsPNGDescription), "/n", vbCrLf)
52230   .OptionsPNGFiles = Replace$(hLang.Retrieve("PNGFiles", .OptionsPNGFiles), "/n", vbCrLf)
52240   .OptionsPNGSymbol = Replace$(hLang.Retrieve("PNGSymbol", .OptionsPNGSymbol), "/n", vbCrLf)
52250   .OptionsPrintAfterSaving = Replace$(hLang.Retrieve("PrintAfterSaving", .OptionsPrintAfterSaving), "/n", vbCrLf)
52260   .OptionsPrintAfterSavingBitsPerPixel = Replace$(hLang.Retrieve("PrintAfterSavingBitsPerPixel", .OptionsPrintAfterSavingBitsPerPixel), "/n", vbCrLf)
52270   .OptionsPrintAfterSavingBitsPerPixelCMYK = Replace$(hLang.Retrieve("PrintAfterSavingBitsPerPixelCMYK", .OptionsPrintAfterSavingBitsPerPixelCMYK), "/n", vbCrLf)
52280   .OptionsPrintAfterSavingBitsPerPixelMono = Replace$(hLang.Retrieve("PrintAfterSavingBitsPerPixelMono", .OptionsPrintAfterSavingBitsPerPixelMono), "/n", vbCrLf)
52290   .OptionsPrintAfterSavingBitsPerPixelTrueColor = Replace$(hLang.Retrieve("PrintAfterSavingBitsPerPixelTrueColor", .OptionsPrintAfterSavingBitsPerPixelTrueColor), "/n", vbCrLf)
52300   .OptionsPrintAfterSavingDuplex = Replace$(hLang.Retrieve("PrintAfterSavingDuplex", .OptionsPrintAfterSavingDuplex), "/n", vbCrLf)
52310   .OptionsPrintAfterSavingDuplexTumbleOff = Replace$(hLang.Retrieve("PrintAfterSavingDuplexTumbleOff", .OptionsPrintAfterSavingDuplexTumbleOff), "/n", vbCrLf)
52320   .OptionsPrintAfterSavingDuplexTumbleOn = Replace$(hLang.Retrieve("PrintAfterSavingDuplexTumbleOn", .OptionsPrintAfterSavingDuplexTumbleOn), "/n", vbCrLf)
52330   .OptionsPrintAfterSavingMaxResolution = Replace$(hLang.Retrieve("PrintAfterSavingMaxResolution", .OptionsPrintAfterSavingMaxResolution), "/n", vbCrLf)
52340   .OptionsPrintAfterSavingNoCancel = Replace$(hLang.Retrieve("PrintAfterSavingNoCancel", .OptionsPrintAfterSavingNoCancel), "/n", vbCrLf)
52350   .OptionsPrintAfterSavingPrinter = Replace$(hLang.Retrieve("PrintAfterSavingPrinter", .OptionsPrintAfterSavingPrinter), "/n", vbCrLf)
52360   .OptionsPrintAfterSavingQueryUser = Replace$(hLang.Retrieve("PrintAfterSavingQueryUser", .OptionsPrintAfterSavingQueryUser), "/n", vbCrLf)
52370   .OptionsPrintAfterSavingQueryUserDefaultPrinter = Replace$(hLang.Retrieve("PrintAfterSavingQueryUserDefaultPrinter", .OptionsPrintAfterSavingQueryUserDefaultPrinter), "/n", vbCrLf)
52380   .OptionsPrintAfterSavingQueryUserOff = Replace$(hLang.Retrieve("PrintAfterSavingQueryUserOff", .OptionsPrintAfterSavingQueryUserOff), "/n", vbCrLf)
52390   .OptionsPrintAfterSavingQueryUserPrinterSetupDialog = Replace$(hLang.Retrieve("PrintAfterSavingQueryUserPrinterSetupDialog", .OptionsPrintAfterSavingQueryUserPrinterSetupDialog), "/n", vbCrLf)
52400   .OptionsPrintAfterSavingQueryUserStandardPrinterDialog = Replace$(hLang.Retrieve("PrintAfterSavingQueryUserStandardPrinterDialog", .OptionsPrintAfterSavingQueryUserStandardPrinterDialog), "/n", vbCrLf)
52410   .OptionsPrintertempDirectoryPrompt = Replace$(hLang.Retrieve("PrintertempDirectoryPrompt", .OptionsPrintertempDirectoryPrompt), "/n", vbCrLf)
52420   .OptionsPrintTestpage = Replace$(hLang.Retrieve("PrintTestpage", .OptionsPrintTestpage), "/n", vbCrLf)
52430   .OptionsProcesspriority = Replace$(hLang.Retrieve("Processpriority", .OptionsProcesspriority), "/n", vbCrLf)
52440   .OptionsProcesspriorityHigh = Replace$(hLang.Retrieve("ProcesspriorityHigh", .OptionsProcesspriorityHigh), "/n", vbCrLf)
52450   .OptionsProcesspriorityIdle = Replace$(hLang.Retrieve("ProcesspriorityIdle", .OptionsProcesspriorityIdle), "/n", vbCrLf)
52460   .OptionsProcesspriorityNormal = Replace$(hLang.Retrieve("ProcesspriorityNormal", .OptionsProcesspriorityNormal), "/n", vbCrLf)
52470   .OptionsProcesspriorityRealtime = Replace$(hLang.Retrieve("ProcesspriorityRealtime", .OptionsProcesspriorityRealtime), "/n", vbCrLf)
52480   .OptionsProfile = Replace$(hLang.Retrieve("Profile", .OptionsProfile), "/n", vbCrLf)
52490   .OptionsProfileAdd = Replace$(hLang.Retrieve("ProfileAdd", .OptionsProfileAdd), "/n", vbCrLf)
52500   .OptionsProfileCancel = Replace$(hLang.Retrieve("ProfileCancel", .OptionsProfileCancel), "/n", vbCrLf)
52510   .OptionsProfileDefaultName = Replace$(hLang.Retrieve("ProfileDefaultName", .OptionsProfileDefaultName), "/n", vbCrLf)
52520   .OptionsProfileDel = Replace$(hLang.Retrieve("ProfileDel", .OptionsProfileDel), "/n", vbCrLf)
52530   .OptionsProfileLoadFromDisc = Replace$(hLang.Retrieve("ProfileLoadFromDisc", .OptionsProfileLoadFromDisc), "/n", vbCrLf)
52540   .OptionsProfileNewProfile = Replace$(hLang.Retrieve("ProfileNewProfile", .OptionsProfileNewProfile), "/n", vbCrLf)
52550   .OptionsProfileOk = Replace$(hLang.Retrieve("ProfileOk", .OptionsProfileOk), "/n", vbCrLf)
52560   .OptionsProfileRenameProfile = Replace$(hLang.Retrieve("ProfileRenameProfile", .OptionsProfileRenameProfile), "/n", vbCrLf)
52570   .OptionsProfileSaveToDisc = Replace$(hLang.Retrieve("ProfileSaveToDisc", .OptionsProfileSaveToDisc), "/n", vbCrLf)
52580   .OptionsProgramActionsDescription = Replace$(hLang.Retrieve("ProgramActionsDescription", .OptionsProgramActionsDescription), "/n", vbCrLf)
52590   .OptionsProgramActionsSymbol = Replace$(hLang.Retrieve("ProgramActionsSymbol", .OptionsProgramActionsSymbol), "/n", vbCrLf)
52600   .OptionsProgramAutosaveDescription = Replace$(hLang.Retrieve("ProgramAutosaveDescription", .OptionsProgramAutosaveDescription), "/n", vbCrLf)
52610   .OptionsProgramAutosaveSymbol = Replace$(hLang.Retrieve("ProgramAutosaveSymbol", .OptionsProgramAutosaveSymbol), "/n", vbCrLf)
52620   .OptionsProgramDirectoriesDescription = Replace$(hLang.Retrieve("ProgramDirectoriesDescription", .OptionsProgramDirectoriesDescription), "/n", vbCrLf)
52630   .OptionsProgramDirectoriesSymbol = Replace$(hLang.Retrieve("ProgramDirectoriesSymbol", .OptionsProgramDirectoriesSymbol), "/n", vbCrLf)
52640   .OptionsProgramDocumentDescription = Replace$(hLang.Retrieve("ProgramDocumentDescription", .OptionsProgramDocumentDescription), "/n", vbCrLf)
52650   .OptionsProgramDocumentDescription1 = Replace$(hLang.Retrieve("ProgramDocumentDescription1", .OptionsProgramDocumentDescription1), "/n", vbCrLf)
52660   .OptionsProgramDocumentDescription2 = Replace$(hLang.Retrieve("ProgramDocumentDescription2", .OptionsProgramDocumentDescription2), "/n", vbCrLf)
52670   .OptionsProgramDocumentSymbol = Replace$(hLang.Retrieve("ProgramDocumentSymbol", .OptionsProgramDocumentSymbol), "/n", vbCrLf)
52680   .OptionsProgramFont = Replace$(hLang.Retrieve("ProgramFont", .OptionsProgramFont), "/n", vbCrLf)
52690   .OptionsProgramFontCancelTest = Replace$(hLang.Retrieve("ProgramFontCancelTest", .OptionsProgramFontCancelTest), "/n", vbCrLf)
52700   .OptionsProgramFontcharset = Replace$(hLang.Retrieve("ProgramFontcharset", .OptionsProgramFontcharset), "/n", vbCrLf)
52710   .OptionsProgramFontDescription = Replace$(hLang.Retrieve("ProgramFontDescription", .OptionsProgramFontDescription), "/n", vbCrLf)
52720   .OptionsProgramFontSize = Replace$(hLang.Retrieve("ProgramFontSize", .OptionsProgramFontSize), "/n", vbCrLf)
52730   .OptionsProgramFontSymbol = Replace$(hLang.Retrieve("ProgramFontSymbol", .OptionsProgramFontSymbol), "/n", vbCrLf)
52740   .OptionsProgramFontTest = Replace$(hLang.Retrieve("ProgramFontTest", .OptionsProgramFontTest), "/n", vbCrLf)
52750   .OptionsProgramFontTestdescription = Replace$(hLang.Retrieve("ProgramFontTestdescription", .OptionsProgramFontTestdescription), "/n", vbCrLf)
52760   .OptionsProgramGeneralDescription = Replace$(hLang.Retrieve("ProgramGeneralDescription", .OptionsProgramGeneralDescription), "/n", vbCrLf)
52770   .OptionsProgramGeneralDescription1 = Replace$(hLang.Retrieve("ProgramGeneralDescription1", .OptionsProgramGeneralDescription1), "/n", vbCrLf)
52780   .OptionsProgramGeneralDescription2 = Replace$(hLang.Retrieve("ProgramGeneralDescription2", .OptionsProgramGeneralDescription2), "/n", vbCrLf)
52790   .OptionsProgramGeneralSymbol = Replace$(hLang.Retrieve("ProgramGeneralSymbol", .OptionsProgramGeneralSymbol), "/n", vbCrLf)
52800   .OptionsProgramGhostscriptDescription = Replace$(hLang.Retrieve("ProgramGhostscriptDescription", .OptionsProgramGhostscriptDescription), "/n", vbCrLf)
52810   .OptionsProgramGhostscriptSymbol = Replace$(hLang.Retrieve("ProgramGhostscriptSymbol", .OptionsProgramGhostscriptSymbol), "/n", vbCrLf)
52820   .OptionsProgramLanguagesDescription = Replace$(hLang.Retrieve("ProgramLanguagesDescription", .OptionsProgramLanguagesDescription), "/n", vbCrLf)
52830   .OptionsProgramLanguagesSymbol = Replace$(hLang.Retrieve("ProgramLanguagesSymbol", .OptionsProgramLanguagesSymbol), "/n", vbCrLf)
52840   .OptionsProgramNoProcessingAtStartup = Replace$(hLang.Retrieve("ProgramNoProcessingAtStartup", .OptionsProgramNoProcessingAtStartup), "/n", vbCrLf)
52850   .OptionsProgramOptionsDesign = Replace$(hLang.Retrieve("ProgramOptionsDesign", .OptionsProgramOptionsDesign), "/n", vbCrLf)
52860   .OptionsProgramOptionsDesignGradient = Replace$(hLang.Retrieve("ProgramOptionsDesignGradient", .OptionsProgramOptionsDesignGradient), "/n", vbCrLf)
52870   .OptionsProgramOptionsDesignSimple = Replace$(hLang.Retrieve("ProgramOptionsDesignSimple", .OptionsProgramOptionsDesignSimple), "/n", vbCrLf)
52880   .OptionsProgramPrintDescription = Replace$(hLang.Retrieve("ProgramPrintDescription", .OptionsProgramPrintDescription), "/n", vbCrLf)
52890   .OptionsProgramPrintSymbol = Replace$(hLang.Retrieve("ProgramPrintSymbol", .OptionsProgramPrintSymbol), "/n", vbCrLf)
52900   .OptionsProgramRunProgramAfterSavingCaption = Replace$(hLang.Retrieve("ProgramRunProgramAfterSavingCaption", .OptionsProgramRunProgramAfterSavingCaption), "/n", vbCrLf)
52910   .OptionsProgramRunProgramAfterSavingProgram = Replace$(hLang.Retrieve("ProgramRunProgramAfterSavingProgram", .OptionsProgramRunProgramAfterSavingProgram), "/n", vbCrLf)
52920   .OptionsProgramRunProgramAfterSavingProgramParameters = Replace$(hLang.Retrieve("ProgramRunProgramAfterSavingProgramParameters", .OptionsProgramRunProgramAfterSavingProgramParameters), "/n", vbCrLf)
52930   .OptionsProgramRunProgramAfterSavingWaitUntilReady = Replace$(hLang.Retrieve("ProgramRunProgramAfterSavingWaitUntilReady", .OptionsProgramRunProgramAfterSavingWaitUntilReady), "/n", vbCrLf)
52940   .OptionsProgramRunProgramAfterSavingWindowstyle = Replace$(hLang.Retrieve("ProgramRunProgramAfterSavingWindowstyle", .OptionsProgramRunProgramAfterSavingWindowstyle), "/n", vbCrLf)
52950   .OptionsProgramRunProgramAfterSavingWindowstyleHide = Replace$(hLang.Retrieve("ProgramRunProgramAfterSavingWindowstyleHide", .OptionsProgramRunProgramAfterSavingWindowstyleHide), "/n", vbCrLf)
52960   .OptionsProgramRunProgramAfterSavingWindowstyleMaximizedFocus = Replace$(hLang.Retrieve("ProgramRunProgramAfterSavingWindowstyleMaximizedFocus", .OptionsProgramRunProgramAfterSavingWindowstyleMaximizedFocus), "/n", vbCrLf)
52970   .OptionsProgramRunProgramAfterSavingWindowstyleMinimizedFocus = Replace$(hLang.Retrieve("ProgramRunProgramAfterSavingWindowstyleMinimizedFocus", .OptionsProgramRunProgramAfterSavingWindowstyleMinimizedFocus), "/n", vbCrLf)
52980   .OptionsProgramRunProgramAfterSavingWindowstyleMinimizedNoFocus = Replace$(hLang.Retrieve("ProgramRunProgramAfterSavingWindowstyleMinimizedNoFocus", .OptionsProgramRunProgramAfterSavingWindowstyleMinimizedNoFocus), "/n", vbCrLf)
52990   .OptionsProgramRunProgramAfterSavingWindowstyleNormalFocus = Replace$(hLang.Retrieve("ProgramRunProgramAfterSavingWindowstyleNormalFocus", .OptionsProgramRunProgramAfterSavingWindowstyleNormalFocus), "/n", vbCrLf)
53000   .OptionsProgramRunProgramAfterSavingWindowstyleNormalNoFocus = Replace$(hLang.Retrieve("ProgramRunProgramAfterSavingWindowstyleNormalNoFocus", .OptionsProgramRunProgramAfterSavingWindowstyleNormalNoFocus), "/n", vbCrLf)
53010   .OptionsProgramRunProgramBeforeSavingCaption = Replace$(hLang.Retrieve("ProgramRunProgramBeforeSavingCaption", .OptionsProgramRunProgramBeforeSavingCaption), "/n", vbCrLf)
53020   .OptionsProgramRunProgramBeforeSavingProgram = Replace$(hLang.Retrieve("ProgramRunProgramBeforeSavingProgram", .OptionsProgramRunProgramBeforeSavingProgram), "/n", vbCrLf)
53030   .OptionsProgramRunProgramBeforeSavingProgramParameters = Replace$(hLang.Retrieve("ProgramRunProgramBeforeSavingProgramParameters", .OptionsProgramRunProgramBeforeSavingProgramParameters), "/n", vbCrLf)
53040   .OptionsProgramRunProgramBeforeSavingWaitUntilReady = Replace$(hLang.Retrieve("ProgramRunProgramBeforeSavingWaitUntilReady", .OptionsProgramRunProgramBeforeSavingWaitUntilReady), "/n", vbCrLf)
53050   .OptionsProgramRunProgramBeforeSavingWindowstyle = Replace$(hLang.Retrieve("ProgramRunProgramBeforeSavingWindowstyle", .OptionsProgramRunProgramBeforeSavingWindowstyle), "/n", vbCrLf)
53060   .OptionsProgramRunProgramBeforeSavingWindowstyleHide = Replace$(hLang.Retrieve("ProgramRunProgramBeforeSavingWindowstyleHide", .OptionsProgramRunProgramBeforeSavingWindowstyleHide), "/n", vbCrLf)
53070   .OptionsProgramRunProgramBeforeSavingWindowstyleMaximizedFocus = Replace$(hLang.Retrieve("ProgramRunProgramBeforeSavingWindowstyleMaximizedFocus", .OptionsProgramRunProgramBeforeSavingWindowstyleMaximizedFocus), "/n", vbCrLf)
53080   .OptionsProgramRunProgramBeforeSavingWindowstyleMinimizedFocus = Replace$(hLang.Retrieve("ProgramRunProgramBeforeSavingWindowstyleMinimizedFocus", .OptionsProgramRunProgramBeforeSavingWindowstyleMinimizedFocus), "/n", vbCrLf)
53090   .OptionsProgramRunProgramBeforeSavingWindowstyleMinimizedNoFocus = Replace$(hLang.Retrieve("ProgramRunProgramBeforeSavingWindowstyleMinimizedNoFocus", .OptionsProgramRunProgramBeforeSavingWindowstyleMinimizedNoFocus), "/n", vbCrLf)
53100   .OptionsProgramRunProgramBeforeSavingWindowstyleNormalFocus = Replace$(hLang.Retrieve("ProgramRunProgramBeforeSavingWindowstyleNormalFocus", .OptionsProgramRunProgramBeforeSavingWindowstyleNormalFocus), "/n", vbCrLf)
53110   .OptionsProgramRunProgramBeforeSavingWindowstyleNormalNoFocus = Replace$(hLang.Retrieve("ProgramRunProgramBeforeSavingWindowstyleNormalNoFocus", .OptionsProgramRunProgramBeforeSavingWindowstyleNormalNoFocus), "/n", vbCrLf)
53120   .OptionsProgramSaveDescription = Replace$(hLang.Retrieve("ProgramSaveDescription", .OptionsProgramSaveDescription), "/n", vbCrLf)
53130   .OptionsProgramSaveSymbol = Replace$(hLang.Retrieve("ProgramSaveSymbol", .OptionsProgramSaveSymbol), "/n", vbCrLf)
53140   .OptionsProgramShowAnimation = Replace$(hLang.Retrieve("ProgramShowAnimation", .OptionsProgramShowAnimation), "/n", vbCrLf)
53150   .OptionsProgramSwitchingDefaultprinter = Replace$(hLang.Retrieve("ProgramSwitchingDefaultprinter", .OptionsProgramSwitchingDefaultprinter), "/n", vbCrLf)
53160   .OptionsPSDColorsCount01 = Replace$(hLang.Retrieve("PSDColorsCount01", .OptionsPSDColorsCount01), "/n", vbCrLf)
53170   .OptionsPSDColorscount02 = Replace$(hLang.Retrieve("PSDColorscount02", .OptionsPSDColorscount02), "/n", vbCrLf)
53180   .OptionsPSDDescription = Replace$(hLang.Retrieve("PSDDescription", .OptionsPSDDescription), "/n", vbCrLf)
53190   .OptionsPSDescription = Replace$(hLang.Retrieve("PSDescription", .OptionsPSDescription), "/n", vbCrLf)
53200   .OptionsPSDSymbol = Replace$(hLang.Retrieve("PSDSymbol", .OptionsPSDSymbol), "/n", vbCrLf)
53210   .OptionsPSFiles = Replace$(hLang.Retrieve("PSFiles", .OptionsPSFiles), "/n", vbCrLf)
53220   .OptionsPSLanguageLevel = Replace$(hLang.Retrieve("PSLanguageLevel", .OptionsPSLanguageLevel), "/n", vbCrLf)
53230   .OptionsPSSymbol = Replace$(hLang.Retrieve("PSSymbol", .OptionsPSSymbol), "/n", vbCrLf)
53240   .OptionsRAWColorsCount01 = Replace$(hLang.Retrieve("RAWColorsCount01", .OptionsRAWColorsCount01), "/n", vbCrLf)
53250   .OptionsRAWColorscount02 = Replace$(hLang.Retrieve("RAWColorscount02", .OptionsRAWColorscount02), "/n", vbCrLf)
53260   .OptionsRAWColorscount03 = Replace$(hLang.Retrieve("RAWColorscount03", .OptionsRAWColorscount03), "/n", vbCrLf)
53270   .OptionsRAWDescription = Replace$(hLang.Retrieve("RAWDescription", .OptionsRAWDescription), "/n", vbCrLf)
53280   .OptionsRAWSymbol = Replace$(hLang.Retrieve("RAWSymbol", .OptionsRAWSymbol), "/n", vbCrLf)
53290   .OptionsRemoveSpaces = Replace$(hLang.Retrieve("RemoveSpaces", .OptionsRemoveSpaces), "/n", vbCrLf)
53300   .OptionsReset = Replace$(hLang.Retrieve("Reset", .OptionsReset), "/n", vbCrLf)
53310   .OptionsSave = Replace$(hLang.Retrieve("Save", .OptionsSave), "/n", vbCrLf)
53320   .OptionsSaveFilename = Replace$(hLang.Retrieve("SaveFilename", .OptionsSaveFilename), "/n", vbCrLf)
53330   .OptionsSaveFilenameAdd = Replace$(hLang.Retrieve("SaveFilenameAdd", .OptionsSaveFilenameAdd), "/n", vbCrLf)
53340   .OptionsSaveFilenameChange = Replace$(hLang.Retrieve("SaveFilenameChange", .OptionsSaveFilenameChange), "/n", vbCrLf)
53350   .OptionsSaveFilenameDelete = Replace$(hLang.Retrieve("SaveFilenameDelete", .OptionsSaveFilenameDelete), "/n", vbCrLf)
53360   .OptionsSaveFilenameSubstitutions = Replace$(hLang.Retrieve("SaveFilenameSubstitutions", .OptionsSaveFilenameSubstitutions), "/n", vbCrLf)
53370   .OptionsSaveFilenameSubstitutionsTitle = Replace$(hLang.Retrieve("SaveFilenameSubstitutionsTitle", .OptionsSaveFilenameSubstitutionsTitle), "/n", vbCrLf)
53380   .OptionsSaveFilenameTokens = Replace$(hLang.Retrieve("SaveFilenameTokens", .OptionsSaveFilenameTokens), "/n", vbCrLf)
53390   .OptionsSavePasswords = Replace$(hLang.Retrieve("SavePasswords", .OptionsSavePasswords), "/n", vbCrLf)
53400   .OptionsSendEmailAfterAutosave = Replace$(hLang.Retrieve("SendEmailAfterAutosave", .OptionsSendEmailAfterAutosave), "/n", vbCrLf)
53410   .OptionsSendMailMethod = Replace$(hLang.Retrieve("SendMailMethod", .OptionsSendMailMethod), "/n", vbCrLf)
53420   .OptionsSendMailMethodAutomatic = Replace$(hLang.Retrieve("SendMailMethodAutomatic", .OptionsSendMailMethodAutomatic), "/n", vbCrLf)
53430   .OptionsSendMailMethodMapi = Replace$(hLang.Retrieve("SendMailMethodMapi", .OptionsSendMailMethodMapi), "/n", vbCrLf)
53440   .OptionsSendMailMethodSendmailDLL = Replace$(hLang.Retrieve("SendMailMethodSendmailDLL", .OptionsSendMailMethodSendmailDLL), "/n", vbCrLf)
53450   .OptionsShellIntegration = Replace$(hLang.Retrieve("ShellIntegration", .OptionsShellIntegration), "/n", vbCrLf)
53460   .OptionsShellIntegrationAdd = Replace$(hLang.Retrieve("ShellIntegrationAdd", .OptionsShellIntegrationAdd), "/n", vbCrLf)
53470   .OptionsShellIntegrationCaption = Replace$(hLang.Retrieve("ShellIntegrationCaption", .OptionsShellIntegrationCaption), "/n", vbCrLf)
53480   .OptionsShellIntegrationRemove = Replace$(hLang.Retrieve("ShellIntegrationRemove", .OptionsShellIntegrationRemove), "/n", vbCrLf)
53490   .OptionsStamp = Replace$(hLang.Retrieve("Stamp", .OptionsStamp), "/n", vbCrLf)
53500   .OptionsStampFontColor = Replace$(hLang.Retrieve("StampFontColor", .OptionsStampFontColor), "/n", vbCrLf)
53510   .OptionsStampOutlineFontThickness = Replace$(hLang.Retrieve("StampOutlineFontThickness", .OptionsStampOutlineFontThickness), "/n", vbCrLf)
53520   .OptionsStampString = Replace$(hLang.Retrieve("StampString", .OptionsStampString), "/n", vbCrLf)
53530   .OptionsStampUseOutlineFont = Replace$(hLang.Retrieve("StampUseOutlineFont", .OptionsStampUseOutlineFont), "/n", vbCrLf)
53540   .OptionsStandardAuthorToken = Replace$(hLang.Retrieve("StandardAuthorToken", .OptionsStandardAuthorToken), "/n", vbCrLf)
53550   .OptionsStandardSaveFormat = Replace$(hLang.Retrieve("StandardSaveFormat", .OptionsStandardSaveFormat), "/n", vbCrLf)
53560   .OptionsSVGDescription = Replace$(hLang.Retrieve("SVGDescription", .OptionsSVGDescription), "/n", vbCrLf)
53570   .OptionsSVGSymbol = Replace$(hLang.Retrieve("SVGSymbol", .OptionsSVGSymbol), "/n", vbCrLf)
53580   .OptionsTestpage = Replace$(hLang.Retrieve("Testpage", .OptionsTestpage), "/n", vbCrLf)
53590   .OptionsTIFFColorscount01 = Replace$(hLang.Retrieve("TIFFColorscount01", .OptionsTIFFColorscount01), "/n", vbCrLf)
53600   .OptionsTIFFColorscount02 = Replace$(hLang.Retrieve("TIFFColorscount02", .OptionsTIFFColorscount02), "/n", vbCrLf)
53610   .OptionsTIFFColorscount03 = Replace$(hLang.Retrieve("TIFFColorscount03", .OptionsTIFFColorscount03), "/n", vbCrLf)
53620   .OptionsTIFFColorscount04 = Replace$(hLang.Retrieve("TIFFColorscount04", .OptionsTIFFColorscount04), "/n", vbCrLf)
53630   .OptionsTIFFColorscount05 = Replace$(hLang.Retrieve("TIFFColorscount05", .OptionsTIFFColorscount05), "/n", vbCrLf)
53640   .OptionsTIFFColorscount06 = Replace$(hLang.Retrieve("TIFFColorscount06", .OptionsTIFFColorscount06), "/n", vbCrLf)
53650   .OptionsTIFFColorscount07 = Replace$(hLang.Retrieve("TIFFColorscount07", .OptionsTIFFColorscount07), "/n", vbCrLf)
53660   .OptionsTIFFColorscount08 = Replace$(hLang.Retrieve("TIFFColorscount08", .OptionsTIFFColorscount08), "/n", vbCrLf)
53670   .OptionsTIFFDescription = Replace$(hLang.Retrieve("TIFFDescription", .OptionsTIFFDescription), "/n", vbCrLf)
53680   .OptionsTIFFSymbol = Replace$(hLang.Retrieve("TIFFSymbol", .OptionsTIFFSymbol), "/n", vbCrLf)
53690   .OptionsTreeFormats = Replace$(hLang.Retrieve("TreeFormats", .OptionsTreeFormats), "/n", vbCrLf)
53700   .OptionsTreeProgram = Replace$(hLang.Retrieve("TreeProgram", .OptionsTreeProgram), "/n", vbCrLf)
53710   .OptionsTXTDescription = Replace$(hLang.Retrieve("TXTDescription", .OptionsTXTDescription), "/n", vbCrLf)
53720   .OptionsTXTSymbol = Replace$(hLang.Retrieve("TXTSymbol", .OptionsTXTSymbol), "/n", vbCrLf)
53730   .OptionsUseAutosave = Replace$(hLang.Retrieve("UseAutosave", .OptionsUseAutosave), "/n", vbCrLf)
53740   .OptionsUseAutosaveDirectory = Replace$(hLang.Retrieve("UseAutosaveDirectory", .OptionsUseAutosaveDirectory), "/n", vbCrLf)
53750   .OptionsUseCreationDateNow = Replace$(hLang.Retrieve("UseCreationDateNow", .OptionsUseCreationDateNow), "/n", vbCrLf)
53760   .OptionsUseCustomPapersize = Replace$(hLang.Retrieve("UseCustomPapersize", .OptionsUseCustomPapersize), "/n", vbCrLf)
53770   .OptionsUseFixPapersize = Replace$(hLang.Retrieve("UseFixPapersize", .OptionsUseFixPapersize), "/n", vbCrLf)
53780   .OptionsUserPass = Replace$(hLang.Retrieve("UserPass", .OptionsUserPass), "/n", vbCrLf)
53790   .OptionsUseStandardauthor = Replace$(hLang.Retrieve("UseStandardauthor", .OptionsUseStandardauthor), "/n", vbCrLf)
53800   .OptionsXCFColorsCount01 = Replace$(hLang.Retrieve("XCFColorsCount01", .OptionsXCFColorsCount01), "/n", vbCrLf)
53810   .OptionsXCFColorscount02 = Replace$(hLang.Retrieve("XCFColorscount02", .OptionsXCFColorscount02), "/n", vbCrLf)
53820   .OptionsXCFDescription = Replace$(hLang.Retrieve("XCFDescription", .OptionsXCFDescription), "/n", vbCrLf)
53830   .OptionsXCFSymbol = Replace$(hLang.Retrieve("XCFSymbol", .OptionsXCFSymbol), "/n", vbCrLf)
53840  End With
53850  Set hLang = Nothing
'---ErrPtnr-OnError-START--- DO NOT MODIFY ! ---
Exit Sub
ErrPtnr_OnError:
...
52880   .OptionsPDFPasswords = "Passwords"
52890   .OptionsPDFRepeatPassword = "Repeat"
52900   .OptionsPDFSecurity = "Security"
52910   .OptionsPDFSecurityCaption = "Security"
52920   .OptionsPDFSetPassword = "Password"
52930   .OptionsPDFSigning = "Signing"
52940   .OptionsPDFSigningCaption = "Signing of PDFs"
52950   .OptionsPDFSigningCerticatePassword = "Certificate password"
52960   .OptionsPDFSigningCerticatePasswordCancel = "&Cancel"
52970   .OptionsPDFSigningCerticatePasswordOk = "&Ok"
52980   .OptionsPDFSigningCerticatePasswordShowPassword = "Show password"
52990   .OptionsPDFSigningCertificateEmptyPassword = "No password is entered. The pdf file will not be signed."
53000   .OptionsPDFSigningCertificateFile = "Certificate file"
53010   .OptionsPDFSigningChooseCertifcateFile = "Choose a certificate"
53020   .OptionsPDFSigningP12Files = "P12 files"
53030   .OptionsPDFSigningPfxFiles = "Pfx files"
53040   .OptionsPDFSigningPfxP12Files = "Pfx/P12 files"
53050   .OptionsPDFSigningSignatureContact = "Signature contact"
53060   .OptionsPDFSigningSignatureLocation = "Signature location"
53070   .OptionsPDFSigningSignatureMultiSignature = "Multi signature allowed"
53080   .OptionsPDFSigningSignatureOnPage = "Show signature on page"
53090   .OptionsPDFSigningSignaturePosition = "Signature position"
53100   .OptionsPDFSigningSignaturePositionLeftX = "LeftX"
53110   .OptionsPDFSigningSignaturePositionLeftY = "LeftY"
53120   .OptionsPDFSigningSignaturePositionRightX = "RightX"
53130   .OptionsPDFSigningSignaturePositionRightY = "RightY"
53140   .OptionsPDFSigningSignatureReason = "Signature reason"
53150   .OptionsPDFSigningSignatureVisible = "Signature visible in pdf file"
53160   .OptionsPDFSigningSignPdfFile = "Sign pdf file"
53170   .OptionsPDFSymbol = "PDF"
53180   .OptionsPDFUserPass = "Password required to open document"
53190   .OptionsPDFUseSecurity = "Use Security"
53200   .OptionsPNGColorscount01 = "16777216 colors (24 Bit)"
53210   .OptionsPNGColorscount02 = "256 colors (8 Bit)"
53220   .OptionsPNGColorscount03 = "16 colors (4 Bit)"
53230   .OptionsPNGColorscount04 = "2 colors (2 Bit - Black/White)"
53240   .OptionsPNGColorscount05 = "Greyscale (8 Bit)"
53250   .OptionsPNGDescription = "PNG Format. Please use only for single pages."
53260   .OptionsPNGFiles = "Bitmap PNG-Files"
53270   .OptionsPNGSymbol = "PNG"
53280   .OptionsPrintAfterSaving = "Print after saving"
53290   .OptionsPrintAfterSavingBitsPerPixel = "Bits per pixel"
53300   .OptionsPrintAfterSavingBitsPerPixelCMYK = "CMYK"
53310   .OptionsPrintAfterSavingBitsPerPixelMono = "Mono"
53320   .OptionsPrintAfterSavingBitsPerPixelTrueColor = "True Color"
53330   .OptionsPrintAfterSavingDuplex = "Duplex"
53340   .OptionsPrintAfterSavingDuplexTumbleOff = "Don't use tumble (Default)"
53350   .OptionsPrintAfterSavingDuplexTumbleOn = "Use tumble"
53360   .OptionsPrintAfterSavingMaxResolution = "Set maximum print resolution"
53370   .OptionsPrintAfterSavingNoCancel = "Hide the progress dialog during printing"
53380   .OptionsPrintAfterSavingPrinter = "Printer"
53390   .OptionsPrintAfterSavingQueryUser = "Query user"
53400   .OptionsPrintAfterSavingQueryUserDefaultPrinter = "Select the default Windows printer without any user interaction"
53410   .OptionsPrintAfterSavingQueryUserOff = "Off (Default)"
53420   .OptionsPrintAfterSavingQueryUserPrinterSetupDialog = "Shows the printer setup dialog"
53430   .OptionsPrintAfterSavingQueryUserStandardPrinterDialog = "Show the standard printer dialog"
53440   .OptionsPrintertempDirectoryPrompt = "Select Printer Temp-Directory"
53450   .OptionsPrintTestpage = "Print Test Page"
53460   .OptionsProcesspriority = "Process priority"
53470   .OptionsProcesspriorityHigh = "High"
53480   .OptionsProcesspriorityIdle = "Idle"
53490   .OptionsProcesspriorityNormal = "Normal"
53500   .OptionsProcesspriorityRealtime = "Realtime"
53510   .OptionsProfile = "Profile"
53520   .OptionsProfileAdd = "Add profile"
53530   .OptionsProfileCancel = "&Cancel"
53540   .OptionsProfileDefaultName = "Default"
53550   .OptionsProfileDel = "Delete profile"
53560   .OptionsProfileLoadFromDisc = "Load profile from disc"
53570   .OptionsProfileNewProfile = "New profile"
53580   .OptionsProfileOk = "&Ok"
53590   .OptionsProfileRenameProfile = "Rename profile"
53600   .OptionsProfileSaveToDisc = "Save profile to disc"
53610   .OptionsProgramActionsDescription = "Define an action before and after saving a file."
53620   .OptionsProgramActionsSymbol = "Actions"
53630   .OptionsProgramAutosaveDescription = "Auto-save mode. Auto-save does not prompt for a filename and file location. It automatically saves all PDF files to a single directory with a predefined filename."
53640   .OptionsProgramAutosaveSymbol = "Auto-save"
53650   .OptionsProgramDirectoriesDescription = "Directories for Ghostscript, temporary files and others."
53660   .OptionsProgramDirectoriesSymbol = "Directories"
53670   .OptionsProgramDocumentDescription = "Document properties"
53680   .OptionsProgramDocumentDescription1 = "Document properties 1"
53690   .OptionsProgramDocumentDescription2 = "Document properties 2"
53700   .OptionsProgramDocumentSymbol = "Document"
53710   .OptionsProgramFont = "Program Font"
53720   .OptionsProgramFontCancelTest = "Cancel Test"
53730   .OptionsProgramFontcharset = "Character Set"
53740   .OptionsProgramFontDescription = "Font for labels, captions and values. For the program menu use the general settings in your Windows OS."
53750   .OptionsProgramFontSize = "Size"
53760   .OptionsProgramFontSymbol = "Program font"
53770   .OptionsProgramFontTest = "Test"
53780   .OptionsProgramFontTestdescription = "Here you can test the font."
53790   .OptionsProgramGeneralDescription = "General Settings"
53800   .OptionsProgramGeneralDescription1 = "General Settings 1"
53810   .OptionsProgramGeneralDescription2 = "General Settings 2"
53820   .OptionsProgramGeneralSymbol = "General settings"
53830   .OptionsProgramGhostscriptDescription = "Ghostscript"
53840   .OptionsProgramGhostscriptSymbol = "Ghostscript"
53850   .OptionsProgramLanguagesDescription = "Define the language and download another languages from the internet."
53860   .OptionsProgramLanguagesSymbol = "Languages"
53870   .OptionsProgramNoProcessingAtStartup = "No processing at startup"
53880   .OptionsProgramOptionsDesign = "Frame color of the options dialog"
53890   .OptionsProgramOptionsDesignGradient = "Red and blue gradient (Default)"
53900   .OptionsProgramOptionsDesignSimple = "Simple red and blue color"
53910   .OptionsProgramPrintDescription = "Print after saving"
53920   .OptionsProgramPrintSymbol = "Print"
53930   .OptionsProgramRunProgramAfterSavingCaption = "Action after saving"
53940   .OptionsProgramRunProgramAfterSavingProgram = "Program/Script"
53950   .OptionsProgramRunProgramAfterSavingProgramParameters = "Program parameters"
53960   .OptionsProgramRunProgramAfterSavingWaitUntilReady = "Wait until the program/script is ready"
53970   .OptionsProgramRunProgramAfterSavingWindowstyle = "Window style"
53980   .OptionsProgramRunProgramAfterSavingWindowstyleHide = "Hide"
53990   .OptionsProgramRunProgramAfterSavingWindowstyleMaximizedFocus = "Maximized/Focus"
54000   .OptionsProgramRunProgramAfterSavingWindowstyleMinimizedFocus = "Minimized/Focus"
54010   .OptionsProgramRunProgramAfterSavingWindowstyleMinimizedNoFocus = "Minimized/No focus"
54020   .OptionsProgramRunProgramAfterSavingWindowstyleNormalFocus = "Normal/Focus"
54030   .OptionsProgramRunProgramAfterSavingWindowstyleNormalNoFocus = "Normal/No focus"
54040   .OptionsProgramRunProgramBeforeSavingCaption = "Action before saving"
54050   .OptionsProgramRunProgramBeforeSavingProgram = "Program/Script"
54060   .OptionsProgramRunProgramBeforeSavingProgramParameters = "Program parameters"
54070   .OptionsProgramRunProgramBeforeSavingWaitUntilReady = "Wait until the program/script is ready"
54080   .OptionsProgramRunProgramBeforeSavingWindowstyle = "Window style"
54090   .OptionsProgramRunProgramBeforeSavingWindowstyleHide = "Hide"
54100   .OptionsProgramRunProgramBeforeSavingWindowstyleMaximizedFocus = "Maximized/Focus"
54110   .OptionsProgramRunProgramBeforeSavingWindowstyleMinimizedFocus = "Minimized/Focus"
54120   .OptionsProgramRunProgramBeforeSavingWindowstyleMinimizedNoFocus = "Minimized/NoFocus"
54130   .OptionsProgramRunProgramBeforeSavingWindowstyleNormalFocus = "Normal/Focus"
54140   .OptionsProgramRunProgramBeforeSavingWindowstyleNormalNoFocus = "Normal/NoFocus"
54150   .OptionsProgramSaveDescription = "Save"
54160   .OptionsProgramSaveSymbol = "Save"
54170   .OptionsProgramShowAnimation = "Show an animation during the process"
54180   .OptionsProgramSwitchingDefaultprinter = "No confirm message switching PDFCreator temporarily as default printer."
54190   .OptionsPSDColorsCount01 = "4294967296 colors (32 Bit) CMYK"
54200   .OptionsPSDColorscount02 = "16777216 colors (24 Bit)"
54210   .OptionsPSDDescription = "Photoshop Format"
54220   .OptionsPSDescription = "Postscript Format"
54230   .OptionsPSDSymbol = "PSD"
54240   .OptionsPSFiles = "Postscript-Files"
54250   .OptionsPSLanguageLevel = "Language Level:"
54260   .OptionsPSSymbol = "PS"
54270   .OptionsRAWColorsCount01 = "4294967296 colors (32 Bit) CMYK"
54280   .OptionsRAWColorscount02 = "16777216 colors (24 Bit)"
54290   .OptionsRAWColorscount03 = "2 colors (Black/White)"
54300   .OptionsRAWDescription = "Raw Format"
54310   .OptionsRAWSymbol = "Raw"
54320   .OptionsRemoveSpaces = "Remove leading and trailing spaces"
54330   .OptionsReset = "&Reset all settings"
54340   .OptionsSave = "&Save"
54350   .OptionsSaveFilename = "Filename"
54360   .OptionsSaveFilenameAdd = "Add"
54370   .OptionsSaveFilenameChange = "Change"
54380   .OptionsSaveFilenameDelete = "Delete"
54390   .OptionsSaveFilenameSubstitutions = "Filename substitution"
54400   .OptionsSaveFilenameSubstitutionsTitle = "Filename substitution only in <Title>"
54410   .OptionsSaveFilenameTokens = "Add a Filename-Token"
54420   .OptionsSavePasswords = "Save passwords temporarily for this session."
54430   .OptionsSendEmailAfterAutosave = "Send an email after auto-saving"
54440   .OptionsSendMailMethod = "Methode to send an email"
54450   .OptionsSendMailMethodAutomatic = "Automatic"
54460   .OptionsSendMailMethodMapi = "Mapi interface"
54470   .OptionsSendMailMethodSendmailDLL = "Using sendmail.dll"
54480   .OptionsShellIntegration = "Shell integration"
54490   .OptionsShellIntegrationAdd = "Integrate PDFCreator into shell"
54500   .OptionsShellIntegrationCaption = "Create &PDF with PDFCreator"
54510   .OptionsShellIntegrationRemove = "Remove shell integration"
54520   .OptionsStamp = "Stamp"
54530   .OptionsStampFontColor = "Font-color"
54540   .OptionsStampOutlineFontThickness = "Outline font thickness"
54550   .OptionsStampString = "Stampstring"
54560   .OptionsStampUseOutlineFont = "Use outline font"
54570   .OptionsStandardAuthorToken = "Add a Author-Token"
54580   .OptionsStandardSaveFormat = "Standard save format"
54590   .OptionsSVGDescription = "SVG Format"
54600   .OptionsSVGSymbol = "SVG"
54610   .OptionsTestpage = "PDFCreator Testpage"
54620   .OptionsTIFFColorscount01 = "16777216 (24 Bit)"
54630   .OptionsTIFFColorscount02 = "4096 (12 Bit)"
54640   .OptionsTIFFColorscount03 = "2 colors (Black/White) G3 fax encoding with no EOLs"
54650   .OptionsTIFFColorscount04 = "2 colors (Black/White) G3 fax encoding with EOLs"
54660   .OptionsTIFFColorscount05 = "2 colors (Black/White) 2-D G3 fax encoding"
54670   .OptionsTIFFColorscount06 = "2 colors (Black/White) G4 fax encoding"
54680   .OptionsTIFFColorscount07 = "2 colors (Black/White) LZW-compatible"
54690   .OptionsTIFFColorscount08 = "2 colors (Black/White) PackBits"
54700   .OptionsTIFFDescription = "TIFF Format. For multipages use the tiff-format."
54710   .OptionsTIFFSymbol = "TIFF"
54720   .OptionsTreeFormats = "Formats"
54730   .OptionsTreeProgram = "Program"
54740   .OptionsTXTDescription = "Text Format"
54750   .OptionsTXTSymbol = "TXT"
54760   .OptionsUseAutosave = "Use Auto-save"
54770   .OptionsUseAutosaveDirectory = "Use this directory for auto-save"
54780   .OptionsUseCreationDateNow = "Use the current Date/Time for 'Creation Date'"
54790   .OptionsUseCustomPapersize = "Use custom paper size"
54800   .OptionsUseFixPapersize = "Use fixed paper size"
54810   .OptionsUserPass = "User Password"
54820   .OptionsUseStandardauthor = "Use standard author"
54830   .OptionsXCFColorsCount01 = "4294967296 colors (32 Bit) CMYK"
54840   .OptionsXCFColorscount02 = "16777216 colors (24 Bit)"
54850   .OptionsXCFDescription = "Gimp Format"
54860   .OptionsXCFSymbol = "XCF"
54870
54880   .PrintersAdminNotice = "You must be an administrator to install or delete a printer!"
54890   .PrintersClose = "Close"
54900   .PrintersNewPrinterName = "New printer name"
54910   .PrintersPrinter = "Printer"
54920   .PrintersPrinterAdd = "Add printer"
54930   .PrintersPrinterDel = "Del printer"
54940   .PrintersPrinters = "Printers"
54950   .PrintersProfile = "Profile"
54960   .PrintersSave = "Save"
54970
54980   .PrintingAuthor = "A&uthor:"
54990   .PrintingBMPFiles = "BMP-Files"
55000   .PrintingCancel = "&Cancel"
55010   .PrintingCollect = "&Wait - Collect"
55020   .PrintingCreationDate = "Creation &Date:"
55030   .PrintingDocumentTitle = "Document &Title:"
55040   .PrintingEMail = "&eMail"
55050   .PrintingEPSFiles = "Encapsulated Postscript-Files"
55060   .PrintingJPEGFiles = "JPEG-Files"
55070   .PrintingKeywords = "&Keywords:"
55080   .PrintingModifyDate = "&Modify Date:"
55090   .PrintingNow = "Now"
55100   .PrintingPCLFiles = "PCL (HP PCL-XL)-Files"
55110   .PrintingPCXFiles = "PCX-Files"
55120   .PrintingPDFAFiles = "PDF/A-1b-Files"
55130   .PrintingPDFFiles = "PDF-Files"
55140   .PrintingPDFXFiles = "PDF/X-Files"
55150   .PrintingPNGFiles = "PNG-Files"
55160   .PrintingProfile = "Profile"
55170   .PrintingPSDFiles = "PSD (Adobe Photoshop)-Files"
55180   .PrintingPSFiles = "Postscript-Files"
55190   .PrintingRAWFiles = "RAW (binary format)-Files"
55200   .PrintingSave = "&Save"
55210   .PrintingStartStandardProgram = "&After saving open the document with the default program."
55220   .PrintingStatus = "Creating file..."
55230   .PrintingSubject = "Su&bject:"
55240   .PrintingSVGFiles = "SVG-Files"
55250   .PrintingTIFFFiles = "TIFF-Files"
55260   .PrintingTXTFiles = "Text-Files"
55270   .PrintingXCFFiles = "XCF (Gimp)-Files"
55280
55290   .SaveOpenAttributes = "Attributes"
55300   .SaveOpenCancel = "Cancel"
55310   .SaveOpenFilename = "Filename"
55320   .SaveOpenOpen = "Open"
55330   .SaveOpenOpenTitle = "Open"
55340   .SaveOpenSave = "Save"
55350   .SaveOpenSaveTitle = "Save as"
55360   .SaveOpenSize = "Size"
55370
55380  End With
'---ErrPtnr-OnError-START--- DO NOT MODIFY ! ---
Exit Sub
