...
Public Declare Function SetWindowPos Lib "user32" (ByVal hwnd As Long, ByVal Order As Long, ByVal X As Long, ByVal Y As Long, ByVal cX As Long, ByVal cY As Long, ByVal Flags As Long) As Long
