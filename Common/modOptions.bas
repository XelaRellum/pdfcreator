...
67300   If LenB(tStr) = 0 And LenB("pdf") > 0 And UseStandard Then
67310     .StandardSaveformat = "pdf"
67320    Else
67330     If LenB(tStr) > 0 Then
67340      .StandardSaveformat = tStr
67350     End If
67360   End If
67370   tStr = hOpt.Retrieve("StandardSubject")
67380   If LenB(tStr) = 0 And LenB("") > 0 And UseStandard Then
67390     .StandardSubject = ""
67400    Else
67410     If LenB(tStr) > 0 Then
67420      .StandardSubject = tStr
67430     End If
67440   End If
67450   tStr = hOpt.Retrieve("StandardTitle")
67460   If LenB(tStr) = 0 And LenB("") > 0 And UseStandard Then
67470     .StandardTitle = ""
67480    Else
67490     If LenB(tStr) > 0 Then
67500      .StandardTitle = tStr
67510     End If
67520   End If
67530   tStr = hOpt.Retrieve("StartStandardProgram")
67540   If IsNumeric(tStr) Then
67550     If CLng(tStr) = 0 Or CLng(tStr) = 1 Then
67560       .StartStandardProgram = CLng(tStr)
67570      Else
67580       If UseStandard Then
67590        .StartStandardProgram = 1
67600       End If
67610     End If
67620    Else
67630     If UseStandard Then
67640      .StartStandardProgram = 1
67650     End If
67660   End If
67670   tStr = hOpt.Retrieve("TIFFColorscount")
67680   If IsNumeric(tStr) Then
67690     If CLng(tStr) >= 0 And CLng(tStr) <= 7 Then
67700       .TIFFColorscount = CLng(tStr)
67710      Else
67720       If UseStandard Then
67730        .TIFFColorscount = 0
67740       End If
67750     End If
67760    Else
67770     If UseStandard Then
67780      .TIFFColorscount = 0
67790     End If
67800   End If
67810   tStr = hOpt.Retrieve("Toolbars")
67820   If IsNumeric(tStr) Then
67830     If CLng(tStr) >= 0 Then
67840       .Toolbars = CLng(tStr)
67850      Else
...
68070     End If
68080   End If
68090   tStr = hOpt.Retrieve("UseAutosaveDirectory")
68100   If IsNumeric(tStr) Then
68110     If CLng(tStr) = 0 Or CLng(tStr) = 1 Then
68120       .UseAutosaveDirectory = CLng(tStr)
68130      Else
68140       If UseStandard Then
68150        .UseAutosaveDirectory = 1
68160       End If
68170     End If
68180    Else
68190     If UseStandard Then
68200      .UseAutosaveDirectory = 1
68210     End If
68220   End If
68230   tStr = hOpt.Retrieve("UseCreationDateNow")
68240   If IsNumeric(tStr) Then
68250     If CLng(tStr) = 0 Or CLng(tStr) = 1 Then
68260       .UseCreationDateNow = CLng(tStr)
68270      Else
68280       If UseStandard Then
68290        .UseCreationDateNow = 0
68300       End If
68310     End If
68320    Else
68330     If UseStandard Then
68340      .UseCreationDateNow = 0
68350     End If
68360   End If
68370   tStr = hOpt.Retrieve("UseStandardAuthor")
68380   If IsNumeric(tStr) Then
68390     If CLng(tStr) = 0 Or CLng(tStr) = 1 Then
68400       .UseStandardAuthor = CLng(tStr)
68410      Else
68420       If UseStandard Then
68430        .UseStandardAuthor = 0
68440       End If
68450     End If
68460    Else
68470     If UseStandard Then
68480      .UseStandardAuthor = 0
68490     End If
68500   End If
68510  End With
68520  Set ini = Nothing
68530  ReadOptionsINI = myOptions
'---ErrPtnr-OnError-START--- DO NOT MODIFY ! ---
Exit Function
ErrPtnr_OnError:
...
51080   Case "PRINTAFTERSAVINGTUMBLE": ini.SaveKey CStr(Abs(.PrintAfterSavingTumble)), "PrintAfterSavingTumble"
...
51070   ini.SaveKey CStr(Abs(.PrintAfterSavingTumble)), "PrintAfterSavingTumble"
...
62270     End If
62280   End If
62290   tStr = reg.GetRegistryValue("AutosaveStartStandardProgram")
62300   If IsNumeric(tStr) Then
62310     If CLng(tStr) = 0 Or CLng(tStr) = 1 Then
62320       .AutosaveStartStandardProgram = CLng(tStr)
62330      Else
62340       If UseStandard Then
62350        .AutosaveStartStandardProgram = 0
62360       End If
62370     End If
62380    Else
62390     If UseStandard Then
62400      .AutosaveStartStandardProgram = 0
62410     End If
62420   End If
62430   tStr = reg.GetRegistryValue("ClientComputerResolveIPAddress")
62440   If IsNumeric(tStr) Then
62450     If CLng(tStr) = 0 Or CLng(tStr) = 1 Then
62460       .ClientComputerResolveIPAddress = CLng(tStr)
62470      Else
62480       If UseStandard Then
62490        .ClientComputerResolveIPAddress = 0
62500       End If
62510     End If
62520    Else
62530     If UseStandard Then
62540      .ClientComputerResolveIPAddress = 0
62550     End If
62560   End If
62570   tStr = reg.GetRegistryValue("DisableEmail")
62580   If IsNumeric(tStr) Then
62590     If CLng(tStr) = 0 Or CLng(tStr) = 1 Then
62600       .DisableEmail = CLng(tStr)
62610      Else
62620       If UseStandard Then
62630        .DisableEmail = 0
62640       End If
62650     End If
62660    Else
62670     If UseStandard Then
62680      .DisableEmail = 0
62690     End If
62700   End If
62710   tStr = reg.GetRegistryValue("DontUseDocumentSettings")
62720   If IsNumeric(tStr) Then
62730     If CLng(tStr) = 0 Or CLng(tStr) = 1 Then
62740       .DontUseDocumentSettings = CLng(tStr)
62750      Else
62760       If UseStandard Then
62770        .DontUseDocumentSettings = 0
62780       End If
62790     End If
62800    Else
62810     If UseStandard Then
62820      .DontUseDocumentSettings = 0
62830     End If
62840   End If
62850   tStr = reg.GetRegistryValue("FilenameSubstitutions")
62860   If LenB(tStr) = 0 And LenB("Microsoft Word - \.doc\Microsoft Excel - \.xls\Microsoft PowerPoint - \.ppt") > 0 And UseStandard Then
62870     .FilenameSubstitutions = "Microsoft Word - \.doc\Microsoft Excel - \.xls\Microsoft PowerPoint - \.ppt"
62880    Else
62890     If LenB(tStr) > 0 Then
62900      .FilenameSubstitutions = tStr
62910     End If
62920   End If
62930   tStr = reg.GetRegistryValue("FilenameSubstitutionsOnlyInTitle")
62940   If IsNumeric(tStr) Then
62950     If CLng(tStr) = 0 Or CLng(tStr) = 1 Then
62960       .FilenameSubstitutionsOnlyInTitle = CLng(tStr)
62970      Else
62980       If UseStandard Then
62990        .FilenameSubstitutionsOnlyInTitle = 1
63000       End If
63010     End If
63020    Else
63030     If UseStandard Then
63040      .FilenameSubstitutionsOnlyInTitle = 1
63050     End If
63060   End If
63070   tStr = reg.GetRegistryValue("Language")
63080   If LenB(tStr) = 0 And LenB("english") > 0 And UseStandard Then
63090     .Language = "english"
63100    Else
63110     If LenB(tStr) > 0 Then
63120      .Language = tStr
63130     End If
63140   End If
63150   tStr = reg.GetRegistryValue("LastSaveDirectory")
63160   If LenB(Trim$(tStr)) > 0 Then
63170     .LastSaveDirectory = CompletePath(tStr)
63180    Else
63190     If UseStandard Then
63200      If InstalledAsServer Then
63210        .LastSaveDirectory = "C:\PDFs\<REDMON_MACHINE>\<REDMON_USER>"
63220       Else
63230        .LastSaveDirectory = "<MyFiles>"
63240      End If
63250     End If
63260   End If
63270   tStr = reg.GetRegistryValue("Logging")
63280   If IsNumeric(tStr) Then
63290     If CLng(tStr) = 0 Or CLng(tStr) = 1 Then
63300       .Logging = CLng(tStr)
63310      Else
...
63390     End If
63400   End If
63410   tStr = reg.GetRegistryValue("LogLines")
63420   If IsNumeric(tStr) Then
63430     If CLng(tStr) >= 100 And CLng(tStr) <= 1000 Then
63440       .LogLines = CLng(tStr)
63450      Else
...
63530     End If
63540   End If
63550   tStr = reg.GetRegistryValue("NoConfirmMessageSwitchingDefaultprinter")
63560   If IsNumeric(tStr) Then
63570     If CLng(tStr) = 0 Or CLng(tStr) = 1 Then
63580       .NoConfirmMessageSwitchingDefaultprinter = CLng(tStr)
63590      Else
63600       If UseStandard Then
63610        .NoConfirmMessageSwitchingDefaultprinter = 0
63620       End If
63630     End If
63640    Else
63650     If UseStandard Then
63660      .NoConfirmMessageSwitchingDefaultprinter = 0
63670     End If
63680   End If
63690   tStr = reg.GetRegistryValue("NoProcessingAtStartup")
63700   If IsNumeric(tStr) Then
63710     If CLng(tStr) = 0 Or CLng(tStr) = 1 Then
63720       .NoProcessingAtStartup = CLng(tStr)
63730      Else
63740       If UseStandard Then
63750        .NoProcessingAtStartup = 0
63760       End If
63770     End If
63780    Else
63790     If UseStandard Then
63800      .NoProcessingAtStartup = 0
63810     End If
63820   End If
63830   tStr = reg.GetRegistryValue("NoPSCheck")
63840   If IsNumeric(tStr) Then
63850     If CLng(tStr) = 0 Or CLng(tStr) = 1 Then
63860       .NoPSCheck = CLng(tStr)
63870      Else
...
63950     End If
63960   End If
63970   tStr = reg.GetRegistryValue("OptionsDesign")
63980   If IsNumeric(tStr) Then
63990     If CLng(tStr) >= 0 And CLng(tStr) <= 1 Then
64000       .OptionsDesign = CLng(tStr)
64010      Else
64020       If UseStandard Then
64030        .OptionsDesign = 0
64040       End If
64050     End If
64060    Else
64070     If UseStandard Then
64080      .OptionsDesign = 0
64090     End If
64100   End If
64110   tStr = reg.GetRegistryValue("OptionsEnabled")
64120   If IsNumeric(tStr) Then
64130     If CLng(tStr) = 0 Or CLng(tStr) = 1 Then
64140       .OptionsEnabled = CLng(tStr)
64150      Else
64160       If UseStandard Then
64170        .OptionsEnabled = 1
64180       End If
64190     End If
64200    Else
64210     If UseStandard Then
64220      .OptionsEnabled = 1
64230     End If
64240   End If
64250   tStr = reg.GetRegistryValue("OptionsVisible")
64260   If IsNumeric(tStr) Then
64270     If CLng(tStr) = 0 Or CLng(tStr) = 1 Then
64280       .OptionsVisible = CLng(tStr)
64290      Else
64300       If UseStandard Then
64310        .OptionsVisible = 1
64320       End If
64330     End If
64340    Else
64350     If UseStandard Then
64360      .OptionsVisible = 1
64370     End If
64380   End If
64390   tStr = reg.GetRegistryValue("PrintAfterSaving")
64400   If IsNumeric(tStr) Then
64410     If CLng(tStr) = 0 Or CLng(tStr) = 1 Then
64420       .PrintAfterSaving = CLng(tStr)
64430      Else
64440       If UseStandard Then
64450        .PrintAfterSaving = 0
64460       End If
64470     End If
64480    Else
64490     If UseStandard Then
64500      .PrintAfterSaving = 0
64510     End If
64520   End If
64530   tStr = reg.GetRegistryValue("PrintAfterSavingDuplex")
64540   If IsNumeric(tStr) Then
64550     If CLng(tStr) = 0 Or CLng(tStr) = 1 Then
64560       .PrintAfterSavingDuplex = CLng(tStr)
64570      Else
64580       If UseStandard Then
64590        .PrintAfterSavingDuplex = 0
64600       End If
64610     End If
64620    Else
64630     If UseStandard Then
64640      .PrintAfterSavingDuplex = 0
64650     End If
64660   End If
64670   tStr = reg.GetRegistryValue("PrintAfterSavingNoCancel")
64680   If IsNumeric(tStr) Then
64690     If CLng(tStr) = 0 Or CLng(tStr) = 1 Then
64700       .PrintAfterSavingNoCancel = CLng(tStr)
64710      Else
64720       If UseStandard Then
64730        .PrintAfterSavingNoCancel = 0
64740       End If
64750     End If
64760    Else
64770     If UseStandard Then
64780      .PrintAfterSavingNoCancel = 0
64790     End If
64800   End If
64810   tStr = reg.GetRegistryValue("PrintAfterSavingPrinter")
64820   If LenB(tStr) = 0 And LenB("") > 0 And UseStandard Then
64830     .PrintAfterSavingPrinter = ""
64840    Else
64850     If LenB(tStr) > 0 Then
64860      .PrintAfterSavingPrinter = tStr
64870     End If
64880   End If
64890   tStr = reg.GetRegistryValue("PrintAfterSavingQueryUser")
64900   If IsNumeric(tStr) Then
64910     If CLng(tStr) >= 0 And CLng(tStr) <= 3 Then
64920       .PrintAfterSavingQueryUser = CLng(tStr)
64930      Else
64940       If UseStandard Then
64950        .PrintAfterSavingQueryUser = 0
64960       End If
64970     End If
64980    Else
64990     If UseStandard Then
65000      .PrintAfterSavingQueryUser = 0
65010     End If
65020   End If
65030   tStr = reg.GetRegistryValue("PrintAfterSavingTumble")
65040   If IsNumeric(tStr) Then
65050     If CLng(tStr) = 0 Or CLng(tStr) = 1 Then
65060       .PrintAfterSavingTumble = CLng(tStr)
65070      Else
65080       If UseStandard Then
65090        .PrintAfterSavingTumble = 0
65100       End If
65110     End If
65120    Else
65130     If UseStandard Then
65140      .PrintAfterSavingTumble = 0
65150     End If
65160   End If
65170   tStr = reg.GetRegistryValue("PrinterStop")
65180   If IsNumeric(tStr) Then
65190     If CLng(tStr) = 0 Or CLng(tStr) = 1 Then
65200       .PrinterStop = CLng(tStr)
65210      Else
...
65290     End If
65300   End If
65310   tStr = reg.GetRegistryValue("PrinterTemppath")
65320   WriteToSpecialLogfile "reg.GetRegistryValue(""PrinterTemppath"")=" & tStr
65330   WriteToSpecialLogfile "Options.PrinterTemppath1=" & .PrinterTemppath
65340   If hkey1 = HKEY_USERS Then
65350     If LenB(tStr) > 0 And LenB(.PrinterTemppath) = 0 Then
65360       .PrinterTemppath = tStr
65370      Else
65380       If UseStandard Then
65390         .PrinterTemppath = GetTempPath
65400        Else
65410         .PrinterTemppath = tStr
65420       End If
65430     End If
65440    Else
65450     If LenB(Trim$(tStr)) > 0 Then
65460      If DirExists(GetSubstFilename2(tStr, False, , , hkey1)) = True Then
65470        .PrinterTemppath = tStr
65480       Else
65490        MakePath ResolveEnvironment(GetSubstFilename2(tStr, False, , , hkey1))
65500        If DirExists(ResolveEnvironment(GetSubstFilename2(tStr, False, , , hkey1))) = False Then
65510          If UseStandard Then
65520            .PrinterTemppath = GetTempPath
65530           Else
65540            .PrinterTemppath = ""
65550            If NoMsg = False Then
65560             MsgBox "PrinterTemppath: '" & tStr & "' = '" & ResolveEnvironment(GetSubstFilename2(tStr, False, , , hkey1)) & "'" & _
             vbCrLf & vbCrLf & LanguageStrings.MessagesMsg07
65580            End If
65590          End If
65600         Else
65610          .PrinterTemppath = tStr
65620        End If
65630      End If
65640     End If
65650   End If
65660   WriteToSpecialLogfile "Options.PrinterTemppath2=" & .PrinterTemppath
65670   tStr = reg.GetRegistryValue("ProcessPriority")
65680   If IsNumeric(tStr) Then
65690     If CLng(tStr) >= 0 And CLng(tStr) <= 3 Then
65700       .ProcessPriority = CLng(tStr)
65710      Else
65720       If UseStandard Then
65730        .ProcessPriority = 1
65740       End If
65750     End If
65760    Else
65770     If UseStandard Then
65780      .ProcessPriority = 1
65790     End If
65800   End If
65810   tStr = reg.GetRegistryValue("ProgramFont")
65820   If LenB(tStr) = 0 And LenB("MS Sans Serif") > 0 And UseStandard Then
65830     .ProgramFont = "MS Sans Serif"
65840    Else
65850     If LenB(tStr) > 0 Then
65860      .ProgramFont = tStr
65870     End If
65880   End If
65890   tStr = reg.GetRegistryValue("ProgramFontCharset")
65900   If IsNumeric(tStr) Then
65910     If CLng(tStr) >= 0 Then
65920       .ProgramFontCharset = CLng(tStr)
65930      Else
65940       If UseStandard Then
65950        .ProgramFontCharset = 0
65960       End If
65970     End If
65980    Else
65990     If UseStandard Then
66000      .ProgramFontCharset = 0
66010     End If
66020   End If
66030   tStr = reg.GetRegistryValue("ProgramFontSize")
66040   If IsNumeric(tStr) Then
66050     If CLng(tStr) >= 1 And CLng(tStr) <= 72 Then
66060       .ProgramFontSize = CLng(tStr)
66070      Else
66080       If UseStandard Then
66090        .ProgramFontSize = 8
66100       End If
66110     End If
66120    Else
66130     If UseStandard Then
66140      .ProgramFontSize = 8
66150     End If
66160   End If
66170   tStr = reg.GetRegistryValue("RemoveAllKnownFileExtensions")
66180   If IsNumeric(tStr) Then
66190     If CLng(tStr) = 0 Or CLng(tStr) = 1 Then
66200       .RemoveAllKnownFileExtensions = CLng(tStr)
66210      Else
66220       If UseStandard Then
66230        .RemoveAllKnownFileExtensions = 1
66240       End If
66250     End If
66260    Else
66270     If UseStandard Then
66280      .RemoveAllKnownFileExtensions = 1
66290     End If
66300   End If
66310   tStr = reg.GetRegistryValue("RemoveSpaces")
66320   If IsNumeric(tStr) Then
66330     If CLng(tStr) = 0 Or CLng(tStr) = 1 Then
66340       .RemoveSpaces = CLng(tStr)
66350      Else
66360       If UseStandard Then
66370        .RemoveSpaces = 1
66380       End If
66390     End If
66400    Else
66410     If UseStandard Then
66420      .RemoveSpaces = 1
66430     End If
66440   End If
66450   tStr = reg.GetRegistryValue("RunProgramAfterSaving")
66460   If IsNumeric(tStr) Then
66470     If CLng(tStr) = 0 Or CLng(tStr) = 1 Then
66480       .RunProgramAfterSaving = CLng(tStr)
66490      Else
66500       If UseStandard Then
66510        .RunProgramAfterSaving = 0
66520       End If
66530     End If
66540    Else
66550     If UseStandard Then
66560      .RunProgramAfterSaving = 0
66570     End If
66580   End If
66590   tStr = reg.GetRegistryValue("RunProgramAfterSavingProgramname")
66600   If LenB(tStr) = 0 And LenB("") > 0 And UseStandard Then
66610     .RunProgramAfterSavingProgramname = ""
66620    Else
66630     If LenB(tStr) > 0 Then
66640      .RunProgramAfterSavingProgramname = tStr
66650     End If
66660   End If
66670   tStr = reg.GetRegistryValue("RunProgramAfterSavingProgramParameters")
66680   If LenB(tStr) = 0 And LenB("""<OutputFilename>""") > 0 And UseStandard Then
66690     .RunProgramAfterSavingProgramParameters = """<OutputFilename>"""
66700    Else
66710     If LenB(tStr) > 0 Then
66720      .RunProgramAfterSavingProgramParameters = tStr
66730     End If
66740   End If
66750   tStr = reg.GetRegistryValue("RunProgramAfterSavingWaitUntilReady")
66760   If IsNumeric(tStr) Then
66770     If CLng(tStr) = 0 Or CLng(tStr) = 1 Then
66780       .RunProgramAfterSavingWaitUntilReady = CLng(tStr)
66790      Else
66800       If UseStandard Then
66810        .RunProgramAfterSavingWaitUntilReady = 1
66820       End If
66830     End If
66840    Else
66850     If UseStandard Then
66860      .RunProgramAfterSavingWaitUntilReady = 1
66870     End If
66880   End If
66890   tStr = reg.GetRegistryValue("RunProgramAfterSavingWindowstyle")
66900   If IsNumeric(tStr) Then
66910     If CLng(tStr) >= 0 And CLng(tStr) <= 6 Then
66920       .RunProgramAfterSavingWindowstyle = CLng(tStr)
66930      Else
66940       If UseStandard Then
66950        .RunProgramAfterSavingWindowstyle = 1
66960       End If
66970     End If
66980    Else
66990     If UseStandard Then
67000      .RunProgramAfterSavingWindowstyle = 1
67010     End If
67020   End If
67030   tStr = reg.GetRegistryValue("RunProgramBeforeSaving")
67040   If IsNumeric(tStr) Then
67050     If CLng(tStr) = 0 Or CLng(tStr) = 1 Then
67060       .RunProgramBeforeSaving = CLng(tStr)
67070      Else
67080       If UseStandard Then
67090        .RunProgramBeforeSaving = 0
67100       End If
67110     End If
67120    Else
67130     If UseStandard Then
67140      .RunProgramBeforeSaving = 0
67150     End If
67160   End If
67170   tStr = reg.GetRegistryValue("RunProgramBeforeSavingProgramname")
67180   If LenB(tStr) = 0 And LenB("") > 0 And UseStandard Then
67190     .RunProgramBeforeSavingProgramname = ""
67200    Else
67210     If LenB(tStr) > 0 Then
67220      .RunProgramBeforeSavingProgramname = tStr
67230     End If
67240   End If
67250   tStr = reg.GetRegistryValue("RunProgramBeforeSavingProgramParameters")
67260   If LenB(tStr) = 0 And LenB("""<TempFilename>""") > 0 And UseStandard Then
67270     .RunProgramBeforeSavingProgramParameters = """<TempFilename>"""
67280    Else
67290     If LenB(tStr) > 0 Then
67300      .RunProgramBeforeSavingProgramParameters = tStr
67310     End If
67320   End If
67330   tStr = reg.GetRegistryValue("RunProgramBeforeSavingWindowstyle")
67340   If IsNumeric(tStr) Then
67350     If CLng(tStr) >= 0 And CLng(tStr) <= 6 Then
67360       .RunProgramBeforeSavingWindowstyle = CLng(tStr)
67370      Else
67380       If UseStandard Then
67390        .RunProgramBeforeSavingWindowstyle = 1
67400       End If
67410     End If
67420    Else
67430     If UseStandard Then
67440      .RunProgramBeforeSavingWindowstyle = 1
67450     End If
67460   End If
67470   tStr = reg.GetRegistryValue("SaveFilename")
67480   If LenB(tStr) = 0 And LenB("<Title>") > 0 And UseStandard Then
67490     .SaveFilename = "<Title>"
67500    Else
67510     If LenB(tStr) > 0 Then
67520      .SaveFilename = tStr
67530     End If
67540   End If
67550   tStr = reg.GetRegistryValue("SendEmailAfterAutoSaving")
67560   If IsNumeric(tStr) Then
67570     If CLng(tStr) = 0 Or CLng(tStr) = 1 Then
67580       .SendEmailAfterAutoSaving = CLng(tStr)
67590      Else
67600       If UseStandard Then
67610        .SendEmailAfterAutoSaving = 0
67620       End If
67630     End If
67640    Else
67650     If UseStandard Then
67660      .SendEmailAfterAutoSaving = 0
67670     End If
67680   End If
67690   tStr = reg.GetRegistryValue("SendMailMethod")
67700   If IsNumeric(tStr) Then
67710     If CLng(tStr) >= 0 Then
67720       .SendMailMethod = CLng(tStr)
67730      Else
67740       If UseStandard Then
67750        .SendMailMethod = 0
67760       End If
67770     End If
67780    Else
67790     If UseStandard Then
67800      .SendMailMethod = 0
67810     End If
67820   End If
67830   tStr = reg.GetRegistryValue("ShowAnimation")
67840   If IsNumeric(tStr) Then
67850     If CLng(tStr) = 0 Or CLng(tStr) = 1 Then
67860       .ShowAnimation = CLng(tStr)
67870      Else
67880       If UseStandard Then
67890        .ShowAnimation = 1
67900       End If
67910     End If
67920    Else
67930     If UseStandard Then
67940      .ShowAnimation = 1
67950     End If
67960   End If
67970   tStr = reg.GetRegistryValue("StartStandardProgram")
67980   If IsNumeric(tStr) Then
67990     If CLng(tStr) = 0 Or CLng(tStr) = 1 Then
68000       .StartStandardProgram = CLng(tStr)
68010      Else
68020       If UseStandard Then
68030        .StartStandardProgram = 1
68040       End If
68050     End If
68060    Else
68070     If UseStandard Then
68080      .StartStandardProgram = 1
68090     End If
68100   End If
68110   tStr = reg.GetRegistryValue("Toolbars")
68120   If IsNumeric(tStr) Then
68130     If CLng(tStr) >= 0 Then
68140       .Toolbars = CLng(tStr)
68150      Else
...
68230     End If
68240   End If
68250   tStr = reg.GetRegistryValue("UseAutosave")
68260   If IsNumeric(tStr) Then
68270     If CLng(tStr) = 0 Or CLng(tStr) = 1 Then
68280       .UseAutosave = CLng(tStr)
68290      Else
...
68370     End If
68380   End If
68390   tStr = reg.GetRegistryValue("UseAutosaveDirectory")
68400   If IsNumeric(tStr) Then
68410     If CLng(tStr) = 0 Or CLng(tStr) = 1 Then
68420       .UseAutosaveDirectory = CLng(tStr)
68430      Else
68440       If UseStandard Then
68450        .UseAutosaveDirectory = 1
68460       End If
68470     End If
68480    Else
68490     If UseStandard Then
68500      .UseAutosaveDirectory = 1
68510     End If
68520   End If
68530  End With
68540  Set reg = Nothing
68550  ReadOptionsReg = myOptions
'---ErrPtnr-OnError-START--- DO NOT MODIFY ! ---
Exit Function
ErrPtnr_OnError:
...
59540     reg.CreateKey
59550    End If
59560    reg.SetRegistryValue "PrintAfterSavingTumble", CStr(Abs(.PrintAfterSavingTumble)), REG_SZ
...
51660   reg.SetRegistryValue "PrintAfterSavingTumble", CStr(Abs(.PrintAfterSavingTumble)), REG_SZ
...
50320  .OptionsDesign = Frm.cmbOptionsDesign.ListIndex
50330  .PCXColorscount = Frm.cmbPCXColors.ListIndex
50340  .PDFAllowAssembly = Abs(Frm.chkAllowAssembly.Value)
50350  .PDFAllowDegradedPrinting = Abs(Frm.chkAllowDegradedPrinting.Value)
50360  .PDFAllowFillIn = Abs(Frm.chkAllowFillIn.Value)
50370  .PDFAllowScreenReaders = Abs(Frm.chkAllowScreenReaders.Value)
50380  .PDFColorsCMYKToRGB = Abs(Frm.chkPDFCMYKtoRGB.Value)
50390  .PDFColorsColorModel = Frm.cmbPDFColorModel.ListIndex
50400  .PDFColorsPreserveHalftone = Abs(Frm.chkPDFPreserveHalftone.Value)
50410  .PDFColorsPreserveOverprint = Abs(Frm.chkPDFPreserveOverprint.Value)
50420  .PDFColorsPreserveTransfer = Abs(Frm.chkPDFPreserveTransfer.Value)
50430  .PDFCompressionColorCompression = Abs(Frm.chkPDFColorComp.Value)
50440  .PDFCompressionColorCompressionChoice = Frm.cmbPDFColorComp.ListIndex
50450  .PDFCompressionColorResample = Abs(Frm.chkPDFColorResample.Value)
50460  .PDFCompressionColorResampleChoice = Frm.cmbPDFColorResample.ListIndex
50470  .PDFCompressionColorResolution = Frm.txtPDFColorRes.Text
50480  .PDFCompressionGreyCompression = Abs(Frm.chkPDFGreyComp.Value)
50490  .PDFCompressionGreyCompressionChoice = Frm.cmbPDFGreyComp.ListIndex
50500  .PDFCompressionGreyResample = Abs(Frm.chkPDFGreyResample.Value)
50510  .PDFCompressionGreyResampleChoice = Frm.cmbPDFGreyResample.ListIndex
50520  .PDFCompressionGreyResolution = Frm.txtPDFGreyRes.Text
50530  .PDFCompressionMonoCompression = Abs(Frm.chkPDFMonoComp.Value)
50540  .PDFCompressionMonoCompressionChoice = Frm.cmbPDFMonoComp.ListIndex
50550  .PDFCompressionMonoResample = Abs(Frm.chkPDFMonoResample.Value)
50560  .PDFCompressionMonoResampleChoice = Frm.cmbPDFMonoResample.ListIndex
50570  .PDFCompressionMonoResolution = Frm.txtPDFMonoRes.Text
50580  .PDFCompressionTextCompression = Abs(Frm.chkPDFTextComp.Value)
50590  .PDFDisallowCopy = Abs(Frm.chkAllowCopy.Value)
50600  .PDFDisallowModifyAnnotations = Abs(Frm.chkAllowModifyAnnotations.Value)
50610  .PDFDisallowModifyContents = Abs(Frm.chkAllowModifyContents.Value)
50620  .PDFDisallowPrinting = Abs(Frm.chkAllowPrinting.Value)
50630  If Frm.cmbPDFEncryptor.ListIndex < 0 Then
50640    .PDFEncryptor = 0
50650   Else
50660    .PDFEncryptor = Frm.cmbPDFEncryptor.ItemData(Frm.cmbPDFEncryptor.ListIndex)
50670  End If
50680  .PDFFontsEmbedAll = Abs(Frm.chkPDFEmbedAll.Value)
50690  .PDFFontsSubSetFonts = Abs(Frm.chkPDFSubSetFonts.Value)
50700  .PDFFontsSubSetFontsPercent = Frm.txtPDFSubSetPerc.Text
50710  .PDFGeneralASCII85 = Abs(Frm.chkPDFASCII85.Value)
50720  .PDFGeneralAutorotate = Frm.cmbPDFRotate.ListIndex
50730  .PDFGeneralCompatibility = Frm.cmbPDFCompat.ListIndex
50740  .PDFGeneralOverprint = Frm.cmbPDFOverprint.ListIndex
50750  .PDFGeneralResolution = Frm.txtPDFRes.Text
50760  .PDFHighEncryption = Abs(Frm.optEncHigh.Value)
50770  .PDFLowEncryption = Abs(Frm.optEncLow.Value)
50780  .PDFOwnerPass = Abs(Frm.chkOwnerPass.Value)
50790  .PDFUserPass = Abs(Frm.chkUserPass.Value)
50800  .PDFUseSecurity = Abs(Frm.chkUseSecurity.Value)
50810  .PNGColorscount = Frm.cmbPNGColors.ListIndex
50820  .PrinterTemppath = Frm.txtTemppath.Text
50830  .ProcessPriority = Frm.sldProcessPriority.Value
50840  .ProgramFont = Frm.cmbFonts.List(Frm.cmbFonts.ListIndex)
50850  .ProgramFontCharset = Frm.cmbCharset.Text
50860  .ProgramFontSize = Frm.cmbProgramFontsize.Text
50870  .PSLanguageLevel = Frm.cmbPSLanguageLevel.ListIndex
50880  .RemoveSpaces = Abs(Frm.chkSpaces.Value)
50890  .RunProgramAfterSaving = Abs(Frm.chkRunProgramAfterSaving.Value)
50900  .RunProgramAfterSavingProgramname = Frm.cmbRunProgramAfterSavingProgramname.Text
50910  .RunProgramAfterSavingProgramParameters = Frm.txtRunProgramAfterSavingProgramParameters.Text
50920  .RunProgramAfterSavingWaitUntilReady = Abs(Frm.chkRunProgramAfterSavingWaitUntilReady.Value)
50930  .RunProgramAfterSavingWindowstyle = Frm.cmbRunProgramAfterSavingWindowstyle.ListIndex
50940  .RunProgramBeforeSaving = Abs(Frm.chkRunProgramBeforeSaving.Value)
50950  .RunProgramBeforeSavingProgramname = Frm.cmbRunProgramBeforeSavingProgramname.Text
50960  .RunProgramBeforeSavingProgramParameters = Frm.txtRunProgramBeforeSavingProgramParameters.Text
50970  .RunProgramBeforeSavingWindowstyle = Frm.cmbRunProgramBeforeSavingWindowstyle.ListIndex
50980  .SaveFilename = Frm.txtSaveFilename.Text
50990  .SendEmailAfterAutoSaving = Abs(Frm.chkAutosaveSendEmail.Value)
51000  .ShowAnimation = Abs(Frm.chkShowAnimation)
51010  .StandardAuthor = Frm.txtStandardAuthor.Text
51020  .TIFFColorscount = Frm.cmbTIFFColors.ListIndex
51030  .UseAutosave = Abs(Frm.chkUseAutosave.Value)
51040  .UseAutosaveDirectory = Abs(Frm.chkUseAutosaveDirectory.Value)
51050  .UseCreationDateNow = Abs(Frm.chkUseCreationDateNow.Value)
51060  .UseStandardAuthor = Abs(Frm.chkUseStandardAuthor.Value)
51070  End With
'---ErrPtnr-OnError-START--- DO NOT MODIFY ! ---
Exit Sub
ErrPtnr_OnError:
