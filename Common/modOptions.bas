...
50990  .ShowAnimation = Abs(Frm.chkShowAnimation)
51000  .StandardAuthor = Frm.txtStandardAuthor.Text
51010  .TIFFColorscount = Frm.cmbTIFFColors.ListIndex
51020  .UseAutosave = Abs(Frm.chkUseAutosave.Value)
51030  .UseAutosaveDirectory = Abs(Frm.chkUseAutosaveDirectory.Value)
51040  .UseCreationDateNow = Abs(Frm.chkUseCreationDateNow.Value)
51050  .UseStandardAuthor = Abs(Frm.chkUseStandardAuthor.Value)
51060  End With
'---ErrPtnr-OnError-START--- DO NOT MODIFY ! ---
Exit Sub
ErrPtnr_OnError:
