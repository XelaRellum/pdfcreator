...
Public Function StandardOptions() As tOptions
 Const Hash As String = "0001B4FD-9EA3-4D90-A79E-FD14BA3AB01D"
 ...
 With myOptions
  ...
  .Counter = "0"
  .DeviceHeightPoints = Replace$("842", ".", GetDecimalChar)
  .DeviceWidthPoints = Replace$("595", ".", GetDecimalChar)
  .DirectoryGhostscriptBinaries = vbNullString
  .DirectoryGhostscriptFonts = vbNullString
  .DirectoryGhostscriptLibraries = vbNullString
  .DirectoryGhostscriptResource = vbNullString
  .DisableEmail = "0"
  ...
  .PDFSigningMultiSignature = "0"
  .PDFSigningPFXFile = vbNullString
  .PDFSigningPFXFilePassword = vbNullString
  .PDFSigningSignatureContact = vbNullString
...
Public Function ReadOptions(Optional NoMsg As Boolean = False, Optional hProfile As hkey = HKEY_CURRENT_USER, Optional ProfileName As String = "") As tOptions
 Dim myOptions As tOptions, Str1 as String
 Dim tStr As String
 ...
 If InstalledAsServer Then
   ...
   If LenB(ProfileName) > 0 Then
     myOptions = ReadOptionsReg(myOptions, "Software\PDFCreator\Profiles\" & ProfileName, HKEY_LOCAL_MACHINE, NoMsg)
    Else
  ...
  Else
   If Not IsWin9xMe Then
     ...
     If LenB(ProfileName) > 0 Then
       myOptions = ReadOptionsReg(myOptions, "Software\PDFCreator\Profiles\" & ProfileName, hProfile, NoMsg, False)
      Else
   ...
   WriteToSpecialLogfile "Reg-Read options: HKEY_LOCAL_MACHINE"
    If LenB(ProfileName) > 0 Then
     myOptions = ReadOptionsReg(myOptions, "Software\PDFCreator\Profiles\" & ProfileName, HKEY_LOCAL_MACHINE, NoMsg, False)
    Else
     myOptions = ReadOptionsReg(myOptions, "Software\PDFCreator", HKEY_LOCAL_MACHINE, NoMsg, False)
   End If
 End If
 Str1 = "7777772E706466666F7267652E6F7267"
 myOptions = CorrectOptionsAfterLoading(myOptions)
 ...
 With myOptions
  ...
  If IsNumeric(tStr) Then
   ...
   Else
    ...
    End If
  End If
  tStr = hOpt.Retrieve("AllowSpecialGSCharsInFilenames")
  If IsNumeric(tStr) Then
    If CLng(tStr) = 0 Or CLng(tStr) = 1 Then
      .AllowSpecialGSCharsInFilenames = CLng(tStr)
     Else
      If UseStandard Then
       .AllowSpecialGSCharsInFilenames = 1
      End If
  ...
  If IsNumeric(tStr) Then
    If CLng(tStr) >= 0 And CLng(tStr) <= 14 Then
  ...
  If IsNumeric(tStr) Then
   ...
   Else
    ...
    End If
  End If
  tStr = hOpt.Retrieve("BMPResolution")
  If IsNumeric(tStr) Then
    If CLng(tStr) >= 1 Then
      .BMPResolution = CLng(tStr)
     Else
      If UseStandard Then
       .BMPResolution = 150
      End If
  ...
  If IsNumeric(tStr) Then
   ...
   Else
    ...
    End If
  End If
  tStr = hOpt.Retrieve("Counter")
  If IsNumeric(tStr) Then
    If CCur(tStr) >= 0 And CCur(tStr) <= 922337203685477 Then
      .Counter = CCur(tStr)
     Else
      If UseStandard Then
       .Counter = 0
  ...
  If LenB(tStr) = 0 And LenB("Microsoft Word - \.docx\.doc\Microsoft Excel - \.xlsx\.xls\Microsoft PowerPoint - \.pptx\.ppt") > 0 And UseStandard Then
    .FilenameSubstitutions = "Microsoft Word - \.docx\.doc\Microsoft Excel - \.xlsx\.xls\Microsoft PowerPoint - \.pptx\.ppt"
   Else
    If LenB(tStr) > 0 Then
  ...
  If IsNumeric(tStr) Then
   ...
   Else
    ...
    End If
  End If
  tStr = hOpt.Retrieve("JPEGResolution")
  If IsNumeric(tStr) Then
    If CLng(tStr) >= 1 Then
      .JPEGResolution = CLng(tStr)
     Else
      If UseStandard Then
       .JPEGResolution = 150
      End If
  ...
  If LenB(Trim$(tStr)) > 0 Then
   ...
   Else
    ...
    End If
  End If
  tStr = hOpt.Retrieve("LastUpdateCheck")
  If LenB(tStr) = 0 And LenB("") > 0 And UseStandard Then
    .LastUpdateCheck = ""
   Else
    If LenB(tStr) > 0 Then
     .LastUpdateCheck = tStr
    End If
  End If
  ...
  If LenB(tStr) = 0 And LenB("a4") > 0 And UseStandard Then
    .Papersize = "a4"
   Else
    If LenB(tStr) > 0 Then
     .Papersize = tStr
    End If
  End If
  tStr = hOpt.Retrieve("PCLColorsCount")
  If IsNumeric(tStr) Then
    If CLng(tStr) >= 0 And CLng(tStr) <= 1 Then
      .PCLColorsCount = CLng(tStr)
     Else
      If UseStandard Then
       .PCLColorsCount = 0
      End If
   ...
   Else
    ...
    End If
  End If
  tStr = hOpt.Retrieve("PCLResolution")
  If IsNumeric(tStr) Then
    If CLng(tStr) >= 1 Then
      .PCLResolution = CLng(tStr)
     Else
      If UseStandard Then
       .PCLResolution = 150
      End If
  ...
  If IsNumeric(tStr) Then
   ...
   Else
    ...
    End If
  End If
  tStr = hOpt.Retrieve("PCXResolution")
  If IsNumeric(tStr) Then
    If CLng(tStr) >= 1 Then
      .PCXResolution = CLng(tStr)
     Else
      If UseStandard Then
       .PCXResolution = 150
      End If
  ...
  If IsNumeric(tStr) Then
   ...
   Else
    ...
    End If
  End If
  tStr = hOpt.Retrieve("PDFGeneralDefault")
  If IsNumeric(tStr) Then
    If CLng(tStr) >= 0 And CLng(tStr) <= 4 Then
      .PDFGeneralDefault = CLng(tStr)
     Else
      If UseStandard Then
       .PDFGeneralDefault = 0
      End If
  ...
  If LenB(tStr) = 0 And LenB("") > 0 And UseStandard Then
   ...
   Else
    ...
    End If
  End If
  tStr = hOpt.Retrieve("PDFSigningMultiSignature")
  If IsNumeric(tStr) Then
    If CLng(tStr) = 0 Or CLng(tStr) = 1 Then
      .PDFSigningMultiSignature = CLng(tStr)
     Else
      If UseStandard Then
       .PDFSigningMultiSignature = 0
      End If
   ...
   Else
    ...
    End If
  End If
  tStr = hOpt.Retrieve("PDFSigningPFXFile")
  If LenB(tStr) = 0 And LenB("") > 0 And UseStandard Then
    .PDFSigningPFXFile = ""
   Else
    If LenB(tStr) > 0 Then
     .PDFSigningPFXFile = tStr
    End If
  End If
  tStr = hOpt.Retrieve("PDFSigningPFXFilePassword")
  If LenB(tStr) = 0 And LenB("") > 0 And UseStandard Then
    .PDFSigningPFXFilePassword = ""
   Else
    If LenB(tStr) > 0 Then
     .PDFSigningPFXFilePassword = tStr
    End If
  End If
  tStr = hOpt.Retrieve("PDFSigningSignatureContact")
  If LenB(tStr) = 0 And LenB("") > 0 And UseStandard Then
    .PDFSigningSignatureContact = ""
   Else
    If LenB(tStr) > 0 Then
     .PDFSigningSignatureContact = tStr
    End If
  End If
  tStr = hOpt.Retrieve("PDFSigningSignatureLeftX")
  If IsNumeric(Replace$(tStr, ".", GetDecimalChar)) Then
    If CDbl(Replace$(tStr, ".", GetDecimalChar)) >= 0 Then
      .PDFSigningSignatureLeftX = CDbl(Replace$(tStr, ".", GetDecimalChar))
     Else
      If UseStandard Then
       .PDFSigningSignatureLeftX = Replace$("100", ".", GetDecimalChar)
      End If
   ...
   Else
    ...
    End If
  End If
  tStr = hOpt.Retrieve("PDFSigningSignatureLeftY")
  If IsNumeric(Replace$(tStr, ".", GetDecimalChar)) Then
    If CDbl(Replace$(tStr, ".", GetDecimalChar)) >= 0 Then
      .PDFSigningSignatureLeftY = CDbl(Replace$(tStr, ".", GetDecimalChar))
     Else
      If UseStandard Then
       .PDFSigningSignatureLeftY = Replace$("100", ".", GetDecimalChar)
      End If
   ...
   Else
    ...
    End If
  End If
  tStr = hOpt.Retrieve("PDFSigningSignatureLocation")
  If LenB(tStr) = 0 And LenB("") > 0 And UseStandard Then
    .PDFSigningSignatureLocation = ""
   Else
    If LenB(tStr) > 0 Then
  ...
  If LenB(tStr) = 0 And LenB("") > 0 And UseStandard Then
   ...
   Else
    If LenB(tStr) > 0 Then
     .PDFSigningSignatureReason = tStr
    End If
  End If
  tStr = hOpt.Retrieve("PDFSigningSignatureRightX")
  If IsNumeric(Replace$(tStr, ".", GetDecimalChar)) Then
    If CDbl(Replace$(tStr, ".", GetDecimalChar)) >= 0 Then
      .PDFSigningSignatureRightX = CDbl(Replace$(tStr, ".", GetDecimalChar))
     Else
      If UseStandard Then
       .PDFSigningSignatureRightX = Replace$("200", ".", GetDecimalChar)
      End If
   ...
   Else
    ...
    End If
  End If
  tStr = hOpt.Retrieve("PDFSigningSignatureRightY")
  If IsNumeric(Replace$(tStr, ".", GetDecimalChar)) Then
    If CDbl(Replace$(tStr, ".", GetDecimalChar)) >= 0 Then
      .PDFSigningSignatureRightY = CDbl(Replace$(tStr, ".", GetDecimalChar))
     Else
      If UseStandard Then
       .PDFSigningSignatureRightY = Replace$("200", ".", GetDecimalChar)
      End If
   ...
   Else
    ...
    End If
  End If
  tStr = hOpt.Retrieve("PDFSigningSignatureVisible")
  If IsNumeric(tStr) Then
    If CLng(tStr) = 0 Or CLng(tStr) = 1 Then
      .PDFSigningSignatureVisible = CLng(tStr)
     Else
      If UseStandard Then
       .PDFSigningSignatureVisible = 0
      End If
   ...
   Else
    ...
    End If
  End If
  tStr = hOpt.Retrieve("PDFSigningSignPDF")
  If IsNumeric(tStr) Then
    If CLng(tStr) = 0 Or CLng(tStr) = 1 Then
      .PDFSigningSignPDF = CLng(tStr)
     Else
      If UseStandard Then
       .PDFSigningSignPDF = 0
      End If
   ...
   Else
    ...
    End If
  End If
  tStr = hOpt.Retrieve("PDFUpdateMetadata")
  If IsNumeric(tStr) Then
    If CLng(tStr) >= 0 And CLng(tStr) <= 2 Then
      .PDFUpdateMetadata = CLng(tStr)
     Else
      If UseStandard Then
       .PDFUpdateMetadata = 1
      End If
  ...
  If IsNumeric(tStr) Then
   ...
   Else
    ...
    End If
  End If
  tStr = hOpt.Retrieve("PNGResolution")
  If IsNumeric(tStr) Then
    If CLng(tStr) >= 1 Then
      .PNGResolution = CLng(tStr)
     Else
      If UseStandard Then
       .PNGResolution = 150
      End If
  ...
  If IsNumeric(tStr) Then
    If CLng(tStr) >= 6 And CLng(tStr) <= 72 Then
   ...
   Else
    ...
    End If
  End If
  tStr = hOpt.Retrieve("PSDColorsCount")
  If IsNumeric(tStr) Then
    If CLng(tStr) >= 0 And CLng(tStr) <= 1 Then
      .PSDColorsCount = CLng(tStr)
     Else
      If UseStandard Then
       .PSDColorsCount = 0
      End If
   ...
   Else
    ...
    End If
  End If
  tStr = hOpt.Retrieve("PSDResolution")
  If IsNumeric(tStr) Then
    If CLng(tStr) >= 1 Then
      .PSDResolution = CLng(tStr)
     Else
      If UseStandard Then
       .PSDResolution = 150
      End If
  ...
  If IsNumeric(tStr) Then
   ...
   Else
    ...
    End If
  End If
  tStr = hOpt.Retrieve("RAWColorsCount")
  If IsNumeric(tStr) Then
    If CLng(tStr) >= 0 And CLng(tStr) <= 2 Then
      .RAWColorsCount = CLng(tStr)
     Else
      If UseStandard Then
       .RAWColorsCount = 0
      End If
   ...
   Else
    ...
    End If
  End If
  tStr = hOpt.Retrieve("RAWResolution")
  If IsNumeric(tStr) Then
    If CLng(tStr) >= 1 Then
      .RAWResolution = CLng(tStr)
     Else
      If UseStandard Then
       .RAWResolution = 150
      End If
  ...
  If IsNumeric(tStr) Then
   ...
   Else
    ...
    End If
  End If
  tStr = hOpt.Retrieve("SVGResolution")
  If IsNumeric(tStr) Then
    If CLng(tStr) >= 1 Then
      .SVGResolution = CLng(tStr)
     Else
      If UseStandard Then
       .SVGResolution = 72
      End If
  ...
  If IsNumeric(tStr) Then
   ...
   Else
    ...
    End If
  End If
  tStr = hOpt.Retrieve("TIFFResolution")
  If IsNumeric(tStr) Then
    If CLng(tStr) >= 1 Then
      .TIFFResolution = CLng(tStr)
     Else
      If UseStandard Then
       .TIFFResolution = 150
      End If
  ...
  If IsNumeric(tStr) Then
   ...
   Else
    ...
    End If
  End If
  tStr = hOpt.Retrieve("UpdateInterval")
  If IsNumeric(tStr) Then
    If CLng(tStr) >= 0 And CLng(tStr) <= 3 Then
      .UpdateInterval = CLng(tStr)
     Else
      If UseStandard Then
       .UpdateInterval = 2
      End If
  ...
  If IsNumeric(tStr) Then
   ...
   Else
    ...
    End If
  End If
  tStr = hOpt.Retrieve("UseCustomPaperSize")
  If LenB(tStr) = 0 And LenB("0") > 0 And UseStandard Then
    .UseCustomPaperSize = "0"
   Else
    If LenB(tStr) > 0 Then
     .UseCustomPaperSize = tStr
    End If
  End If
  tStr = hOpt.Retrieve("UseFixPapersize")
  If IsNumeric(tStr) Then
    If CLng(tStr) = 0 Or CLng(tStr) = 1 Then
      .UseFixPapersize = CLng(tStr)
     Else
      If UseStandard Then
       .UseFixPapersize = 0
      End If
...
Public Function CorrectOptionsAfterLoading(Options As tOptions) As tOptions
 Dim fns As String, fnsf() As String, nfnsf() As String, i As Long, j As Long
 fns = Options.FilenameSubstitutions
 If LenB(fns) = 0 Then
  CorrectOptionsAfterLoading = Options
  Exit Function
 End If
 If InStr(1, fns, "\") = 0 Then
  CorrectOptionsAfterLoading = Options
  Exit Function
 End If
 fnsf = Split(fns, "\")
 ReDim nfnsf(0)
 nfnsf(0) = fnsf(0)
 For i = 1 To UBound(fnsf)
  For j = LBound(nfnsf) To UBound(nfnsf)
   If nfnsf(j) = fnsf(i) Then
    Exit For
   End If
   DoEvents
  Next j
  If j > UBound(nfnsf) Then
   ReDim Preserve nfnsf(UBound(nfnsf) + 1)
   nfnsf(UBound(nfnsf)) = fnsf(i)
  End If
  DoEvents
 Next i
 fns = nfnsf(0)
 For i = 1 To UBound(nfnsf)
  fns = fns & "\" & nfnsf(i)
  DoEvents
 Next i
 Options.FilenameSubstitutions = fns
 CorrectOptionsAfterLoading = Options
End Function
...
End Sub
 ...
 Dim Profiles As Collection, i As Long
 Set Profiles = GetProfiles
 For i = 1 To Profiles.Count
  If LCase$(Profiles(i)) = LCase$(ProfileName) Then
   ProfileExists = True
   Exit Function
  End If
 Next i
...
Public Function GetProfiles() As Collection
 ...
 reg.KeyRoot = "Software\PDFCreator\Profiles\"
 ...
 End If
 Set GetProfiles = reg.EnumRegistryKeys(reg.hkey, reg.KeyRoot)
End Function

Public Function GetPrinterDefaultProfile(Printername As String) As String
 Dim reg As clsRegistry, PrinterProfiles As Collection, i As Long
 Set reg = New clsRegistry
 reg.KeyRoot = "Software\PDFCreator\Printers\"
 If InstalledAsServer Then
   reg.hkey = HKEY_LOCAL_MACHINE
  Else
   reg.hkey = HKEY_CURRENT_USER
 End If
 Set PrinterProfiles = reg.EnumRegistryValues(reg.hkey, "Software\PDFCreator\Printers\")
 For i = 1 To PrinterProfiles.Count
  If UCase$(Trim$(PrinterProfiles(i)(0))) = UCase$(Trim$(Printername)) Then
   GetPrinterDefaultProfile = PrinterProfiles(i)(1)
   Exit For
  End If
 Next i
End Function
...
Public Sub SaveOptions(sOptions As tOptions, Optional ProfileName As String = "")
 ...
 If InstalledAsServer Then
   SaveOptionsReg sOptions, HKEY_LOCAL_MACHINE, ProfileName
  Else
   SaveOptionsReg sOptions, , ProfileName
 End If
End Sub

Public Sub SaveOption(sOptions As tOptions, OptionName As String, Optional ProfileName As String = "")
 If InstalledAsServer Then
   SaveOptionReg sOptions, OptionName, HKEY_LOCAL_MACHINE, ProfileName
  Else
   SaveOptionReg sOptions, OptionName, , ProfileName
 End If
End Sub
...
Public Sub SaveOptionINI(sOptions As tOptions, OptionName As String, PDFCreatorINIFile As String)
 ...
 With sOptions
  ...
  Case "ALLOWSPECIALGSCHARSINFILENAMES":ini.SaveKey CStr(Abs(.AllowSpecialGSCharsInFilenames)), "AllowSpecialGSCharsInFilenames"
  ...
  Case "JPEGRESOLUTION":ini.SaveKey CStr(.JPEGResolution), "JPEGResolution"
  ...
  Case "LASTUPDATECHECK":ini.SaveKey CStr(.LastUpdateCheck), "LastUpdateCheck"
  ...
  Case "PCLCOLORSCOUNT":ini.SaveKey CStr(.PCLColorsCount), "PCLColorsCount"
  Case "PCLRESOLUTION":ini.SaveKey CStr(.PCLResolution), "PCLResolution"
  Case "PCXCOLORSCOUNT":ini.SaveKey CStr(.PCXColorscount), "PCXColorscount"
  Case "PCXRESOLUTION":ini.SaveKey CStr(.PCXResolution), "PCXResolution"
  ...
  Case "PDFGENERALDEFAULT":ini.SaveKey CStr(.PDFGeneralDefault), "PDFGeneralDefault"
  ...
  Case "PDFSIGNINGMULTISIGNATURE":ini.SaveKey CStr(Abs(.PDFSigningMultiSignature)), "PDFSigningMultiSignature"
  Case "PDFSIGNINGPFXFILE":ini.SaveKey CStr(.PDFSigningPFXFile), "PDFSigningPFXFile"
  Case "PDFSIGNINGPFXFILEPASSWORD":ini.SaveKey CStr(.PDFSigningPFXFilePassword), "PDFSigningPFXFilePassword"
  Case "PDFSIGNINGSIGNATURECONTACT":ini.SaveKey CStr(.PDFSigningSignatureContact), "PDFSigningSignatureContact"
  ...
  Case "PDFSIGNINGSIGNATUREVISIBLE":ini.SaveKey CStr(Abs(.PDFSigningSignatureVisible)), "PDFSigningSignatureVisible"
  Case "PDFSIGNINGSIGNPDF":ini.SaveKey CStr(Abs(.PDFSigningSignPDF)), "PDFSigningSignPDF"
  Case "PDFUPDATEMETADATA":ini.SaveKey CStr(.PDFUpdateMetadata), "PDFUpdateMetadata"
  ...
  Case "PNGRESOLUTION":ini.SaveKey CStr(.PNGResolution), "PNGResolution"
  ...
  Case "PRINTAFTERSAVINGTUMBLE":ini.SaveKey CStr(.PrintAfterSavingTumble), "PrintAfterSavingTumble"
  ...
  Case "PSDCOLORSCOUNT":ini.SaveKey CStr(.PSDColorsCount), "PSDColorsCount"
  Case "PSDRESOLUTION":ini.SaveKey CStr(.PSDResolution), "PSDResolution"
  Case "PSLANGUAGELEVEL":ini.SaveKey CStr(.PSLanguageLevel), "PSLanguageLevel"
  Case "RAWCOLORSCOUNT":ini.SaveKey CStr(.RAWColorsCount), "RAWColorsCount"
  Case "RAWRESOLUTION":ini.SaveKey CStr(.RAWResolution), "RAWResolution"
  ...
  Case "SVGRESOLUTION":ini.SaveKey CStr(.SVGResolution), "SVGResolution"
  Case "TIFFCOLORSCOUNT":ini.SaveKey CStr(.TIFFColorscount), "TIFFColorscount"
  Case "TIFFRESOLUTION":ini.SaveKey CStr(.TIFFResolution), "TIFFResolution"
  Case "TOOLBARS":ini.SaveKey CStr(.Toolbars), "Toolbars"
  Case "UPDATEINTERVAL":ini.SaveKey CStr(.UpdateInterval), "UpdateInterval"
  ...
  Case "USECUSTOMPAPERSIZE":ini.SaveKey CStr(.UseCustomPaperSize), "UseCustomPaperSize"
  Case "USEFIXPAPERSIZE":ini.SaveKey CStr(Abs(.UseFixPapersize)), "UseFixPapersize"
...
Public Sub SaveOptionsINI(sOptions as tOptions, PDFCreatorINIFile As String)
 ...
 With sOptions
  ...
  ini.SaveKey CStr(Abs(.AllowSpecialGSCharsInFilenames)), "AllowSpecialGSCharsInFilenames"
  ...
  ini.SaveKey CStr(.JPEGResolution), "JPEGResolution"
  ini.SaveKey CStr(.Language), "Language"
  ini.SaveKey CStr(.LastSaveDirectory), "LastSaveDirectory"
  ini.SaveKey CStr(.LastUpdateCheck), "LastUpdateCheck"
  ...
  ini.SaveKey CStr(.PCLColorsCount), "PCLColorsCount"
  ini.SaveKey CStr(.PCLResolution), "PCLResolution"
  ini.SaveKey CStr(.PCXColorscount), "PCXColorscount"
  ini.SaveKey CStr(.PCXResolution), "PCXResolution"
  ...
  ini.SaveKey CStr(.PDFGeneralDefault), "PDFGeneralDefault"
  ...
  ini.SaveKey CStr(Abs(.PDFSigningMultiSignature)), "PDFSigningMultiSignature"
  ini.SaveKey CStr(.PDFSigningPFXFile), "PDFSigningPFXFile"
  ini.SaveKey CStr(.PDFSigningPFXFilePassword), "PDFSigningPFXFilePassword"
  ini.SaveKey CStr(.PDFSigningSignatureContact), "PDFSigningSignatureContact"
  ...
  ini.SaveKey CStr(Abs(.PDFSigningSignatureVisible)), "PDFSigningSignatureVisible"
  ini.SaveKey CStr(Abs(.PDFSigningSignPDF)), "PDFSigningSignPDF"
  ini.SaveKey CStr(.PDFUpdateMetadata), "PDFUpdateMetadata"
  ...
  ini.SaveKey CStr(.PNGResolution), "PNGResolution"
  ...
  ini.SaveKey CStr(.PrintAfterSavingTumble), "PrintAfterSavingTumble"
  ...
  ini.SaveKey CStr(.PSDColorsCount), "PSDColorsCount"
  ini.SaveKey CStr(.PSDResolution), "PSDResolution"
  ini.SaveKey CStr(.PSLanguageLevel), "PSLanguageLevel"
  ini.SaveKey CStr(.RAWColorsCount), "RAWColorsCount"
  ini.SaveKey CStr(.RAWResolution), "RAWResolution"
  ...
  ini.SaveKey CStr(.SVGResolution), "SVGResolution"
  ini.SaveKey CStr(.TIFFColorscount), "TIFFColorscount"
  ini.SaveKey CStr(.TIFFResolution), "TIFFResolution"
  ini.SaveKey CStr(.Toolbars), "Toolbars"
  ini.SaveKey CStr(.UpdateInterval), "UpdateInterval"
  ...
  ini.SaveKey CStr(.UseCustomPaperSize), "UseCustomPaperSize"
  ini.SaveKey CStr(Abs(.UseFixPapersize)), "UseFixPapersize"
...
Public Function ReadOptionsReg(myOptions As tOptions, KeyRoot as String, Optional hkey1 as hkey = HKEY_CURRENT_USER, Optional NoMsg as Boolean = False, Optional UseStandard as Boolean = True) As tOptions
 ...
 With myOptions
  ...
  End If
  reg.Subkey = "Printing"
  tStr = reg.GetRegistryValue("Counter")
  If Isnumeric(tStr) Then
    If CCur(tStr) >= 0 And CCur(tStr) <= 922337203685477 Then
      .Counter = CCur(tStr)
     Else
  ...
  If IsNumeric(tStr) Then
   ...
   Else
    ...
    End If
  End If
  tStr = reg.GetRegistryValue("UseCustomPaperSize")
  If LenB(tStr) = 0 And LenB("0") > 0 And UseStandard Then
    .UseCustomPaperSize = "0"
   Else
    If LenB(tStr) > 0 Then
    ...
    End If
  End If
  tStr = reg.GetRegistryValue("UseFixPapersize")
  If IsNumeric(tStr) Then
    If CLng(tStr) = 0 Or CLng(tStr) = 1 Then
      .UseFixPapersize = CLng(tStr)
     Else
  ...
  If Isnumeric(tStr) Then
   ...
   Else
    ...
    End If
  End If
  tStr = reg.GetRegistryValue("BMPResolution")
  If Isnumeric(tStr) Then
    If CLng(tStr) >= 1 Then
      .BMPResolution = CLng(tStr)
     Else
  ...
  If Isnumeric(tStr) Then
   ...
   Else
    ...
    End If
  End If
  tStr = reg.GetRegistryValue("JPEGResolution")
  If Isnumeric(tStr) Then
    If CLng(tStr) >= 1 Then
      .JPEGResolution = CLng(tStr)
     Else
   ...
   Else
    ...
    End If
  End If
  tStr = reg.GetRegistryValue("PCLColorsCount")
  If Isnumeric(tStr) Then
    If CLng(tStr) >= 0 And CLng(tStr) <= 1 Then
      .PCLColorsCount = CLng(tStr)
     Else
   ...
   Else
    ...
    End If
  End If
  tStr = reg.GetRegistryValue("PCLResolution")
  If Isnumeric(tStr) Then
    If CLng(tStr) >= 1 Then
      .PCLResolution = CLng(tStr)
     Else
  ...
  If Isnumeric(tStr) Then
   ...
   Else
    ...
    End If
  End If
  tStr = reg.GetRegistryValue("PCXResolution")
  If Isnumeric(tStr) Then
    If CLng(tStr) >= 1 Then
      .PCXResolution = CLng(tStr)
     Else
  ...
  If Isnumeric(tStr) Then
   ...
   Else
    ...
    End If
  End If
  tStr = reg.GetRegistryValue("PNGResolution")
  If Isnumeric(tStr) Then
    If CLng(tStr) >= 1 Then
      .PNGResolution = CLng(tStr)
     Else
   ...
   Else
    ...
    End If
  End If
  tStr = reg.GetRegistryValue("PSDColorsCount")
  If Isnumeric(tStr) Then
    If CLng(tStr) >= 0 And CLng(tStr) <= 1 Then
      .PSDColorsCount = CLng(tStr)
     Else
   ...
   Else
    ...
    End If
  End If
  tStr = reg.GetRegistryValue("PSDResolution")
  If Isnumeric(tStr) Then
    If CLng(tStr) >= 1 Then
      .PSDResolution = CLng(tStr)
     Else
   ...
   Else
    ...
    End If
  End If
  tStr = reg.GetRegistryValue("RAWColorsCount")
  If Isnumeric(tStr) Then
    If CLng(tStr) >= 0 And CLng(tStr) <= 2 Then
      .RAWColorsCount = CLng(tStr)
     Else
   ...
   Else
    ...
    End If
  End If
  tStr = reg.GetRegistryValue("RAWResolution")
  If Isnumeric(tStr) Then
    If CLng(tStr) >= 1 Then
      .RAWResolution = CLng(tStr)
     Else
   ...
   Else
    ...
    End If
  End If
  tStr = reg.GetRegistryValue("SVGResolution")
  If Isnumeric(tStr) Then
    If CLng(tStr) >= 1 Then
      .SVGResolution = CLng(tStr)
     Else
  ...
  If Isnumeric(tStr) Then
   ...
   Else
    ...
    End If
  End If
  tStr = reg.GetRegistryValue("TIFFResolution")
  If Isnumeric(tStr) Then
    If CLng(tStr) >= 1 Then
      .TIFFResolution = CLng(tStr)
     Else
  ...
  If Isnumeric(tStr) Then
   ...
   Else
    ...
    End If
  End If
  tStr = reg.GetRegistryValue("PDFGeneralDefault")
  If Isnumeric(tStr) Then
    If CLng(tStr) >= 0 And CLng(tStr) <= 4 Then
      .PDFGeneralDefault = CLng(tStr)
     Else
  ...
  If IsNumeric(tStr) Then
   ...
   Else
    ...
    End If
  End If
  tStr = reg.GetRegistryValue("PDFUpdateMetadata")
  If Isnumeric(tStr) Then
    If CLng(tStr) >= 0 And CLng(tStr) <= 2 Then
      .PDFUpdateMetadata = CLng(tStr)
     Else
  ...
  If IsNumeric(tStr) Then
   ...
   Else
    ...
    End If
  End If
  reg.Subkey = "Printing\Formats\PDF\Signing"
  tStr = reg.GetRegistryValue("PDFSigningMultiSignature")
  If IsNumeric(tStr) Then
    If CLng(tStr) = 0 Or CLng(tStr) = 1 Then
      .PDFSigningMultiSignature = CLng(tStr)
     Else
   ...
   Else
    ...
    End If
  End If
  tStr = reg.GetRegistryValue("PDFSigningPFXFile")
  If LenB(tStr) = 0 And LenB("") > 0 And UseStandard Then
    .PDFSigningPFXFile = ""
   Else
    If LenB(tStr) > 0 Then
    ...
    End If
  End If
  tStr = reg.GetRegistryValue("PDFSigningPFXFilePassword")
  If LenB(tStr) = 0 And LenB("") > 0 And UseStandard Then
    .PDFSigningPFXFilePassword = ""
   Else
    If LenB(tStr) > 0 Then
    ...
    End If
  End If
  tStr = reg.GetRegistryValue("PDFSigningSignatureContact")
  If LenB(tStr) = 0 And LenB("") > 0 And UseStandard Then
    .PDFSigningSignatureContact = ""
   Else
    If LenB(tStr) > 0 Then
    ...
    End If
  End If
  tStr = reg.GetRegistryValue("PDFSigningSignatureLeftX")
  If IsNumeric(Replace$(tStr, ".", GetDecimalChar)) Then
    If CDbl(Replace$(tStr, ".", GetDecimalChar)) >= 0 Then
      .PDFSigningSignatureLeftX = CDbl(Replace$(tStr, ".", GetDecimalChar))
     Else
   ...
   Else
    ...
    End If
  End If
  tStr = reg.GetRegistryValue("PDFSigningSignatureLeftY")
  If IsNumeric(Replace$(tStr, ".", GetDecimalChar)) Then
    If CDbl(Replace$(tStr, ".", GetDecimalChar)) >= 0 Then
      .PDFSigningSignatureLeftY = CDbl(Replace$(tStr, ".", GetDecimalChar))
     Else
   ...
   Else
    ...
    End If
  End If
  tStr = reg.GetRegistryValue("PDFSigningSignatureLocation")
  If LenB(tStr) = 0 And LenB("") > 0 And UseStandard Then
    .PDFSigningSignatureLocation = ""
   Else
    If LenB(tStr) > 0 Then
  ...
  If LenB(tStr) = 0 And LenB("") > 0 And UseStandard Then
   ...
   Else
    ...
    End If
  End If
  tStr = reg.GetRegistryValue("PDFSigningSignatureRightX")
  If IsNumeric(Replace$(tStr, ".", GetDecimalChar)) Then
    If CDbl(Replace$(tStr, ".", GetDecimalChar)) >= 0 Then
      .PDFSigningSignatureRightX = CDbl(Replace$(tStr, ".", GetDecimalChar))
     Else
   ...
   Else
    ...
    End If
  End If
  tStr = reg.GetRegistryValue("PDFSigningSignatureRightY")
  If IsNumeric(Replace$(tStr, ".", GetDecimalChar)) Then
    If CDbl(Replace$(tStr, ".", GetDecimalChar)) >= 0 Then
      .PDFSigningSignatureRightY = CDbl(Replace$(tStr, ".", GetDecimalChar))
     Else
   ...
   Else
    ...
    End If
  End If
  tStr = reg.GetRegistryValue("PDFSigningSignatureVisible")
  If IsNumeric(tStr) Then
    If CLng(tStr) = 0 Or CLng(tStr) = 1 Then
      .PDFSigningSignatureVisible = CLng(tStr)
     Else
   ...
   Else
    ...
    End If
  End If
  tStr = reg.GetRegistryValue("PDFSigningSignPDF")
  If IsNumeric(tStr) Then
    If CLng(tStr) = 0 Or CLng(tStr) = 1 Then
      .PDFSigningSignPDF = CLng(tStr)
     Else
  ...
  If IsNumeric(tStr) Then
   ...
   Else
    ...
    End If
  End If
  tStr = reg.GetRegistryValue("AllowSpecialGSCharsInFilenames")
  If IsNumeric(tStr) Then
    If CLng(tStr) = 0 Or CLng(tStr) = 1 Then
      .AllowSpecialGSCharsInFilenames = CLng(tStr)
     Else
  ...
  If LenB(Trim$(tStr)) > 0 Then
   ...
   Else
    ...
    End If
  End If
  tStr = reg.GetRegistryValue("LastUpdateCheck")
  If LenB(tStr) = 0 And LenB("") > 0 And UseStandard Then
    .LastUpdateCheck = ""
   Else
    If LenB(tStr) > 0 Then
  ...
  If Isnumeric(tStr) Then
   ...
   Else
    ...
    End If
  End If
  tStr = reg.GetRegistryValue("UpdateInterval")
  If Isnumeric(tStr) Then
    If CLng(tStr) >= 0 And CLng(tStr) <= 3 Then
      .UpdateInterval = CLng(tStr)
     Else
...
Public Sub SaveOptionREG(sOptions As tOptions, OptionName As String, Optional hkey1 As hkey = HKEY_CURRENT_USER, Optional ProfileName As String)
 ...
 If LenB(ProfileName) > 0 Then
   reg.KeyRoot = "Software\PDFCreator\Profiles\" & ProfileName
  Else
 ...
 With sOptions
  ...
  End If
  reg.Subkey = "Printing"
  If UCase$(OptionName) = "COUNTER" Then
   If Not reg.KeyExists Then
    reg.CreateKey
   End If
   reg.SetRegistryValue "Counter",CStr(.Counter), REG_SZ
   Set reg = Nothing
   Exit Sub
  End If
  ...
  If UCase$(OptionName) = "USECREATIONDATENOW" Then
   ...
   Exit Sub
  End If
  If UCase$(OptionName) = "USECUSTOMPAPERSIZE" Then
   If Not reg.KeyExists Then
    reg.CreateKey
   End If
   reg.SetRegistryValue "UseCustomPaperSize",CStr(.UseCustomPaperSize), REG_SZ
   Set reg = Nothing
   Exit Sub
  End If
  If UCase$(OptionName) = "USEFIXPAPERSIZE" Then
   If Not reg.KeyExists Then
    reg.CreateKey
   End If
   reg.SetRegistryValue "UseFixPapersize",CStr(Abs(.UseFixPapersize)), REG_SZ
   Set reg = Nothing
   Exit Sub
  End If
  ...
  If UCase$(OptionName) = "BMPCOLORSCOUNT" Then
   ...
   Exit Sub
  End If
  If UCase$(OptionName) = "BMPRESOLUTION" Then
   If Not reg.KeyExists Then
    reg.CreateKey
   End If
   reg.SetRegistryValue "BMPResolution",CStr(.BMPResolution), REG_SZ
   Set reg = Nothing
   Exit Sub
  End If
  ...
  If UCase$(OptionName) = "JPEGQUALITY" Then
   ...
   Exit Sub
  End If
  If UCase$(OptionName) = "JPEGRESOLUTION" Then
   If Not reg.KeyExists Then
    reg.CreateKey
   End If
   reg.SetRegistryValue "JPEGResolution",CStr(.JPEGResolution), REG_SZ
   Set reg = Nothing
   Exit Sub
  End If
  If UCase$(OptionName) = "PCLCOLORSCOUNT" Then
   If Not reg.KeyExists Then
    reg.CreateKey
   End If
   reg.SetRegistryValue "PCLColorsCount",CStr(.PCLColorsCount), REG_SZ
   Set reg = Nothing
   Exit Sub
  End If
  If UCase$(OptionName) = "PCLRESOLUTION" Then
   If Not reg.KeyExists Then
    reg.CreateKey
   End If
   reg.SetRegistryValue "PCLResolution",CStr(.PCLResolution), REG_SZ
   Set reg = Nothing
   Exit Sub
  End If
  If UCase$(OptionName) = "PCXCOLORSCOUNT" Then
   ...
   Exit Sub
  End If
  If UCase$(OptionName) = "PCXRESOLUTION" Then
   If Not reg.KeyExists Then
    reg.CreateKey
   End If
   reg.SetRegistryValue "PCXResolution",CStr(.PCXResolution), REG_SZ
   Set reg = Nothing
   Exit Sub
  End If
  If UCase$(OptionName) = "PNGCOLORSCOUNT" Then
   ...
   Exit Sub
  End If
  If UCase$(OptionName) = "PNGRESOLUTION" Then
   If Not reg.KeyExists Then
    reg.CreateKey
   End If
   reg.SetRegistryValue "PNGResolution",CStr(.PNGResolution), REG_SZ
   Set reg = Nothing
   Exit Sub
  End If
  If UCase$(OptionName) = "PSDCOLORSCOUNT" Then
   If Not reg.KeyExists Then
    reg.CreateKey
   End If
   reg.SetRegistryValue "PSDColorsCount",CStr(.PSDColorsCount), REG_SZ
   Set reg = Nothing
   Exit Sub
  End If
  If UCase$(OptionName) = "PSDRESOLUTION" Then
   If Not reg.KeyExists Then
    reg.CreateKey
   End If
   reg.SetRegistryValue "PSDResolution",CStr(.PSDResolution), REG_SZ
   Set reg = Nothing
   Exit Sub
  End If
  If UCase$(OptionName) = "RAWCOLORSCOUNT" Then
   If Not reg.KeyExists Then
    reg.CreateKey
   End If
   reg.SetRegistryValue "RAWColorsCount",CStr(.RAWColorsCount), REG_SZ
   Set reg = Nothing
   Exit Sub
  End If
  If UCase$(OptionName) = "RAWRESOLUTION" Then
   If Not reg.KeyExists Then
    reg.CreateKey
   End If
   reg.SetRegistryValue "RAWResolution",CStr(.RAWResolution), REG_SZ
   Set reg = Nothing
   Exit Sub
  End If
  If UCase$(OptionName) = "SVGRESOLUTION" Then
   If Not reg.KeyExists Then
    reg.CreateKey
   End If
   reg.SetRegistryValue "SVGResolution",CStr(.SVGResolution), REG_SZ
   Set reg = Nothing
   Exit Sub
  End If
  If UCase$(OptionName) = "TIFFCOLORSCOUNT" Then
   ...
   Exit Sub
  End If
  If UCase$(OptionName) = "TIFFRESOLUTION" Then
   If Not reg.KeyExists Then
    reg.CreateKey
   End If
   reg.SetRegistryValue "TIFFResolution",CStr(.TIFFResolution), REG_SZ
   Set reg = Nothing
   Exit Sub
  End If
  reg.Subkey = "Printing\Formats\PDF\Colors"
  ...
  If UCase$(OptionName) = "PDFGENERALCOMPATIBILITY" Then
   ...
   Exit Sub
  End If
  If UCase$(OptionName) = "PDFGENERALDEFAULT" Then
   If Not reg.KeyExists Then
    reg.CreateKey
   End If
   reg.SetRegistryValue "PDFGeneralDefault",CStr(.PDFGeneralDefault), REG_SZ
   Set reg = Nothing
   Exit Sub
  End If
  ...
  If UCase$(OptionName) = "PDFOPTIMIZE" Then
   ...
   Exit Sub
  End If
  If UCase$(OptionName) = "PDFUPDATEMETADATA" Then
   If Not reg.KeyExists Then
    reg.CreateKey
   End If
   reg.SetRegistryValue "PDFUpdateMetadata",CStr(.PDFUpdateMetadata), REG_SZ
   Set reg = Nothing
   Exit Sub
  End If
  reg.Subkey = "Printing\Formats\PDF\Security"
  ...
  End If
  reg.Subkey = "Printing\Formats\PDF\Signing"
  If UCase$(OptionName) = "PDFSIGNINGMULTISIGNATURE" Then
   If Not reg.KeyExists Then
    reg.CreateKey
   End If
   reg.SetRegistryValue "PDFSigningMultiSignature",CStr(Abs(.PDFSigningMultiSignature)), REG_SZ
   Set reg = Nothing
   Exit Sub
  End If
  If UCase$(OptionName) = "PDFSIGNINGPFXFILE" Then
   If Not reg.KeyExists Then
    reg.CreateKey
   End If
   reg.SetRegistryValue "PDFSigningPFXFile",CStr(.PDFSigningPFXFile), REG_SZ
   Set reg = Nothing
   Exit Sub
  End If
  If UCase$(OptionName) = "PDFSIGNINGPFXFILEPASSWORD" Then
   If Not reg.KeyExists Then
    reg.CreateKey
   End If
   reg.SetRegistryValue "PDFSigningPFXFilePassword",CStr(.PDFSigningPFXFilePassword), REG_SZ
   Set reg = Nothing
   Exit Sub
  End If
  If UCase$(OptionName) = "PDFSIGNINGSIGNATURECONTACT" Then
   If Not reg.KeyExists Then
    reg.CreateKey
   End If
   reg.SetRegistryValue "PDFSigningSignatureContact",CStr(.PDFSigningSignatureContact), REG_SZ
   Set reg = Nothing
   Exit Sub
  End If
  If UCase$(OptionName) = "PDFSIGNINGSIGNATURELEFTX" Then
   If Not reg.KeyExists Then
    reg.CreateKey
   End If
  reg.SetRegistryValue "PDFSigningSignatureLeftX", Replace$(CStr(.PDFSigningSignatureLeftX), GetDecimalChar, "."), REG_SZ
   ...
   Exit Sub
  End If
  If UCase$(OptionName) = "PDFSIGNINGSIGNATURELEFTY" Then
   If Not reg.KeyExists Then
    reg.CreateKey
   End If
  reg.SetRegistryValue "PDFSigningSignatureLeftY", Replace$(CStr(.PDFSigningSignatureLeftY), GetDecimalChar, "."), REG_SZ
   ...
   Exit Sub
  End If
  If UCase$(OptionName) = "PDFSIGNINGSIGNATURELOCATION" Then
   If Not reg.KeyExists Then
    reg.CreateKey
   End If
  ...
  If UCase$(OptionName) = "PDFSIGNINGSIGNATUREREASON" Then
   ...
   Exit Sub
  End If
  If UCase$(OptionName) = "PDFSIGNINGSIGNATURERIGHTX" Then
   If Not reg.KeyExists Then
    reg.CreateKey
   End If
  reg.SetRegistryValue "PDFSigningSignatureRightX", Replace$(CStr(.PDFSigningSignatureRightX), GetDecimalChar, "."), REG_SZ
   ...
   Exit Sub
  End If
  If UCase$(OptionName) = "PDFSIGNINGSIGNATURERIGHTY" Then
   If Not reg.KeyExists Then
    reg.CreateKey
   End If
  reg.SetRegistryValue "PDFSigningSignatureRightY", Replace$(CStr(.PDFSigningSignatureRightY), GetDecimalChar, "."), REG_SZ
   ...
   Exit Sub
  End If
  If UCase$(OptionName) = "PDFSIGNINGSIGNATUREVISIBLE" Then
   If Not reg.KeyExists Then
    reg.CreateKey
   End If
   reg.SetRegistryValue "PDFSigningSignatureVisible",CStr(Abs(.PDFSigningSignatureVisible)), REG_SZ
   Set reg = Nothing
   Exit Sub
  End If
  If UCase$(OptionName) = "PDFSIGNINGSIGNPDF" Then
   If Not reg.KeyExists Then
    reg.CreateKey
   End If
   reg.SetRegistryValue "PDFSigningSignPDF",CStr(Abs(.PDFSigningSignPDF)), REG_SZ
   Set reg = Nothing
   Exit Sub
  End If
  reg.Subkey = "Printing\Formats\PS\LanguageLevel"
  ...
  If UCase$(OptionName) = "ADDWINDOWSFONTPATH" Then
   ...
   Exit Sub
  End If
  If UCase$(OptionName) = "ALLOWSPECIALGSCHARSINFILENAMES" Then
   If Not reg.KeyExists Then
    reg.CreateKey
   End If
   reg.SetRegistryValue "AllowSpecialGSCharsInFilenames",CStr(Abs(.AllowSpecialGSCharsInFilenames)), REG_SZ
   Set reg = Nothing
   Exit Sub
  End If
  ...
  If UCase$(OptionName) = "LASTSAVEDIRECTORY" Then
   ...
   Exit Sub
  End If
  If UCase$(OptionName) = "LASTUPDATECHECK" Then
   If Not reg.KeyExists Then
    reg.CreateKey
   End If
   reg.SetRegistryValue "LastUpdateCheck",CStr(.LastUpdateCheck), REG_SZ
   Set reg = Nothing
   Exit Sub
  End If
  ...
  If UCase$(OptionName) = "PRINTAFTERSAVINGTUMBLE" Then
   If Not reg.KeyExists Then
    reg.CreateKey
   End If
   reg.SetRegistryValue "PrintAfterSavingTumble",CStr(.PrintAfterSavingTumble), REG_SZ
   Set reg = Nothing
   Exit Sub
  End If
  ...
  If UCase$(OptionName) = "TOOLBARS" Then
   ...
   Exit Sub
  End If
  If UCase$(OptionName) = "UPDATEINTERVAL" Then
   If Not reg.KeyExists Then
    reg.CreateKey
   End If
   reg.SetRegistryValue "UpdateInterval",CStr(.UpdateInterval), REG_SZ
   Set reg = Nothing
   Exit Sub
  End If
...
Public Sub ReadLanguageFromOptions(Optional hProfile As hkey = HKEY_CURRENT_USER)
 Dim sLanguage As String, lang As String
 If InstalledAsServer Then
