...
'---ErrPtnr-OnError-END--- DO NOT MODIFY ! ---
50010  If UseINI Then
50020    ReadLanguageFromOptionsINI
50030   Else
50040    ReadLanguageFromOptionsReg hProfile
50050   End If
'---ErrPtnr-OnError-START--- DO NOT MODIFY ! ---
Exit Sub
ErrPtnr_OnError:
...
Public Sub ReadLanguageFromOptionsINI()
'---ErrPtnr-OnError-START--- DO NOT MODIFY ! ---
On Error GoTo ErrPtnr_OnError
'---ErrPtnr-OnError-END--- DO NOT MODIFY ! ---
50010  Dim hOpt As clsHash
50020  Set hOpt = New clsHash
50030  ReadINISection PDFCreatorINIFile, "Options", hOpt
50040  Options.Language = hOpt.Retrieve("Language", "english")
50050  Set hOpt = Nothing
'---ErrPtnr-OnError-START--- DO NOT MODIFY ! ---
Exit Sub
ErrPtnr_OnError:
...
Public Sub ReadLanguageFromOptionsReg(Optional hProfile As hkey = HKEY_CURRENT_USER)
'---ErrPtnr-OnError-START--- DO NOT MODIFY ! ---
On Error GoTo ErrPtnr_OnError
'---ErrPtnr-OnError-END--- DO NOT MODIFY ! ---
50010  Dim reg As clsRegistry, tStr As String
50020  Set reg = New clsRegistry
50030  With reg
50040   .KeyRoot = "Software\PDFCreator"
50050   .Subkey = "Program"
50060   .hkey = HKEY_LOCAL_MACHINE
50070   Options.Language = Trim$(reg.GetRegistryValue("Language", "english"))
50080   .hkey = hProfile
50090   tStr = Trim$(reg.GetRegistryValue("Language", ""))
50100  End With
50110  If LenB(Trim$(tStr)) > 0 Then
50120   Options.Language = Trim$(tStr)
50130  End If
