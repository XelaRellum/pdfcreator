...
SetupFileMissing=El archivo %1 no se encuentra en la carpeta de instalación. Por favor, corrija el problema u obtenga una copia nueva del programa.
SetupFileCorrupt=Los archivos de instalación están dañados. Por favor, obtenga una copia nueva del programa.
SetupFileCorruptOrWrongVer=Los archivos de instalación están dañados, o son incompatibles con su versión del Instalador. Por favor, corrija el problema u obtenga una copia nueva del programa.
...
SetupAppRunningError=El Instalador ha detectado que %1 se está ejecutando actualmente.%n%nPor favor, ciérrelo ahora, luego haga clic en Aceptar para continuar, o Cancelar para salir.
UninstallAppRunningError=La Desinstalador ha detectado que %1 se está ejecutando actualmente.%n%nPor favor, ciérrelo ahora, luego haga clic en Aceptar para continuar, o Cancelar para salir.
...
LicenseLabel3=Por favor, lea detenidamente el siguiente acuerdo de licencia. Debe de aceptar los términos de este acuerdo antes de continuar con la instalación.
...
NoUninstallWarning=El Instalador ha detectado que los siguientes componentes ya están instalados en su sistema:%n%n%1%n%nQuitando la selección de estos componentes, no serán desinstalados.%n%n¿Desea continuar de todos modos?
ComponentSize1=%1 KB
ComponentSize2=%1 MB
...
SelectStartMenuFolderLabel3=El Instalador creará los iconos de programa en la siguiente carpeta del Menú de Inicio.
...
ReadyLabel1=Ahora el instalador está listo para iniciar el proceso de instalación de [name] en su sistema.
...
PreviousInstallNotCompleted=La instalación/desinstalación previa del programa no se completó. Deberá reiniciar el sistema para completar la instalación.%n%nUna vez reiniciado el sistema, ejecute el programa de nuevo para completar la instalación de [name].
