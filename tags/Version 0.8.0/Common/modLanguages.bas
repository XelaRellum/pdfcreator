...
Private Sub InitLanguagesStrings()
 With LanguageStrings
  ...
  .DialogDocumentUp = "Up"
  .DialogInfo = "?"
  .DialogInfoCheckUpdates = "Check Updates"
  ...
  .MessagesMsg12 = "Please don't use these forbidden chars for a filename!"
  ...
  .MessagesMsg21 = "User Passes do not match!"
  .MessagesMsg22 = "Owner Passes do not match!"
  ...
  .OptionsGhostscriptversion = "Ghostscriptversion"
  ...
  .OptionsPDFCompressionMonoComp03 = "LZW-Compression"
  .OptionsPDFCompressionMonoComp04 = "Run-Length-Encoding"
  ...
  .OptionsSavePasswords = "Save passwords temporarily for this sesion."
