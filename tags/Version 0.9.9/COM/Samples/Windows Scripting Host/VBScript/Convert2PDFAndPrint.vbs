...
' Comments: This script convert a printable file in a pdf-file and print it on a printer.

Option Explicit

Const maxTime = 30    ' in seconds
Const sleepTime = 250 ' in milliseconds
Const PrinterName = "HP8100"
'Const PrinterName = "\\Print1\HP8100"
...
With PDFCreator
 ...
 .cOption("PrintAfterSaving") = 1
 .cOption("PrintAfterSavingPrinter") = PrinterName
