...
Private Sub CreateModOptions()
 ...
 Print #fn, "End Type"
 Print #fn, ""
 Print #fn, "Public Options As tOptions, Options1 As tOptions"
 Print #fn, ""
...
'    Print #fn, "  Set reg = Nothing"
 ...
 Print #fn, "Public Function ReadOptions(Optional NoMsg As Boolean = False, Optional hProfile As hkey = HKEY_CURRENT_USER, Optional ProfileName As String = """") As tOptions"
 Print #fn, " Dim myOptions As tOptions, Str1 as String"
 Print #fn, " Dim tStr As String"
 Print #fn, ""
 Print #fn, " ProfileName = Trim$(ProfileName)"
 Print #fn, " If LenB(ProfileName) > 0 Then"
 Print #fn, "  tStr = ""_"" & ProfileName"
 Print #fn, " End If"
 Print #fn, " If InstalledAsServer Then"
 ...
 Print #fn, "End Function"
 Print #fn, ""
 Print #fn, "Public Function CorrectOptionsAfterLoading(Options As tOptions) As tOptions"
 Print #fn, " Dim fns As String, fnsf() As String, nfnsf() As String, i As Long, j As Long"
 Print #fn, " fns = Options.FilenameSubstitutions"
 Print #fn, " If LenB(fns) = 0 Then"
 Print #fn, "  CorrectOptionsAfterLoading = Options"
 Print #fn, "  Exit Function"
 Print #fn, " End If"
 Print #fn, " If InStr(1, fns, ""\"") = 0 Then"
 Print #fn, "  CorrectOptionsAfterLoading = Options"
 Print #fn, "  Exit Function"
 Print #fn, " End If"
 Print #fn, " fnsf = Split(fns, ""\"")"
 Print #fn, " ReDim nfnsf(0)"
 Print #fn, " nfnsf(0) = fnsf(0)"
 Print #fn, " For i = 1 To UBound(fnsf)"
 Print #fn, "  For j = LBound(nfnsf) To UBound(nfnsf)"
 Print #fn, "   If nfnsf(j) = fnsf(i) Then"
 Print #fn, "    Exit For"
 Print #fn, "   End If"
 Print #fn, "   DoEvents"
 Print #fn, "  Next j"
 Print #fn, "  If j > UBound(nfnsf) Then"
 Print #fn, "   ReDim Preserve nfnsf(UBound(nfnsf) + 1)"
 Print #fn, "   nfnsf(UBound(nfnsf)) = fnsf(i)"
 Print #fn, "  End If"
 Print #fn, "  DoEvents"
 Print #fn, " Next i"
 Print #fn, " fns = nfnsf(0)"
 Print #fn, " For i = 1 To UBound(nfnsf)"
 Print #fn, "  fns = fns & ""\"" & nfnsf(i)"
 Print #fn, "  DoEvents"
 Print #fn, " Next i"
 Print #fn, " Options.FilenameSubstitutions = fns"
 Print #fn, " CorrectOptionsAfterLoading = Options"
 Print #fn, "End Function"
 Print #fn, ""
 ...
 Print #fn, "End Sub"
 Print #fn, ""
 Print #fn, " Public Function ProfileExists(ByVal ProfileName As String) As Boolean"
 Print #fn, " Dim Profiles As Collection, i As Long"
 Print #fn, " Set Profiles = GetProfiles"
 Print #fn, " For i = 1 To Profiles.Count"
 Print #fn, "  If LCase$(Profiles(i)) = LCase$(ProfileName) Then"
 Print #fn, "   ProfileExists = True"
 Print #fn, "   Exit Function"
 Print #fn, "  End If"
 Print #fn, " Next i"
 Print #fn, " ProfileExists = False"
 Print #fn, "End Function"
 Print #fn, ""
 Print #fn, "Public Function GetProfiles() As Collection"
 Print #fn, " Dim reg As clsRegistry"
 Print #fn, ""
 Print #fn, " Set reg = New clsRegistry"
 Print #fn, " reg.KeyRoot = ""Software\PDFCreator\Profiles\"""
 Print #fn, ""
 Print #fn, " If InstalledAsServer Then"
 Print #fn, "   reg.hkey = HKEY_LOCAL_MACHINE"
 Print #fn, "  Else"
 Print #fn, "   reg.hkey = HKEY_CURRENT_USER"
 Print #fn, " End If"
 Print #fn, " Set GetProfiles = reg.EnumRegistryKeys(reg.hkey, reg.KeyRoot)"
 Print #fn, "End Function"
 Print #fn, ""
 Print #fn, "Public Function GetPrinterDefaultProfile(Printername As String) As String"
 Print #fn, " Dim reg As clsRegistry, PrinterProfiles As Collection, i As Long"
 Print #fn, " Set reg = New clsRegistry"
 Print #fn, " reg.KeyRoot = ""Software\PDFCreator\Printers\"""
 Print #fn, " If InstalledAsServer Then"
 Print #fn, "   reg.hkey = HKEY_LOCAL_MACHINE"
 Print #fn, "  Else"
 Print #fn, "   reg.hkey = HKEY_CURRENT_USER"
 Print #fn, " End If"
 Print #fn, " Set PrinterProfiles = reg.EnumRegistryValues(reg.hkey, ""Software\PDFCreator\Printers\"")"
 Print #fn, " For i = 1 To PrinterProfiles.Count"
 Print #fn, "  If UCase$(Trim$(PrinterProfiles(i)(0))) = UCase$(Trim$(Printername)) Then"
 Print #fn, "   GetPrinterDefaultProfile = PrinterProfiles(i)(1)"
 Print #fn, "   Exit For"
 Print #fn, "  End If"
 Print #fn, " Next i"
 Print #fn, "End Function"
 Print #fn, ""
 Print #fn, "Public Sub DeleteProfile(ProfileName As String)"
 Print #fn, " Dim reg As clsRegistry"
 Print #fn, " Set reg = New clsRegistry"
 Print #fn, ""
 Print #fn, " ProfileName = Trim$(ProfileName)"
 ...
 Print #fn, "   reg.hkey = HKEY_CURRENT_USER"
 Print #fn, " End If"
 Print #fn, " reg.DeleteKeyWithSubkeys ProfileName"
 Print #fn, "End Sub"
 Print #fn, ""
 Print #fn, "Public Sub SaveOptions(sOptions As tOptions, Optional ProfileName As String = """")"
 Print #fn, " Dim tStr As String"
 Print #fn, ""
 Print #fn, " CorrectOptionsBeforeSaving"
 Print #fn, ""
 Print #fn, " ProfileName = Trim$(ProfileName)"
 Print #fn, " If LenB(ProfileName) > 0 Then"
 Print #fn, "  tStr = ""_"" & ProfileName"
 ...
 Print #fn, ""
 Print #fn, " If InstalledAsServer Then"
 Print #fn, "   SaveOptionsReg sOptions, HKEY_LOCAL_MACHINE, ProfileName"
 Print #fn, "  Else"
 Print #fn, "   SaveOptionsReg sOptions, , ProfileName"
 Print #fn, " End If"
 Print #fn, "End Sub"
 Print #fn, ""
 Print #fn, "Public Sub SaveOption(sOptions As tOptions, OptionName As String, Optional ProfileName As String = """")"
 Print #fn, " If InstalledAsServer Then"
 Print #fn, "   SaveOptionReg sOptions, OptionName, HKEY_LOCAL_MACHINE, ProfileName"
 Print #fn, "  Else"
 Print #fn, "   SaveOptionReg sOptions, OptionName, , ProfileName"
 Print #fn, " End If"
 Print #fn, "End Sub"
 Print #fn, ""
 ...
 Print #fn, "Public Sub SaveOptionREG(sOptions As tOptions, OptionName As String, Optional hkey1 As hkey = HKEY_CURRENT_USER, Optional ProfileName As String)"
 Print #fn, " Dim reg As clsRegistry"
 Print #fn, " Set reg = New clsRegistry"
 Print #fn, " reg.hkey = hkey1"
 Print #fn, ""
 ...
 Print #fn, ""
 Print #fn, " If LenB(ProfileName) > 0 Then"
 Print #fn, "   reg.KeyRoot = ""Software\PDFCreator\Profiles\"" & ProfileName"
 Print #fn, "  Else"
 ...
 Print #fn, "End Sub"
 Print #fn, ""
 Print #fn, "Public Sub SaveOptionsREG(sOptions as tOptions, Optional hkey1 as hkey = HKEY_CURRENT_USER, Optional ProfileName As String = """")"
 Print #fn, " Dim reg As clsRegistry"
 Print #fn, " Set reg = New clsRegistry"
 Print #fn, " reg.hkey = hkey1"
 Print #fn, ""
 ...
 Print #fn, " Dim sLanguage As String, lang As String"
 Print #fn, " If InstalledAsServer Then"
...
' inStrF = outStrF
 ...
 tStr1 = "Private Sub cLetOption(PropertyName As String, value As Variant, Options1 As tOptions, Profilename As String)"
 tStr2 = "End Sub"
 replStr = tStr1
 replStr = replStr & vbCrLf & " Select Case UCase$(PropertyName)"
 For i = 1 To lsvOptions.ListItems.Count
  With lsvOptions.ListItems(i)
   replStr = replStr & vbCrLf & "  Case """ & UCase$(.SubItems(1)) & """: Options1." & .SubItems(1) & " = Value"
  End With
 Next i
 ...
 replStr = replStr & vbCrLf & " End Select"
 replStr = replStr & vbCrLf & " If Profilename = """" Then"
 replStr = replStr & vbCrLf & "   Options = Options1"
 replStr = replStr & vbCrLf & "  Else"
 replStr = replStr & vbCrLf & "   SaveOptions Options1, Profilename"
 replStr = replStr & vbCrLf & " End If"
 inStrF = outStrF
 If InStr(1, inStrF, tStr1, vbTextCompare) > 0 And InStr(1, inStrF, tStr2, vbTextCompare) Then
   outStrF = Mid(inStrF, 1, InStr(1, inStrF, tStr1, vbTextCompare) - 1) & _
    replStr & vbCrLf & Mid(inStrF, InStr(InStr(1, inStrF, tStr1, vbTextCompare), inStrF, _
 ...
 outStrF = Trim$(outStrF)
 Do While Len(outStrF) >= 2
  If Mid(outStrF, Len(outStrF) - 1) = vbCrLf Then
    outStrF = Mid$(outStrF, 1, Len(outStrF) - 2)
   Else
    outStrF = outStrF & vbCrLf
    Exit Do
  End If
  DoEvents
 Loop
...
Private Sub CreateSpecialStrings()
 ...
 With ss
  ...
  .Add "PNGResolution"
  .Add "JPEGBitmapResolution"
  .Add "BMPBitmapResolution"
  .Add "PCXResolution"
  .Add "TIFFResolution"
  .Add "PSDResolution"
  .Add "PCLResolution"
