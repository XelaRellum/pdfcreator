...
51770   .OptionsPDFGeneralPageLayout01 = Replace$(hLang.Retrieve("PDFGeneralPageLayout01", .OptionsPDFGeneralPageLayout01), "/n", vbCrLf)
51780   .OptionsPDFGeneralPageLayout02 = Replace$(hLang.Retrieve("PDFGeneralPageLayout02", .OptionsPDFGeneralPageLayout02), "/n", vbCrLf)
51790   .OptionsPDFGeneralPageLayout03 = Replace$(hLang.Retrieve("PDFGeneralPageLayout03", .OptionsPDFGeneralPageLayout03), "/n", vbCrLf)
51800   .OptionsPDFGeneralPageLayout04 = Replace$(hLang.Retrieve("PDFGeneralPageLayout04", .OptionsPDFGeneralPageLayout04), "/n", vbCrLf)
51810   .OptionsPDFGeneralPageLayout05 = Replace$(hLang.Retrieve("PDFGeneralPageLayout05", .OptionsPDFGeneralPageLayout05), "/n", vbCrLf)
51820   .OptionsPDFGeneralPageLayout06 = Replace$(hLang.Retrieve("PDFGeneralPageLayout06", .OptionsPDFGeneralPageLayout06), "/n", vbCrLf)
51830   .OptionsPDFGeneralPageMode01 = Replace$(hLang.Retrieve("PDFGeneralPageMode01", .OptionsPDFGeneralPageMode01), "/n", vbCrLf)
51840   .OptionsPDFGeneralPageMode02 = Replace$(hLang.Retrieve("PDFGeneralPageMode02", .OptionsPDFGeneralPageMode02), "/n", vbCrLf)
51850   .OptionsPDFGeneralPageMode03 = Replace$(hLang.Retrieve("PDFGeneralPageMode03", .OptionsPDFGeneralPageMode03), "/n", vbCrLf)
51860   .OptionsPDFGeneralPageMode04 = Replace$(hLang.Retrieve("PDFGeneralPageMode04", .OptionsPDFGeneralPageMode04), "/n", vbCrLf)
51870   .OptionsPDFGeneralPageMode05 = Replace$(hLang.Retrieve("PDFGeneralPageMode05", .OptionsPDFGeneralPageMode05), "/n", vbCrLf)
51880   .OptionsPDFGeneralPageMode06 = Replace$(hLang.Retrieve("PDFGeneralPageMode06", .OptionsPDFGeneralPageMode06), "/n", vbCrLf)
51890   .OptionsPDFGeneralRotate01 = Replace$(hLang.Retrieve("PDFGeneralRotate01", .OptionsPDFGeneralRotate01), "/n", vbCrLf)
51900   .OptionsPDFGeneralRotate02 = Replace$(hLang.Retrieve("PDFGeneralRotate02", .OptionsPDFGeneralRotate02), "/n", vbCrLf)
51910   .OptionsPDFGeneralRotate03 = Replace$(hLang.Retrieve("PDFGeneralRotate03", .OptionsPDFGeneralRotate03), "/n", vbCrLf)
51920   .OptionsPDFGeneralStartPage = Replace$(hLang.Retrieve("PDFGeneralStartPage", .OptionsPDFGeneralStartPage), "/n", vbCrLf)
51930   .OptionsPDFOptimize = Replace$(hLang.Retrieve("PDFOptimize", .OptionsPDFOptimize), "/n", vbCrLf)
51940   .OptionsPDFOptions = Replace$(hLang.Retrieve("PDFOptions", .OptionsPDFOptions), "/n", vbCrLf)
51950   .OptionsPDFOwnerPass = Replace$(hLang.Retrieve("PDFOwnerPass", .OptionsPDFOwnerPass), "/n", vbCrLf)
51960   .OptionsPDFOwnerPasswordShowChars = Replace$(hLang.Retrieve("PDFOwnerPasswordShowChars", .OptionsPDFOwnerPasswordShowChars), "/n", vbCrLf)
51970   .OptionsPDFPasswords = Replace$(hLang.Retrieve("PDFPasswords", .OptionsPDFPasswords), "/n", vbCrLf)
51980   .OptionsPDFRepeatPassword = Replace$(hLang.Retrieve("PDFRepeatPassword", .OptionsPDFRepeatPassword), "/n", vbCrLf)
51990   .OptionsPDFSecurity = Replace$(hLang.Retrieve("PDFSecurity", .OptionsPDFSecurity), "/n", vbCrLf)
52000   .OptionsPDFSecurityCaption = Replace$(hLang.Retrieve("PDFSecurityCaption", .OptionsPDFSecurityCaption), "/n", vbCrLf)
52010   .OptionsPDFSetPassword = Replace$(hLang.Retrieve("PDFSetPassword", .OptionsPDFSetPassword), "/n", vbCrLf)
52020   .OptionsPDFSigning = Replace$(hLang.Retrieve("PDFSigning", .OptionsPDFSigning), "/n", vbCrLf)
52030   .OptionsPDFSigningCaption = Replace$(hLang.Retrieve("PDFSigningCaption", .OptionsPDFSigningCaption), "/n", vbCrLf)
52040   .OptionsPDFSigningCerticatePassword = Replace$(hLang.Retrieve("PDFSigningCerticatePassword", .OptionsPDFSigningCerticatePassword), "/n", vbCrLf)
52050   .OptionsPDFSigningCerticatePasswordCancel = Replace$(hLang.Retrieve("PDFSigningCerticatePasswordCancel", .OptionsPDFSigningCerticatePasswordCancel), "/n", vbCrLf)
52060   .OptionsPDFSigningCerticatePasswordOk = Replace$(hLang.Retrieve("PDFSigningCerticatePasswordOk", .OptionsPDFSigningCerticatePasswordOk), "/n", vbCrLf)
52070   .OptionsPDFSigningCerticatePasswordShowPassword = Replace$(hLang.Retrieve("PDFSigningCerticatePasswordShowPassword", .OptionsPDFSigningCerticatePasswordShowPassword), "/n", vbCrLf)
52080   .OptionsPDFSigningCertificateEmptyPassword = Replace$(hLang.Retrieve("PDFSigningCertificateEmptyPassword", .OptionsPDFSigningCertificateEmptyPassword), "/n", vbCrLf)
52090   .OptionsPDFSigningCertificateFile = Replace$(hLang.Retrieve("PDFSigningCertificateFile", .OptionsPDFSigningCertificateFile), "/n", vbCrLf)
52100   .OptionsPDFSigningChooseCertifcateFile = Replace$(hLang.Retrieve("PDFSigningChooseCertifcateFile", .OptionsPDFSigningChooseCertifcateFile), "/n", vbCrLf)
52110   .OptionsPDFSigningEnterCerticatePassword = Replace$(hLang.Retrieve("PDFSigningEnterCerticatePassword", .OptionsPDFSigningEnterCerticatePassword), "/n", vbCrLf)
52120   .OptionsPDFSigningP12Files = Replace$(hLang.Retrieve("PDFSigningP12Files", .OptionsPDFSigningP12Files), "/n", vbCrLf)
52130   .OptionsPDFSigningPfxFiles = Replace$(hLang.Retrieve("PDFSigningPfxFiles", .OptionsPDFSigningPfxFiles), "/n", vbCrLf)
52140   .OptionsPDFSigningPfxP12Files = Replace$(hLang.Retrieve("PDFSigningPfxP12Files", .OptionsPDFSigningPfxP12Files), "/n", vbCrLf)
52150   .OptionsPDFSigningSignatureContact = Replace$(hLang.Retrieve("PDFSigningSignatureContact", .OptionsPDFSigningSignatureContact), "/n", vbCrLf)
52160   .OptionsPDFSigningSignatureLocation = Replace$(hLang.Retrieve("PDFSigningSignatureLocation", .OptionsPDFSigningSignatureLocation), "/n", vbCrLf)
52170   .OptionsPDFSigningSignatureMultiSignature = Replace$(hLang.Retrieve("PDFSigningSignatureMultiSignature", .OptionsPDFSigningSignatureMultiSignature), "/n", vbCrLf)
52180   .OptionsPDFSigningSignatureOnPage = Replace$(hLang.Retrieve("PDFSigningSignatureOnPage", .OptionsPDFSigningSignatureOnPage), "/n", vbCrLf)
52190   .OptionsPDFSigningSignaturePosition = Replace$(hLang.Retrieve("PDFSigningSignaturePosition", .OptionsPDFSigningSignaturePosition), "/n", vbCrLf)
52200   .OptionsPDFSigningSignaturePositionLeftX = Replace$(hLang.Retrieve("PDFSigningSignaturePositionLeftX", .OptionsPDFSigningSignaturePositionLeftX), "/n", vbCrLf)
52210   .OptionsPDFSigningSignaturePositionLeftY = Replace$(hLang.Retrieve("PDFSigningSignaturePositionLeftY", .OptionsPDFSigningSignaturePositionLeftY), "/n", vbCrLf)
52220   .OptionsPDFSigningSignaturePositionRightX = Replace$(hLang.Retrieve("PDFSigningSignaturePositionRightX", .OptionsPDFSigningSignaturePositionRightX), "/n", vbCrLf)
52230   .OptionsPDFSigningSignaturePositionRightY = Replace$(hLang.Retrieve("PDFSigningSignaturePositionRightY", .OptionsPDFSigningSignaturePositionRightY), "/n", vbCrLf)
52240   .OptionsPDFSigningSignatureReason = Replace$(hLang.Retrieve("PDFSigningSignatureReason", .OptionsPDFSigningSignatureReason), "/n", vbCrLf)
52250   .OptionsPDFSigningSignatureVisible = Replace$(hLang.Retrieve("PDFSigningSignatureVisible", .OptionsPDFSigningSignatureVisible), "/n", vbCrLf)
52260   .OptionsPDFSigningSignPdfFile = Replace$(hLang.Retrieve("PDFSigningSignPdfFile", .OptionsPDFSigningSignPdfFile), "/n", vbCrLf)
52270   .OptionsPDFSigningTimeServerUrl = Replace$(hLang.Retrieve("PDFSigningTimeServerUrl", .OptionsPDFSigningTimeServerUrl), "/n", vbCrLf)
52280   .OptionsPDFSymbol = Replace$(hLang.Retrieve("PDFSymbol", .OptionsPDFSymbol), "/n", vbCrLf)
52290   .OptionsPDFUserPass = Replace$(hLang.Retrieve("PDFUserPass", .OptionsPDFUserPass), "/n", vbCrLf)
52300   .OptionsPDFUserPasswordShowChars = Replace$(hLang.Retrieve("PDFUserPasswordShowChars", .OptionsPDFUserPasswordShowChars), "/n", vbCrLf)
52310   .OptionsPDFUseSecurity = Replace$(hLang.Retrieve("PDFUseSecurity", .OptionsPDFUseSecurity), "/n", vbCrLf)
52320   .OptionsPNGColorscount01 = Replace$(hLang.Retrieve("PNGColorscount01", .OptionsPNGColorscount01), "/n", vbCrLf)
52330   .OptionsPNGColorscount02 = Replace$(hLang.Retrieve("PNGColorscount02", .OptionsPNGColorscount02), "/n", vbCrLf)
52340   .OptionsPNGColorscount03 = Replace$(hLang.Retrieve("PNGColorscount03", .OptionsPNGColorscount03), "/n", vbCrLf)
52350   .OptionsPNGColorscount04 = Replace$(hLang.Retrieve("PNGColorscount04", .OptionsPNGColorscount04), "/n", vbCrLf)
52360   .OptionsPNGColorscount05 = Replace$(hLang.Retrieve("PNGColorscount05", .OptionsPNGColorscount05), "/n", vbCrLf)
52370   .OptionsPNGColorscount06 = Replace$(hLang.Retrieve("PNGColorscount06", .OptionsPNGColorscount06), "/n", vbCrLf)
52380   .OptionsPNGDescription = Replace$(hLang.Retrieve("PNGDescription", .OptionsPNGDescription), "/n", vbCrLf)
52390   .OptionsPNGFiles = Replace$(hLang.Retrieve("PNGFiles", .OptionsPNGFiles), "/n", vbCrLf)
52400   .OptionsPNGSymbol = Replace$(hLang.Retrieve("PNGSymbol", .OptionsPNGSymbol), "/n", vbCrLf)
52410   .OptionsPrintAfterSaving = Replace$(hLang.Retrieve("PrintAfterSaving", .OptionsPrintAfterSaving), "/n", vbCrLf)
52420   .OptionsPrintAfterSavingBitsPerPixel = Replace$(hLang.Retrieve("PrintAfterSavingBitsPerPixel", .OptionsPrintAfterSavingBitsPerPixel), "/n", vbCrLf)
52430   .OptionsPrintAfterSavingBitsPerPixelCMYK = Replace$(hLang.Retrieve("PrintAfterSavingBitsPerPixelCMYK", .OptionsPrintAfterSavingBitsPerPixelCMYK), "/n", vbCrLf)
52440   .OptionsPrintAfterSavingBitsPerPixelMono = Replace$(hLang.Retrieve("PrintAfterSavingBitsPerPixelMono", .OptionsPrintAfterSavingBitsPerPixelMono), "/n", vbCrLf)
52450   .OptionsPrintAfterSavingBitsPerPixelTrueColor = Replace$(hLang.Retrieve("PrintAfterSavingBitsPerPixelTrueColor", .OptionsPrintAfterSavingBitsPerPixelTrueColor), "/n", vbCrLf)
52460   .OptionsPrintAfterSavingDuplex = Replace$(hLang.Retrieve("PrintAfterSavingDuplex", .OptionsPrintAfterSavingDuplex), "/n", vbCrLf)
52470   .OptionsPrintAfterSavingDuplexTumbleOff = Replace$(hLang.Retrieve("PrintAfterSavingDuplexTumbleOff", .OptionsPrintAfterSavingDuplexTumbleOff), "/n", vbCrLf)
52480   .OptionsPrintAfterSavingDuplexTumbleOn = Replace$(hLang.Retrieve("PrintAfterSavingDuplexTumbleOn", .OptionsPrintAfterSavingDuplexTumbleOn), "/n", vbCrLf)
52490   .OptionsPrintAfterSavingMaxResolution = Replace$(hLang.Retrieve("PrintAfterSavingMaxResolution", .OptionsPrintAfterSavingMaxResolution), "/n", vbCrLf)
52500   .OptionsPrintAfterSavingNoCancel = Replace$(hLang.Retrieve("PrintAfterSavingNoCancel", .OptionsPrintAfterSavingNoCancel), "/n", vbCrLf)
52510   .OptionsPrintAfterSavingPrinter = Replace$(hLang.Retrieve("PrintAfterSavingPrinter", .OptionsPrintAfterSavingPrinter), "/n", vbCrLf)
52520   .OptionsPrintAfterSavingQueryUser = Replace$(hLang.Retrieve("PrintAfterSavingQueryUser", .OptionsPrintAfterSavingQueryUser), "/n", vbCrLf)
52530   .OptionsPrintAfterSavingQueryUserDefaultPrinter = Replace$(hLang.Retrieve("PrintAfterSavingQueryUserDefaultPrinter", .OptionsPrintAfterSavingQueryUserDefaultPrinter), "/n", vbCrLf)
52540   .OptionsPrintAfterSavingQueryUserOff = Replace$(hLang.Retrieve("PrintAfterSavingQueryUserOff", .OptionsPrintAfterSavingQueryUserOff), "/n", vbCrLf)
52550   .OptionsPrintAfterSavingQueryUserPrinterSetupDialog = Replace$(hLang.Retrieve("PrintAfterSavingQueryUserPrinterSetupDialog", .OptionsPrintAfterSavingQueryUserPrinterSetupDialog), "/n", vbCrLf)
52560   .OptionsPrintAfterSavingQueryUserStandardPrinterDialog = Replace$(hLang.Retrieve("PrintAfterSavingQueryUserStandardPrinterDialog", .OptionsPrintAfterSavingQueryUserStandardPrinterDialog), "/n", vbCrLf)
52570   .OptionsPrintertempDirectoryPrompt = Replace$(hLang.Retrieve("PrintertempDirectoryPrompt", .OptionsPrintertempDirectoryPrompt), "/n", vbCrLf)
52580   .OptionsPrintTestpage = Replace$(hLang.Retrieve("PrintTestpage", .OptionsPrintTestpage), "/n", vbCrLf)
52590   .OptionsProcesspriority = Replace$(hLang.Retrieve("Processpriority", .OptionsProcesspriority), "/n", vbCrLf)
52600   .OptionsProcesspriorityHigh = Replace$(hLang.Retrieve("ProcesspriorityHigh", .OptionsProcesspriorityHigh), "/n", vbCrLf)
52610   .OptionsProcesspriorityIdle = Replace$(hLang.Retrieve("ProcesspriorityIdle", .OptionsProcesspriorityIdle), "/n", vbCrLf)
52620   .OptionsProcesspriorityNormal = Replace$(hLang.Retrieve("ProcesspriorityNormal", .OptionsProcesspriorityNormal), "/n", vbCrLf)
52630   .OptionsProcesspriorityRealtime = Replace$(hLang.Retrieve("ProcesspriorityRealtime", .OptionsProcesspriorityRealtime), "/n", vbCrLf)
52640   .OptionsProfile = Replace$(hLang.Retrieve("Profile", .OptionsProfile), "/n", vbCrLf)
52650   .OptionsProfileAdd = Replace$(hLang.Retrieve("ProfileAdd", .OptionsProfileAdd), "/n", vbCrLf)
52660   .OptionsProfileCancel = Replace$(hLang.Retrieve("ProfileCancel", .OptionsProfileCancel), "/n", vbCrLf)
52670   .OptionsProfileDefaultName = Replace$(hLang.Retrieve("ProfileDefaultName", .OptionsProfileDefaultName), "/n", vbCrLf)
52680   .OptionsProfileDel = Replace$(hLang.Retrieve("ProfileDel", .OptionsProfileDel), "/n", vbCrLf)
52690   .OptionsProfileLoadFromDisc = Replace$(hLang.Retrieve("ProfileLoadFromDisc", .OptionsProfileLoadFromDisc), "/n", vbCrLf)
52700   .OptionsProfileNewProfile = Replace$(hLang.Retrieve("ProfileNewProfile", .OptionsProfileNewProfile), "/n", vbCrLf)
52710   .OptionsProfileOk = Replace$(hLang.Retrieve("ProfileOk", .OptionsProfileOk), "/n", vbCrLf)
52720   .OptionsProfileRenameProfile = Replace$(hLang.Retrieve("ProfileRenameProfile", .OptionsProfileRenameProfile), "/n", vbCrLf)
52730   .OptionsProfileSaveToDisc = Replace$(hLang.Retrieve("ProfileSaveToDisc", .OptionsProfileSaveToDisc), "/n", vbCrLf)
52740   .OptionsProgramActionsDescription = Replace$(hLang.Retrieve("ProgramActionsDescription", .OptionsProgramActionsDescription), "/n", vbCrLf)
52750   .OptionsProgramActionsSymbol = Replace$(hLang.Retrieve("ProgramActionsSymbol", .OptionsProgramActionsSymbol), "/n", vbCrLf)
52760   .OptionsProgramAutosaveDescription = Replace$(hLang.Retrieve("ProgramAutosaveDescription", .OptionsProgramAutosaveDescription), "/n", vbCrLf)
52770   .OptionsProgramAutosaveSymbol = Replace$(hLang.Retrieve("ProgramAutosaveSymbol", .OptionsProgramAutosaveSymbol), "/n", vbCrLf)
52780   .OptionsProgramDirectoriesDescription = Replace$(hLang.Retrieve("ProgramDirectoriesDescription", .OptionsProgramDirectoriesDescription), "/n", vbCrLf)
52790   .OptionsProgramDirectoriesSymbol = Replace$(hLang.Retrieve("ProgramDirectoriesSymbol", .OptionsProgramDirectoriesSymbol), "/n", vbCrLf)
52800   .OptionsProgramDocumentDescription = Replace$(hLang.Retrieve("ProgramDocumentDescription", .OptionsProgramDocumentDescription), "/n", vbCrLf)
52810   .OptionsProgramDocumentDescription1 = Replace$(hLang.Retrieve("ProgramDocumentDescription1", .OptionsProgramDocumentDescription1), "/n", vbCrLf)
52820   .OptionsProgramDocumentDescription2 = Replace$(hLang.Retrieve("ProgramDocumentDescription2", .OptionsProgramDocumentDescription2), "/n", vbCrLf)
52830   .OptionsProgramDocumentSymbol = Replace$(hLang.Retrieve("ProgramDocumentSymbol", .OptionsProgramDocumentSymbol), "/n", vbCrLf)
52840   .OptionsProgramFont = Replace$(hLang.Retrieve("ProgramFont", .OptionsProgramFont), "/n", vbCrLf)
52850   .OptionsProgramFontCancelTest = Replace$(hLang.Retrieve("ProgramFontCancelTest", .OptionsProgramFontCancelTest), "/n", vbCrLf)
52860   .OptionsProgramFontcharset = Replace$(hLang.Retrieve("ProgramFontcharset", .OptionsProgramFontcharset), "/n", vbCrLf)
52870   .OptionsProgramFontDescription = Replace$(hLang.Retrieve("ProgramFontDescription", .OptionsProgramFontDescription), "/n", vbCrLf)
52880   .OptionsProgramFontSize = Replace$(hLang.Retrieve("ProgramFontSize", .OptionsProgramFontSize), "/n", vbCrLf)
52890   .OptionsProgramFontSymbol = Replace$(hLang.Retrieve("ProgramFontSymbol", .OptionsProgramFontSymbol), "/n", vbCrLf)
52900   .OptionsProgramFontTest = Replace$(hLang.Retrieve("ProgramFontTest", .OptionsProgramFontTest), "/n", vbCrLf)
52910   .OptionsProgramFontTestdescription = Replace$(hLang.Retrieve("ProgramFontTestdescription", .OptionsProgramFontTestdescription), "/n", vbCrLf)
52920   .OptionsProgramGeneralDescription = Replace$(hLang.Retrieve("ProgramGeneralDescription", .OptionsProgramGeneralDescription), "/n", vbCrLf)
52930   .OptionsProgramGeneralDescription1 = Replace$(hLang.Retrieve("ProgramGeneralDescription1", .OptionsProgramGeneralDescription1), "/n", vbCrLf)
52940   .OptionsProgramGeneralDescription2 = Replace$(hLang.Retrieve("ProgramGeneralDescription2", .OptionsProgramGeneralDescription2), "/n", vbCrLf)
52950   .OptionsProgramGeneralSymbol = Replace$(hLang.Retrieve("ProgramGeneralSymbol", .OptionsProgramGeneralSymbol), "/n", vbCrLf)
52960   .OptionsProgramGhostscriptDescription = Replace$(hLang.Retrieve("ProgramGhostscriptDescription", .OptionsProgramGhostscriptDescription), "/n", vbCrLf)
52970   .OptionsProgramGhostscriptSymbol = Replace$(hLang.Retrieve("ProgramGhostscriptSymbol", .OptionsProgramGhostscriptSymbol), "/n", vbCrLf)
52980   .OptionsProgramLanguagesDescription = Replace$(hLang.Retrieve("ProgramLanguagesDescription", .OptionsProgramLanguagesDescription), "/n", vbCrLf)
52990   .OptionsProgramLanguagesSymbol = Replace$(hLang.Retrieve("ProgramLanguagesSymbol", .OptionsProgramLanguagesSymbol), "/n", vbCrLf)
53000   .OptionsProgramNoProcessingAtStartup = Replace$(hLang.Retrieve("ProgramNoProcessingAtStartup", .OptionsProgramNoProcessingAtStartup), "/n", vbCrLf)
53010   .OptionsProgramOptionsDesign = Replace$(hLang.Retrieve("ProgramOptionsDesign", .OptionsProgramOptionsDesign), "/n", vbCrLf)
53020   .OptionsProgramOptionsDesignGradient = Replace$(hLang.Retrieve("ProgramOptionsDesignGradient", .OptionsProgramOptionsDesignGradient), "/n", vbCrLf)
53030   .OptionsProgramOptionsDesignSimple = Replace$(hLang.Retrieve("ProgramOptionsDesignSimple", .OptionsProgramOptionsDesignSimple), "/n", vbCrLf)
53040   .OptionsProgramPrintDescription = Replace$(hLang.Retrieve("ProgramPrintDescription", .OptionsProgramPrintDescription), "/n", vbCrLf)
53050   .OptionsProgramPrintSymbol = Replace$(hLang.Retrieve("ProgramPrintSymbol", .OptionsProgramPrintSymbol), "/n", vbCrLf)
53060   .OptionsProgramRunProgramAfterSavingCaption = Replace$(hLang.Retrieve("ProgramRunProgramAfterSavingCaption", .OptionsProgramRunProgramAfterSavingCaption), "/n", vbCrLf)
53070   .OptionsProgramRunProgramAfterSavingProgram = Replace$(hLang.Retrieve("ProgramRunProgramAfterSavingProgram", .OptionsProgramRunProgramAfterSavingProgram), "/n", vbCrLf)
53080   .OptionsProgramRunProgramAfterSavingProgramParameters = Replace$(hLang.Retrieve("ProgramRunProgramAfterSavingProgramParameters", .OptionsProgramRunProgramAfterSavingProgramParameters), "/n", vbCrLf)
53090   .OptionsProgramRunProgramAfterSavingWaitUntilReady = Replace$(hLang.Retrieve("ProgramRunProgramAfterSavingWaitUntilReady", .OptionsProgramRunProgramAfterSavingWaitUntilReady), "/n", vbCrLf)
53100   .OptionsProgramRunProgramAfterSavingWindowstyle = Replace$(hLang.Retrieve("ProgramRunProgramAfterSavingWindowstyle", .OptionsProgramRunProgramAfterSavingWindowstyle), "/n", vbCrLf)
53110   .OptionsProgramRunProgramAfterSavingWindowstyleHide = Replace$(hLang.Retrieve("ProgramRunProgramAfterSavingWindowstyleHide", .OptionsProgramRunProgramAfterSavingWindowstyleHide), "/n", vbCrLf)
53120   .OptionsProgramRunProgramAfterSavingWindowstyleMaximizedFocus = Replace$(hLang.Retrieve("ProgramRunProgramAfterSavingWindowstyleMaximizedFocus", .OptionsProgramRunProgramAfterSavingWindowstyleMaximizedFocus), "/n", vbCrLf)
53130   .OptionsProgramRunProgramAfterSavingWindowstyleMinimizedFocus = Replace$(hLang.Retrieve("ProgramRunProgramAfterSavingWindowstyleMinimizedFocus", .OptionsProgramRunProgramAfterSavingWindowstyleMinimizedFocus), "/n", vbCrLf)
53140   .OptionsProgramRunProgramAfterSavingWindowstyleMinimizedNoFocus = Replace$(hLang.Retrieve("ProgramRunProgramAfterSavingWindowstyleMinimizedNoFocus", .OptionsProgramRunProgramAfterSavingWindowstyleMinimizedNoFocus), "/n", vbCrLf)
53150   .OptionsProgramRunProgramAfterSavingWindowstyleNormalFocus = Replace$(hLang.Retrieve("ProgramRunProgramAfterSavingWindowstyleNormalFocus", .OptionsProgramRunProgramAfterSavingWindowstyleNormalFocus), "/n", vbCrLf)
53160   .OptionsProgramRunProgramAfterSavingWindowstyleNormalNoFocus = Replace$(hLang.Retrieve("ProgramRunProgramAfterSavingWindowstyleNormalNoFocus", .OptionsProgramRunProgramAfterSavingWindowstyleNormalNoFocus), "/n", vbCrLf)
53170   .OptionsProgramRunProgramBeforeSavingCaption = Replace$(hLang.Retrieve("ProgramRunProgramBeforeSavingCaption", .OptionsProgramRunProgramBeforeSavingCaption), "/n", vbCrLf)
53180   .OptionsProgramRunProgramBeforeSavingProgram = Replace$(hLang.Retrieve("ProgramRunProgramBeforeSavingProgram", .OptionsProgramRunProgramBeforeSavingProgram), "/n", vbCrLf)
53190   .OptionsProgramRunProgramBeforeSavingProgramParameters = Replace$(hLang.Retrieve("ProgramRunProgramBeforeSavingProgramParameters", .OptionsProgramRunProgramBeforeSavingProgramParameters), "/n", vbCrLf)
53200   .OptionsProgramRunProgramBeforeSavingWaitUntilReady = Replace$(hLang.Retrieve("ProgramRunProgramBeforeSavingWaitUntilReady", .OptionsProgramRunProgramBeforeSavingWaitUntilReady), "/n", vbCrLf)
53210   .OptionsProgramRunProgramBeforeSavingWindowstyle = Replace$(hLang.Retrieve("ProgramRunProgramBeforeSavingWindowstyle", .OptionsProgramRunProgramBeforeSavingWindowstyle), "/n", vbCrLf)
53220   .OptionsProgramRunProgramBeforeSavingWindowstyleHide = Replace$(hLang.Retrieve("ProgramRunProgramBeforeSavingWindowstyleHide", .OptionsProgramRunProgramBeforeSavingWindowstyleHide), "/n", vbCrLf)
53230   .OptionsProgramRunProgramBeforeSavingWindowstyleMaximizedFocus = Replace$(hLang.Retrieve("ProgramRunProgramBeforeSavingWindowstyleMaximizedFocus", .OptionsProgramRunProgramBeforeSavingWindowstyleMaximizedFocus), "/n", vbCrLf)
53240   .OptionsProgramRunProgramBeforeSavingWindowstyleMinimizedFocus = Replace$(hLang.Retrieve("ProgramRunProgramBeforeSavingWindowstyleMinimizedFocus", .OptionsProgramRunProgramBeforeSavingWindowstyleMinimizedFocus), "/n", vbCrLf)
53250   .OptionsProgramRunProgramBeforeSavingWindowstyleMinimizedNoFocus = Replace$(hLang.Retrieve("ProgramRunProgramBeforeSavingWindowstyleMinimizedNoFocus", .OptionsProgramRunProgramBeforeSavingWindowstyleMinimizedNoFocus), "/n", vbCrLf)
53260   .OptionsProgramRunProgramBeforeSavingWindowstyleNormalFocus = Replace$(hLang.Retrieve("ProgramRunProgramBeforeSavingWindowstyleNormalFocus", .OptionsProgramRunProgramBeforeSavingWindowstyleNormalFocus), "/n", vbCrLf)
53270   .OptionsProgramRunProgramBeforeSavingWindowstyleNormalNoFocus = Replace$(hLang.Retrieve("ProgramRunProgramBeforeSavingWindowstyleNormalNoFocus", .OptionsProgramRunProgramBeforeSavingWindowstyleNormalNoFocus), "/n", vbCrLf)
53280   .OptionsProgramSaveDescription = Replace$(hLang.Retrieve("ProgramSaveDescription", .OptionsProgramSaveDescription), "/n", vbCrLf)
53290   .OptionsProgramSaveSymbol = Replace$(hLang.Retrieve("ProgramSaveSymbol", .OptionsProgramSaveSymbol), "/n", vbCrLf)
53300   .OptionsProgramShowAnimation = Replace$(hLang.Retrieve("ProgramShowAnimation", .OptionsProgramShowAnimation), "/n", vbCrLf)
53310   .OptionsProgramSwitchingDefaultprinter = Replace$(hLang.Retrieve("ProgramSwitchingDefaultprinter", .OptionsProgramSwitchingDefaultprinter), "/n", vbCrLf)
53320   .OptionsPSDColorsCount01 = Replace$(hLang.Retrieve("PSDColorsCount01", .OptionsPSDColorsCount01), "/n", vbCrLf)
53330   .OptionsPSDColorscount02 = Replace$(hLang.Retrieve("PSDColorscount02", .OptionsPSDColorscount02), "/n", vbCrLf)
53340   .OptionsPSDDescription = Replace$(hLang.Retrieve("PSDDescription", .OptionsPSDDescription), "/n", vbCrLf)
53350   .OptionsPSDescription = Replace$(hLang.Retrieve("PSDescription", .OptionsPSDescription), "/n", vbCrLf)
53360   .OptionsPSDSymbol = Replace$(hLang.Retrieve("PSDSymbol", .OptionsPSDSymbol), "/n", vbCrLf)
53370   .OptionsPSFiles = Replace$(hLang.Retrieve("PSFiles", .OptionsPSFiles), "/n", vbCrLf)
53380   .OptionsPSLanguageLevel = Replace$(hLang.Retrieve("PSLanguageLevel", .OptionsPSLanguageLevel), "/n", vbCrLf)
53390   .OptionsPSSymbol = Replace$(hLang.Retrieve("PSSymbol", .OptionsPSSymbol), "/n", vbCrLf)
53400   .OptionsRAWColorsCount01 = Replace$(hLang.Retrieve("RAWColorsCount01", .OptionsRAWColorsCount01), "/n", vbCrLf)
53410   .OptionsRAWColorscount02 = Replace$(hLang.Retrieve("RAWColorscount02", .OptionsRAWColorscount02), "/n", vbCrLf)
53420   .OptionsRAWColorscount03 = Replace$(hLang.Retrieve("RAWColorscount03", .OptionsRAWColorscount03), "/n", vbCrLf)
53430   .OptionsRAWDescription = Replace$(hLang.Retrieve("RAWDescription", .OptionsRAWDescription), "/n", vbCrLf)
53440   .OptionsRAWSymbol = Replace$(hLang.Retrieve("RAWSymbol", .OptionsRAWSymbol), "/n", vbCrLf)
53450   .OptionsRemoveSpaces = Replace$(hLang.Retrieve("RemoveSpaces", .OptionsRemoveSpaces), "/n", vbCrLf)
53460   .OptionsReset = Replace$(hLang.Retrieve("Reset", .OptionsReset), "/n", vbCrLf)
53470   .OptionsSave = Replace$(hLang.Retrieve("Save", .OptionsSave), "/n", vbCrLf)
53480   .OptionsSaveFilename = Replace$(hLang.Retrieve("SaveFilename", .OptionsSaveFilename), "/n", vbCrLf)
53490   .OptionsSaveFilenameAdd = Replace$(hLang.Retrieve("SaveFilenameAdd", .OptionsSaveFilenameAdd), "/n", vbCrLf)
53500   .OptionsSaveFilenameChange = Replace$(hLang.Retrieve("SaveFilenameChange", .OptionsSaveFilenameChange), "/n", vbCrLf)
53510   .OptionsSaveFilenameDelete = Replace$(hLang.Retrieve("SaveFilenameDelete", .OptionsSaveFilenameDelete), "/n", vbCrLf)
53520   .OptionsSaveFilenameSubstitutions = Replace$(hLang.Retrieve("SaveFilenameSubstitutions", .OptionsSaveFilenameSubstitutions), "/n", vbCrLf)
53530   .OptionsSaveFilenameSubstitutionsTitle = Replace$(hLang.Retrieve("SaveFilenameSubstitutionsTitle", .OptionsSaveFilenameSubstitutionsTitle), "/n", vbCrLf)
53540   .OptionsSaveFilenameTokens = Replace$(hLang.Retrieve("SaveFilenameTokens", .OptionsSaveFilenameTokens), "/n", vbCrLf)
53550   .OptionsSavePasswords = Replace$(hLang.Retrieve("SavePasswords", .OptionsSavePasswords), "/n", vbCrLf)
53560   .OptionsSendEmailAfterAutosave = Replace$(hLang.Retrieve("SendEmailAfterAutosave", .OptionsSendEmailAfterAutosave), "/n", vbCrLf)
53570   .OptionsSendMailMethod = Replace$(hLang.Retrieve("SendMailMethod", .OptionsSendMailMethod), "/n", vbCrLf)
53580   .OptionsSendMailMethodAutomatic = Replace$(hLang.Retrieve("SendMailMethodAutomatic", .OptionsSendMailMethodAutomatic), "/n", vbCrLf)
53590   .OptionsSendMailMethodMapi = Replace$(hLang.Retrieve("SendMailMethodMapi", .OptionsSendMailMethodMapi), "/n", vbCrLf)
53600   .OptionsSendMailMethodSendmailDLL = Replace$(hLang.Retrieve("SendMailMethodSendmailDLL", .OptionsSendMailMethodSendmailDLL), "/n", vbCrLf)
53610   .OptionsShellIntegration = Replace$(hLang.Retrieve("ShellIntegration", .OptionsShellIntegration), "/n", vbCrLf)
53620   .OptionsShellIntegrationAdd = Replace$(hLang.Retrieve("ShellIntegrationAdd", .OptionsShellIntegrationAdd), "/n", vbCrLf)
53630   .OptionsShellIntegrationCaption = Replace$(hLang.Retrieve("ShellIntegrationCaption", .OptionsShellIntegrationCaption), "/n", vbCrLf)
53640   .OptionsShellIntegrationRemove = Replace$(hLang.Retrieve("ShellIntegrationRemove", .OptionsShellIntegrationRemove), "/n", vbCrLf)
53650   .OptionsStamp = Replace$(hLang.Retrieve("Stamp", .OptionsStamp), "/n", vbCrLf)
53660   .OptionsStampFontColor = Replace$(hLang.Retrieve("StampFontColor", .OptionsStampFontColor), "/n", vbCrLf)
53670   .OptionsStampOutlineFontThickness = Replace$(hLang.Retrieve("StampOutlineFontThickness", .OptionsStampOutlineFontThickness), "/n", vbCrLf)
53680   .OptionsStampString = Replace$(hLang.Retrieve("StampString", .OptionsStampString), "/n", vbCrLf)
53690   .OptionsStampUseOutlineFont = Replace$(hLang.Retrieve("StampUseOutlineFont", .OptionsStampUseOutlineFont), "/n", vbCrLf)
53700   .OptionsStandardAuthorToken = Replace$(hLang.Retrieve("StandardAuthorToken", .OptionsStandardAuthorToken), "/n", vbCrLf)
53710   .OptionsStandardSaveFormat = Replace$(hLang.Retrieve("StandardSaveFormat", .OptionsStandardSaveFormat), "/n", vbCrLf)
53720   .OptionsSVGDescription = Replace$(hLang.Retrieve("SVGDescription", .OptionsSVGDescription), "/n", vbCrLf)
53730   .OptionsSVGSymbol = Replace$(hLang.Retrieve("SVGSymbol", .OptionsSVGSymbol), "/n", vbCrLf)
53740   .OptionsTestpage = Replace$(hLang.Retrieve("Testpage", .OptionsTestpage), "/n", vbCrLf)
53750   .OptionsTIFFColorscount01 = Replace$(hLang.Retrieve("TIFFColorscount01", .OptionsTIFFColorscount01), "/n", vbCrLf)
53760   .OptionsTIFFColorscount02 = Replace$(hLang.Retrieve("TIFFColorscount02", .OptionsTIFFColorscount02), "/n", vbCrLf)
53770   .OptionsTIFFColorscount03 = Replace$(hLang.Retrieve("TIFFColorscount03", .OptionsTIFFColorscount03), "/n", vbCrLf)
53780   .OptionsTIFFColorscount04 = Replace$(hLang.Retrieve("TIFFColorscount04", .OptionsTIFFColorscount04), "/n", vbCrLf)
53790   .OptionsTIFFColorscount05 = Replace$(hLang.Retrieve("TIFFColorscount05", .OptionsTIFFColorscount05), "/n", vbCrLf)
53800   .OptionsTIFFColorscount06 = Replace$(hLang.Retrieve("TIFFColorscount06", .OptionsTIFFColorscount06), "/n", vbCrLf)
53810   .OptionsTIFFColorscount07 = Replace$(hLang.Retrieve("TIFFColorscount07", .OptionsTIFFColorscount07), "/n", vbCrLf)
53820   .OptionsTIFFColorscount08 = Replace$(hLang.Retrieve("TIFFColorscount08", .OptionsTIFFColorscount08), "/n", vbCrLf)
53830   .OptionsTIFFDescription = Replace$(hLang.Retrieve("TIFFDescription", .OptionsTIFFDescription), "/n", vbCrLf)
53840   .OptionsTIFFSymbol = Replace$(hLang.Retrieve("TIFFSymbol", .OptionsTIFFSymbol), "/n", vbCrLf)
53850   .OptionsTreeFormats = Replace$(hLang.Retrieve("TreeFormats", .OptionsTreeFormats), "/n", vbCrLf)
53860   .OptionsTreeProgram = Replace$(hLang.Retrieve("TreeProgram", .OptionsTreeProgram), "/n", vbCrLf)
53870   .OptionsTXTDescription = Replace$(hLang.Retrieve("TXTDescription", .OptionsTXTDescription), "/n", vbCrLf)
53880   .OptionsTXTSymbol = Replace$(hLang.Retrieve("TXTSymbol", .OptionsTXTSymbol), "/n", vbCrLf)
53890   .OptionsUseAutosave = Replace$(hLang.Retrieve("UseAutosave", .OptionsUseAutosave), "/n", vbCrLf)
53900   .OptionsUseAutosaveDirectory = Replace$(hLang.Retrieve("UseAutosaveDirectory", .OptionsUseAutosaveDirectory), "/n", vbCrLf)
53910   .OptionsUseCreationDateNow = Replace$(hLang.Retrieve("UseCreationDateNow", .OptionsUseCreationDateNow), "/n", vbCrLf)
53920   .OptionsUseCustomPapersize = Replace$(hLang.Retrieve("UseCustomPapersize", .OptionsUseCustomPapersize), "/n", vbCrLf)
53930   .OptionsUseFixPapersize = Replace$(hLang.Retrieve("UseFixPapersize", .OptionsUseFixPapersize), "/n", vbCrLf)
53940   .OptionsUserPass = Replace$(hLang.Retrieve("UserPass", .OptionsUserPass), "/n", vbCrLf)
53950   .OptionsUseStandardauthor = Replace$(hLang.Retrieve("UseStandardauthor", .OptionsUseStandardauthor), "/n", vbCrLf)
53960   .OptionsXCFColorsCount01 = Replace$(hLang.Retrieve("XCFColorsCount01", .OptionsXCFColorsCount01), "/n", vbCrLf)
53970   .OptionsXCFColorscount02 = Replace$(hLang.Retrieve("XCFColorscount02", .OptionsXCFColorscount02), "/n", vbCrLf)
53980   .OptionsXCFDescription = Replace$(hLang.Retrieve("XCFDescription", .OptionsXCFDescription), "/n", vbCrLf)
53990   .OptionsXCFSymbol = Replace$(hLang.Retrieve("XCFSymbol", .OptionsXCFSymbol), "/n", vbCrLf)
54000  End With
54010  Set hLang = Nothing
'---ErrPtnr-OnError-START--- DO NOT MODIFY ! ---
Exit Sub
ErrPtnr_OnError:
...
52820   .OptionsPDFGeneralPageLayout01 = "Display one page at a time."
52830   .OptionsPDFGeneralPageLayout02 = "Display the pages in one column."
52840   .OptionsPDFGeneralPageLayout03 = "Display the pages in two columns, with odd-numbered pages on the left."
52850   .OptionsPDFGeneralPageLayout04 = "Display the pages in two columns, with odd-numbered pages on the right."
52860   .OptionsPDFGeneralPageLayout05 = "Display the pages two at a time, with odd-numbered pages on the left."
52870   .OptionsPDFGeneralPageLayout06 = "Display the pages two at a time, with odd-numbered pages on the right."
52880   .OptionsPDFGeneralPageMode01 = "Neither document outline nor thumbnail images visible."
52890   .OptionsPDFGeneralPageMode02 = "Document outline visible."
52900   .OptionsPDFGeneralPageMode03 = "Thumbnail images visible."
52910   .OptionsPDFGeneralPageMode04 = "Full-screen mode, with no menu bar, window controls, or any other window visible."
52920   .OptionsPDFGeneralPageMode05 = "Optional content group panel visible."
52930   .OptionsPDFGeneralPageMode06 = "Attachments panel visible."
52940   .OptionsPDFGeneralRotate01 = "None"
52950   .OptionsPDFGeneralRotate02 = "All"
52960   .OptionsPDFGeneralRotate03 = "Single Page"
52970   .OptionsPDFGeneralStartPage = "Start page:"
52980   .OptionsPDFOptimize = "Fast web view"
52990   .OptionsPDFOptions = "PDF Options"
53000   .OptionsPDFOwnerPass = "Password required to change permissions and passwords"
53010   .OptionsPDFOwnerPasswordShowChars = "Show password"
53020   .OptionsPDFPasswords = "Passwords"
53030   .OptionsPDFRepeatPassword = "Repeat"
53040   .OptionsPDFSecurity = "Security"
53050   .OptionsPDFSecurityCaption = "Security"
53060   .OptionsPDFSetPassword = "Password"
53070   .OptionsPDFSigning = "Signing"
53080   .OptionsPDFSigningCaption = "Signing of PDFs"
53090   .OptionsPDFSigningCerticatePassword = "Certificate password"
53100   .OptionsPDFSigningCerticatePasswordCancel = "&Cancel"
53110   .OptionsPDFSigningCerticatePasswordOk = "&Ok"
53120   .OptionsPDFSigningCerticatePasswordShowPassword = "Show password"
53130   .OptionsPDFSigningCertificateEmptyPassword = "No password is entered. The pdf file will not be signed."
53140   .OptionsPDFSigningCertificateFile = "Certificate file"
53150   .OptionsPDFSigningChooseCertifcateFile = "Choose a certificate"
53160   .OptionsPDFSigningEnterCerticatePassword = "Enter certificate password"
53170   .OptionsPDFSigningP12Files = "P12 files"
53180   .OptionsPDFSigningPfxFiles = "Pfx files"
53190   .OptionsPDFSigningPfxP12Files = "Pfx/P12 files"
53200   .OptionsPDFSigningSignatureContact = "Signature contact"
53210   .OptionsPDFSigningSignatureLocation = "Signature location"
53220   .OptionsPDFSigningSignatureMultiSignature = "Multi signature allowed"
53230   .OptionsPDFSigningSignatureOnPage = "Show signature on page"
53240   .OptionsPDFSigningSignaturePosition = "Signature position"
53250   .OptionsPDFSigningSignaturePositionLeftX = "LeftX"
53260   .OptionsPDFSigningSignaturePositionLeftY = "LeftY"
53270   .OptionsPDFSigningSignaturePositionRightX = "RightX"
53280   .OptionsPDFSigningSignaturePositionRightY = "RightY"
53290   .OptionsPDFSigningSignatureReason = "Signature reason"
53300   .OptionsPDFSigningSignatureVisible = "Signature visible in pdf file"
53310   .OptionsPDFSigningSignPdfFile = "Sign pdf file"
53320   .OptionsPDFSigningTimeServerUrl = "Time server url"
53330   .OptionsPDFSymbol = "PDF"
53340   .OptionsPDFUserPass = "Password required to open document"
53350   .OptionsPDFUserPasswordShowChars = "Show password"
53360   .OptionsPDFUseSecurity = "Use Security"
53370   .OptionsPNGColorscount01 = "16777216 colors (24 Bit)"
53380   .OptionsPNGColorscount02 = "256 colors (8 Bit)"
53390   .OptionsPNGColorscount03 = "16 colors (4 Bit)"
53400   .OptionsPNGColorscount04 = "2 colors (2 Bit - Black/White)"
53410   .OptionsPNGColorscount05 = "Greyscale (8 Bit)"
53420   .OptionsPNGColorscount06 = "4294967296 colors (32 Bit) with transparency"
53430   .OptionsPNGDescription = "PNG Format. Please use only for single pages."
53440   .OptionsPNGFiles = "Bitmap PNG Files"
53450   .OptionsPNGSymbol = "PNG"
53460   .OptionsPrintAfterSaving = "Print after saving"
53470   .OptionsPrintAfterSavingBitsPerPixel = "Bits per pixel"
53480   .OptionsPrintAfterSavingBitsPerPixelCMYK = "CMYK"
53490   .OptionsPrintAfterSavingBitsPerPixelMono = "Mono"
53500   .OptionsPrintAfterSavingBitsPerPixelTrueColor = "True Color"
53510   .OptionsPrintAfterSavingDuplex = "Duplex"
53520   .OptionsPrintAfterSavingDuplexTumbleOff = "Don't use tumble (Default)"
53530   .OptionsPrintAfterSavingDuplexTumbleOn = "Use tumble"
53540   .OptionsPrintAfterSavingMaxResolution = "Set maximum print resolution"
53550   .OptionsPrintAfterSavingNoCancel = "Hide the progress dialog during printing"
53560   .OptionsPrintAfterSavingPrinter = "Printer"
53570   .OptionsPrintAfterSavingQueryUser = "Query user"
53580   .OptionsPrintAfterSavingQueryUserDefaultPrinter = "Select the default Windows printer without any user interaction"
53590   .OptionsPrintAfterSavingQueryUserOff = "Off (Default)"
53600   .OptionsPrintAfterSavingQueryUserPrinterSetupDialog = "Shows the printer setup dialog"
53610   .OptionsPrintAfterSavingQueryUserStandardPrinterDialog = "Show the standard printer dialog"
53620   .OptionsPrintertempDirectoryPrompt = "Select Printer Temp-Directory"
53630   .OptionsPrintTestpage = "Print Test Page"
53640   .OptionsProcesspriority = "Process priority"
53650   .OptionsProcesspriorityHigh = "High"
53660   .OptionsProcesspriorityIdle = "Idle"
53670   .OptionsProcesspriorityNormal = "Normal"
53680   .OptionsProcesspriorityRealtime = "Realtime"
53690   .OptionsProfile = "Profile"
53700   .OptionsProfileAdd = "Add profile"
53710   .OptionsProfileCancel = "&Cancel"
53720   .OptionsProfileDefaultName = "Default"
53730   .OptionsProfileDel = "Delete profile"
53740   .OptionsProfileLoadFromDisc = "Load profile from disc"
53750   .OptionsProfileNewProfile = "New profile"
53760   .OptionsProfileOk = "&Ok"
53770   .OptionsProfileRenameProfile = "Rename profile"
53780   .OptionsProfileSaveToDisc = "Save profile to disc"
53790   .OptionsProgramActionsDescription = "Define an action before and after saving a file."
53800   .OptionsProgramActionsSymbol = "Actions"
53810   .OptionsProgramAutosaveDescription = "Auto-save mode. Auto-save does not prompt for a filename and file location. It automatically saves all PDF files to a single directory with a predefined filename."
53820   .OptionsProgramAutosaveSymbol = "Auto-save"
53830   .OptionsProgramDirectoriesDescription = "Directories for Ghostscript, temporary files and others."
53840   .OptionsProgramDirectoriesSymbol = "Directories"
53850   .OptionsProgramDocumentDescription = "Document properties"
53860   .OptionsProgramDocumentDescription1 = "Document properties 1"
53870   .OptionsProgramDocumentDescription2 = "Document properties 2"
53880   .OptionsProgramDocumentSymbol = "Document"
53890   .OptionsProgramFont = "Program Font"
53900   .OptionsProgramFontCancelTest = "Cancel Test"
53910   .OptionsProgramFontcharset = "Character Set"
53920   .OptionsProgramFontDescription = "Font for labels, captions and values. For the program menu use the general settings in your Windows OS."
53930   .OptionsProgramFontSize = "Size"
53940   .OptionsProgramFontSymbol = "Program font"
53950   .OptionsProgramFontTest = "Test"
53960   .OptionsProgramFontTestdescription = "Here you can test the font."
53970   .OptionsProgramGeneralDescription = "General Settings"
53980   .OptionsProgramGeneralDescription1 = "General Settings 1"
53990   .OptionsProgramGeneralDescription2 = "General Settings 2"
54000   .OptionsProgramGeneralSymbol = "General settings"
54010   .OptionsProgramGhostscriptDescription = "Ghostscript"
54020   .OptionsProgramGhostscriptSymbol = "Ghostscript"
54030   .OptionsProgramLanguagesDescription = "Define the language and download another languages from the internet."
54040   .OptionsProgramLanguagesSymbol = "Languages"
54050   .OptionsProgramNoProcessingAtStartup = "No processing at startup"
54060   .OptionsProgramOptionsDesign = "Frame color of the options dialog"
54070   .OptionsProgramOptionsDesignGradient = "Red and blue gradient (Default)"
54080   .OptionsProgramOptionsDesignSimple = "Simple red and blue color"
54090   .OptionsProgramPrintDescription = "Print after saving"
54100   .OptionsProgramPrintSymbol = "Print"
54110   .OptionsProgramRunProgramAfterSavingCaption = "Action after saving"
54120   .OptionsProgramRunProgramAfterSavingProgram = "Program/Script"
54130   .OptionsProgramRunProgramAfterSavingProgramParameters = "Program parameters"
54140   .OptionsProgramRunProgramAfterSavingWaitUntilReady = "Wait until the program/script is ready"
54150   .OptionsProgramRunProgramAfterSavingWindowstyle = "Window style"
54160   .OptionsProgramRunProgramAfterSavingWindowstyleHide = "Hide"
54170   .OptionsProgramRunProgramAfterSavingWindowstyleMaximizedFocus = "Maximized/Focus"
54180   .OptionsProgramRunProgramAfterSavingWindowstyleMinimizedFocus = "Minimized/Focus"
54190   .OptionsProgramRunProgramAfterSavingWindowstyleMinimizedNoFocus = "Minimized/No focus"
54200   .OptionsProgramRunProgramAfterSavingWindowstyleNormalFocus = "Normal/Focus"
54210   .OptionsProgramRunProgramAfterSavingWindowstyleNormalNoFocus = "Normal/No focus"
54220   .OptionsProgramRunProgramBeforeSavingCaption = "Action before saving"
54230   .OptionsProgramRunProgramBeforeSavingProgram = "Program/Script"
54240   .OptionsProgramRunProgramBeforeSavingProgramParameters = "Program parameters"
54250   .OptionsProgramRunProgramBeforeSavingWaitUntilReady = "Wait until the program/script is ready"
54260   .OptionsProgramRunProgramBeforeSavingWindowstyle = "Window style"
54270   .OptionsProgramRunProgramBeforeSavingWindowstyleHide = "Hide"
54280   .OptionsProgramRunProgramBeforeSavingWindowstyleMaximizedFocus = "Maximized/Focus"
54290   .OptionsProgramRunProgramBeforeSavingWindowstyleMinimizedFocus = "Minimized/Focus"
54300   .OptionsProgramRunProgramBeforeSavingWindowstyleMinimizedNoFocus = "Minimized/NoFocus"
54310   .OptionsProgramRunProgramBeforeSavingWindowstyleNormalFocus = "Normal/Focus"
54320   .OptionsProgramRunProgramBeforeSavingWindowstyleNormalNoFocus = "Normal/NoFocus"
54330   .OptionsProgramSaveDescription = "Save"
54340   .OptionsProgramSaveSymbol = "Save"
54350   .OptionsProgramShowAnimation = "Show an animation during the process"
54360   .OptionsProgramSwitchingDefaultprinter = "No confirm message switching PDFCreator temporarily as default printer."
54370   .OptionsPSDColorsCount01 = "4294967296 colors (32 Bit) CMYK"
54380   .OptionsPSDColorscount02 = "16777216 colors (24 Bit)"
54390   .OptionsPSDDescription = "Photoshop Format"
54400   .OptionsPSDescription = "PostScript Format"
54410   .OptionsPSDSymbol = "PSD"
54420   .OptionsPSFiles = "PostScript Files"
54430   .OptionsPSLanguageLevel = "Language Level:"
54440   .OptionsPSSymbol = "PS"
54450   .OptionsRAWColorsCount01 = "4294967296 colors (32 Bit) CMYK"
54460   .OptionsRAWColorscount02 = "16777216 colors (24 Bit)"
54470   .OptionsRAWColorscount03 = "2 colors (Black/White)"
54480   .OptionsRAWDescription = "Raw Format"
54490   .OptionsRAWSymbol = "Raw"
54500   .OptionsRemoveSpaces = "Remove leading and trailing spaces"
54510   .OptionsReset = "&Reset all settings"
54520   .OptionsSave = "&Save"
54530   .OptionsSaveFilename = "Filename"
54540   .OptionsSaveFilenameAdd = "Add"
54550   .OptionsSaveFilenameChange = "Change"
54560   .OptionsSaveFilenameDelete = "Delete"
54570   .OptionsSaveFilenameSubstitutions = "Filename substitution"
54580   .OptionsSaveFilenameSubstitutionsTitle = "Filename substitution only in <Title>"
54590   .OptionsSaveFilenameTokens = "Add a Filename-Token"
54600   .OptionsSavePasswords = "Save passwords temporarily for this session."
54610   .OptionsSendEmailAfterAutosave = "Send an email after auto-saving"
54620   .OptionsSendMailMethod = "Method to send an email"
54630   .OptionsSendMailMethodAutomatic = "Automatic"
54640   .OptionsSendMailMethodMapi = "Mapi interface"
54650   .OptionsSendMailMethodSendmailDLL = "Using sendmail.dll"
54660   .OptionsShellIntegration = "Shell integration"
54670   .OptionsShellIntegrationAdd = "Integrate PDFCreator into shell"
54680   .OptionsShellIntegrationCaption = "Create &PDF with PDFCreator"
54690   .OptionsShellIntegrationRemove = "Remove shell integration"
54700   .OptionsStamp = "Stamp"
54710   .OptionsStampFontColor = "Font-color"
54720   .OptionsStampOutlineFontThickness = "Outline font thickness"
54730   .OptionsStampString = "Stampstring"
54740   .OptionsStampUseOutlineFont = "Use outline font"
54750   .OptionsStandardAuthorToken = "Add a Author-Token"
54760   .OptionsStandardSaveFormat = "Standard save format"
54770   .OptionsSVGDescription = "SVG Format"
54780   .OptionsSVGSymbol = "SVG"
54790   .OptionsTestpage = "PDFCreator Testpage"
54800   .OptionsTIFFColorscount01 = "16777216 (24 Bit)"
54810   .OptionsTIFFColorscount02 = "4096 (12 Bit)"
54820   .OptionsTIFFColorscount03 = "2 colors (Black/White) G3 fax encoding with no EOLs"
54830   .OptionsTIFFColorscount04 = "2 colors (Black/White) G3 fax encoding with EOLs"
54840   .OptionsTIFFColorscount05 = "2 colors (Black/White) 2-D G3 fax encoding"
54850   .OptionsTIFFColorscount06 = "2 colors (Black/White) G4 fax encoding"
54860   .OptionsTIFFColorscount07 = "2 colors (Black/White) LZW-compatible"
54870   .OptionsTIFFColorscount08 = "2 colors (Black/White) PackBits"
54880   .OptionsTIFFDescription = "TIFF Format. For multipages use the tiff-format."
54890   .OptionsTIFFSymbol = "TIFF"
54900   .OptionsTreeFormats = "Formats"
54910   .OptionsTreeProgram = "Program"
54920   .OptionsTXTDescription = "Text Format"
54930   .OptionsTXTSymbol = "TXT"
54940   .OptionsUseAutosave = "Use Auto-save"
54950   .OptionsUseAutosaveDirectory = "Use this directory for auto-save"
54960   .OptionsUseCreationDateNow = "Use the current Date/Time for 'Creation Date'"
54970   .OptionsUseCustomPapersize = "Use custom paper size"
54980   .OptionsUseFixPapersize = "Use fixed paper size"
54990   .OptionsUserPass = "User Password"
55000   .OptionsUseStandardauthor = "Use standard author"
55010   .OptionsXCFColorsCount01 = "4294967296 colors (32 Bit) CMYK"
55020   .OptionsXCFColorscount02 = "16777216 colors (24 Bit)"
55030   .OptionsXCFDescription = "Gimp Format"
55040   .OptionsXCFSymbol = "XCF"
55050
55060   .PrintersAdminNotice = "You must be an administrator to install or delete a printer!"
55070   .PrintersClose = "Close"
55080   .PrintersNewPrinterName = "New printer name"
55090   .PrintersPrinter = "Printer"
55100   .PrintersPrinterAdd = "Add printer"
55110   .PrintersPrinterDel = "Del printer"
55120   .PrintersPrinters = "Printers"
55130   .PrintersProfile = "Profile"
55140   .PrintersSave = "Save"
55150
55160   .PrintingAuthor = "A&uthor:"
55170   .PrintingBMPFiles = "BMP Files"
55180   .PrintingCancel = "&Cancel"
55190   .PrintingCollect = "&Wait - Collect"
55200   .PrintingCreationDate = "Creation &Date:"
55210   .PrintingDocumentTitle = "Document &Title:"
55220   .PrintingEditWithPDFArchitect = "Edit PDF files with PDFArchitect"
55230   .PrintingEMail = "&eMail"
55240   .PrintingEPSFiles = "Encapsulated PostScript Files"
55250   .PrintingJPEGFiles = "JPEG Files"
55260   .PrintingKeywords = "&Keywords:"
55270   .PrintingModifyDate = "&Modify Date:"
55280   .PrintingNow = "Now"
55290   .PrintingOpenOutputFile = "After saving &open output file"
55300   .PrintingPCLFiles = "PCL (HP PCL-XL) Files"
55310   .PrintingPCXFiles = "PCX Files"
55320   .PrintingPDFAFiles = "PDF/A-1b Files"
55330   .PrintingPDFArchitectToolTipText = "Edit the created PDF file with PDFArchitect.%n%nThis note will be shown %1 more times."
55340   .PrintingPDFArchitectToolTipTitle = "New: PDFArchitect"
55350   .PrintingPDFFiles = "PDF Files"
55360   .PrintingPDFXFiles = "PDF/X Files"
55370   .PrintingPNGFiles = "PNG Files"
55380   .PrintingProfile = "Profile"
55390   .PrintingPSDFiles = "PSD (Adobe Photoshop) Files"
55400   .PrintingPSFiles = "PostScript Files"
55410   .PrintingRAWFiles = "RAW (binary format) Files"
55420   .PrintingSave = "&Save"
55430   .PrintingStatus = "Creating file..."
55440   .PrintingSubject = "Su&bject:"
55450   .PrintingSVGFiles = "SVG Files"
55460   .PrintingTIFFFiles = "TIFF Files"
55470   .PrintingTXTFiles = "Text Files"
55480   .PrintingXCFFiles = "XCF (Gimp) Files"
55490
55500   .SaveOpenAttributes = "Attributes"
55510   .SaveOpenCancel = "Cancel"
55520   .SaveOpenFilename = "Filename"
55530   .SaveOpenOpen = "Open"
55540   .SaveOpenOpenTitle = "Open"
55550   .SaveOpenSave = "Save"
55560   .SaveOpenSaveTitle = "Save as"
55570   .SaveOpenSize = "Size"
55580
55590  End With
'---ErrPtnr-OnError-START--- DO NOT MODIFY ! ---
Exit Sub
