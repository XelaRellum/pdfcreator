...
Public Type tLanguageStrings
 ...
 OptionsLanguageInstall As String
 OptionsLanguageRefresh As String
 OptionsLanguages As String
...
Private Sub LoadOptionsStrings(ByVal Languagefile As String)
 ...
 With LanguageStrings
  ...
  .OptionsLanguageInstall = Replace$(hLang.Retrieve("LanguageInstall", .OptionsLanguageInstall),"/n",vbCrLf)
  .OptionsLanguageRefresh = Replace$(hLang.Retrieve("LanguageRefresh", .OptionsLanguageRefresh),"/n",vbCrLf)
  .OptionsLanguages = Replace$(hLang.Retrieve("Languages", .OptionsLanguages),"/n",vbCrLf)
...
Public Sub InitLanguagesStrings()
 With LanguageStrings
  ...
  .OptionsLanguageInstall = "Install"
  .OptionsLanguageRefresh = "Refresh List"
  .OptionsLanguages = "Languages"
