...
Public Const PRODUCT_UNDEFINED                        As Long = &H0  'An unknown product
Public Const PRODUCT_ULTIMATE                         As Long = &H1  'Ultimate Edition
Public Const PRODUCT_HOME_BASIC                       As Long = &H2  'Home Basic Edition
Public Const PRODUCT_HOME_PREMIUM                     As Long = &H3  'Home Premium Edition
Public Const PRODUCT_ENTERPRISE                       As Long = &H4  'Enterprise Edition
Public Const PRODUCT_HOME_BASIC_N                     As Long = &H5  'Home Basic Edition
Public Const PRODUCT_BUSINESS                         As Long = &H6  'Business Edition
Public Const PRODUCT_STANDARD_SERVER                  As Long = &H7  'Server Standard Edition (full installation)
Public Const PRODUCT_DATACENTER_SERVER                As Long = &H8  'Server Datacenter Edition (full installation)
Public Const PRODUCT_SMALLBUSINESS_SERVER             As Long = &H9  'Small Business Server
Public Const PRODUCT_ENTERPRISE_SERVER                As Long = &HA  'Server Enterprise Edition (full installation)
Public Const PRODUCT_STARTER                          As Long = &HB  'Starter Edition
Public Const PRODUCT_DATACENTER_SERVER_CORE           As Long = &HC  'Server Datacenter Edition (core installation)
Public Const PRODUCT_STANDARD_SERVER_CORE             As Long = &HD  'Server Standard Edition (core installation)
Public Const PRODUCT_ENTERPRISE_SERVER_CORE           As Long = &HE  'Server Enterprise Edition (core installation)
Public Const PRODUCT_ENTERPRISE_SERVER_IA64           As Long = &HF  'Server Enterprise Edition for Itanium-based Systems
Public Const PRODUCT_BUSINESS_N                       As Long = &H10  'Business Edition
Public Const PRODUCT_WEB_SERVER                       As Long = &H11  'Web Server Edition (full installation)
Public Const PRODUCT_CLUSTER_SERVER                   As Long = &H12  'Cluster Server Edition
Public Const PRODUCT_HOME_SERVER                      As Long = &H13  'Home Server Edition
Public Const PRODUCT_STORAGE_EXPRESS_SERVER           As Long = &H14  'Storage Server Express Edition
Public Const PRODUCT_STORAGE_STANDARD_SERVER          As Long = &H15  'Storage Server Standard Edition
Public Const PRODUCT_STORAGE_WORKGROUP_SERVER         As Long = &H16  'Storage Server Workgroup Edition
Public Const PRODUCT_STORAGE_ENTERPRISE_SERVER        As Long = &H17  'Storage Server Enterprise Edition
Public Const PRODUCT_SERVER_FOR_SMALLBUSINESS         As Long = &H18  'Server for Small Business Edition
Public Const PRODUCT_SMALLBUSINESS_SERVER_PREMIUM     As Long = &H19  'Small Business Server Premium Edition
Public Const PRODUCT_HOME_PREMIUM_N                   As Long = &H1A  'Home Premium Edition
Public Const PRODUCT_ENTERPRISE_N                     As Long = &H1B  'Enterprise Edition
Public Const PRODUCT_ULTIMATE_N                       As Long = &H1C  'Ultimate Edition
Public Const PRODUCT_WEB_SERVER_CORE                  As Long = &H1D  'Web Server Edition (core installation)
Public Const PRODUCT_MEDIUMBUSINESS_SERVER_MANAGEMENT As Long = &H1E  'Windows Essential Business Server Management Server
Public Const PRODUCT_MEDIUMBUSINESS_SERVER_SECURITY   As Long = &H1F  'Windows Essential Business Server Security Server
Public Const PRODUCT_MEDIUMBUSINESS_SERVER_MESSAGING  As Long = &H20  'Windows Essential Business Server Messaging Server
Public Const PRODUCT_STANDARD_SERVER_V                As Long = &H24  'Server Standard Edition without Hyper-V (full installation)
Public Const PRODUCT_DATACENTER_SERVER_V              As Long = &H25  'Server Datacenter Edition without Hyper-V (full installation)
Public Const PRODUCT_ENTERPRISE_SERVER_V              As Long = &H26  'Server Enterprise Edition without Hyper-V (full installation)
