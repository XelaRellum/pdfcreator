; *** Inno Setup version 5.1.11+ Corsican messages ***
;
...
AdminPrivilegesRequired=Ci vole à esse amministratore o membru di u gruppu di i "Power Users" per installà stu prugrammu.
...
ExitSetupTitle=Esce l'installazione
ExitSetupMessage=L'installazione ùn hè micca compia. S'è voi escite l'installazione avà, u prugrammu ùn serà micca installatu.%n%nCi vulerà à ripiglià l'installazione più tardi per compiella.%n%nEsce l'installazione ?
...
ToUNCPathname=Ùn hè micca pussibule d'impiegà unu caminu UNC. S'è voi vulete installà nantu à a reta, ci vole à cunnettà, primu, u lettore di reta.
...
ClickFinish=Sceglite Piantà per esce l'Assistente.
...
UninstalledMost=A disinstallazione di %1 hè compie.%n%nQualchì elementu ùn pò micca esse scacciatu. Ci vole à scacciallu manualmente.
