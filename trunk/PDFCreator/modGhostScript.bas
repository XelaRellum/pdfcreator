...
Private Function CallGhostscript(Comment As String)
 Dim LastStop As Currency, res As Boolean
 LastStop = ExactTimer_Value()
 res = CallGS(GSParams)
 IfLoggingWriteLogfile "Time for converting in seconds [" & Comment & "]: " & CStr(ExactTimer_Value() - LastStop)
End Function
...
Public Function OptimizePDF(PDFInputFilename As String, PDFOutputFilename As String) As Boolean
 Dim LastStop As Currency, tStr As String
 InitParams
 tStr = Options.DirectoryGhostscriptLibraries & ";" & Options.DirectoryGhostscriptFonts
 If LenB(LTrim(Options.DirectoryGhostscriptResource)) > 0 Then
  tStr = tStr & ";" & LTrim(Options.DirectoryGhostscriptResource)
 ...
 IfLoggingWriteLogfile "Time for optimizing in seconds: " & CStr(ExactTimer_Value() - LastStop)
End Function
    ...
    Else
     ...
     Select Case Options.PDFCompressionColorCompressionChoice
      Case 1:
       ...
       AddParamCommand ".setpdfwrite << /ColorImageDict <</QFactor 2 /Blend 1 /HSample [2 1 1 2] /VSample [2 1 1 2]>> >> setdistillerparams"
      Case 2:
       AddParams "-dColorImageFilter=/DCTEncode"
       AddParamCommand ".setpdfwrite << /ColorImageDict <</QFactor 0.9 /Blend 1 /HSample [2 1 1 2] /VSample [2 1 1 2]>> >> setdistillerparams"
      Case 3:
       AddParams "-dColorImageFilter=/DCTEncode"
       AddParamCommand ".setpdfwrite << /ColorImageDict <</QFactor 0.5 /Blend 1 /HSample [2 1 1 2] /VSample [2 1 1 2]>> >> setdistillerparams"
      Case 4:
       AddParams "-dColorImageFilter=/DCTEncode"
       AddParamCommand ".setpdfwrite << /ColorImageDict <</QFactor 0.25 /Blend 0 /HSample [1 1 1 1] /VSample [1 1 1 1]>> >> setdistillerparams"
      Case 5:
       AddParams "-dColorImageFilter=/DCTEncode"
       AddParamCommand ".setpdfwrite << /ColorImageDict <</QFactor 0.1 /Blend 0 /HSample [1 1 1 1] /VSample [1 1 1 1]>> >> setdistillerparams"
      Case 6:
    ...
    Else
     ...
     Select Case Options.PDFCompressionGreyCompressionChoice
      Case 1:
       ...
       AddParamCommand ".setpdfwrite << /GrayImageDict <</QFactor 2 /Blend 1 /HSample [2 1 1 2] /VSample [2 1 1 2]>> >> setdistillerparams"
      Case 2:
       AddParams "-dGrayImageFilter=/DCTEncode"
       AddParamCommand ".setpdfwrite << /GrayImageDict <</QFactor 0.9 /Blend 1 /HSample [2 1 1 2] /VSample [2 1 1 2]>> >> setdistillerparams"
      Case 3:
       AddParams "-dGrayImageFilter=/DCTEncode"
       AddParamCommand ".setpdfwrite << /GrayImageDict <</QFactor 0.5 /Blend 1 /HSample [2 1 1 2] /VSample [2 1 1 2]>> >> setdistillerparams"
      Case 4:
       AddParams "-dGrayImageFilter=/DCTEncode"
       AddParamCommand ".setpdfwrite << /GrayImageDict <</QFactor 0.25 /Blend 0 /HSample [1 1 1 1] /VSample [1 1 1 1]>> >> setdistillerparams"
      Case 5:
       AddParams "-dGrayImageFilter=/DCTEncode"
       AddParamCommand ".setpdfwrite << /GrayImageDict <</QFactor 0.1 /Blend 0 /HSample [1 1 1 1] /VSample [1 1 1 1]>> >> setdistillerparams"
      Case 6:
...
Public Sub CheckForStamping(Filename As String)
 ...
 If Len(StampString) > 0 Then
  ...
  StampPage = Replace(StampPage, "[STAMPSTRING]", StampString, , , vbTextCompare)
  StampPage = Replace(StampPage, "[FONTNAME]", Trim$(Options.StampFontname), , , vbTextCompare)
  StampFontsize = 48
