...
50010  Dim reg As clsRegistry, value As String, orgValue As String, PDFCreatorExePath As String
50020  WriteToLog "Start: Installation printer """ & PrinterName & """", LogFile, True
50030  PDFCreatorExePath = CompletePath(AppDir) & "PDFCreator.exe"
...
50100  End If
50110  GetMonitors
50120  If MonitorIsInstalled(Monitorname) = False Then
50130   InstallPort "pdfcmon", PDFCreatorExePath
50140   InstallMonitor Monitorname, Environment, DLLName, LogFile
50150  End If
50160  GetMonitors
50170  GetDrivers "Windows 4.0"
50180  GetDrivers "Windows NT x86"
50190  If DriverIsInstalled(Drivername) = False Then
50200   InstallDriver Drivername, LogFile
50210  End If
50220  GetPrinters
50230  If PrinterIsInstalled(PrinterName) = False Then
50240   InstallPrinter PrinterName, Drivername, PortName, LogFile
50250  End If
50260  GetPrinters
50270  If IsWinVista Then
50280   Set reg = New clsRegistry
50290   With reg
50300    .hkey = HKEY_LOCAL_MACHINE
50310    .KeyRoot = "SYSTEM\CurrentControlSet\Services"
50320    .SubKey = "Spooler"
50330    orgValue = .GetRegistryValue("RequiredPrivileges")
50340    value = orgValue
50350    If InStr(1, Replace(value, vbNullChar, " "), "SeBackupPrivilege", vbTextCompare) = 0 Then
50360     If Asc(Mid(value, Len(value), 1)) <> 0 Then
50370      value = value & vbNullChar
50380     End If
50390     value = value & "SeBackupPrivilege" & vbNullChar
50400    End If
50410    If InStr(1, Replace(value, vbNullChar, " "), "SeRestorePrivilege", vbTextCompare) = 0 Then
50420     If Asc(Mid(value, Len(value), 1)) <> 0 Then
50430      value = value & vbNullChar
50440     End If
50450     value = value & "SeRestorePrivilege" & vbNullChar
50460    End If
50470    If orgValue <> value Then
50480     Call .SetRegistryValue("RequiredPrivileges", value, REG_MULTI_SZ)
50490     'Debug.Print StopService("Spooler")
50500     'Debug.Print StartService("Spooler")
50510    End If
50520   End With
50530  End If
'---ErrPtnr-OnError-START--- DO NOT MODIFY ! ---
...
50080  GetDrivers
50090  GetPorts
50100  UnInstallMonitor Monitorname, LogFile
50110  GetMonitors
'---ErrPtnr-OnError-START--- DO NOT MODIFY ! ---
Exit Sub
ErrPtnr_OnError:
...
Private Sub InstallPort(PortName As String, PDFCreatorExePath As String)
'---ErrPtnr-OnError-START--- DO NOT MODIFY ! ---
On Error GoTo ErrPtnr_OnError
'---ErrPtnr-OnError-END--- DO NOT MODIFY ! ---
...
50060   .KeyRoot = "System\CurrentControlSet\Control\Print\Monitors\pdfcmon"
50070   If .KeyExists = False Then
50080    .CreateKey
50090   End If
50100   .SetRegistryValue "Driver", "pdfcmon.dll", REG_SZ
50110   .SetRegistryValue "PdfCreator", PDFCreatorExePath, REG_SZ
50120   .SetRegistryValue "Port", PortName, REG_SZ
50130  End With
50140  Set reg = Nothing
50150  If IsWin9xMe = True Then
50160   Call SendMessage(65535, 26, 0, PrintSystem)
50170  End If
'---ErrPtnr-OnError-START--- DO NOT MODIFY ! ---
Exit Sub
ErrPtnr_OnError:
...
50020  IsPDFCreatorPrinter = False
50030  Set PDFCreatorPrinters = GetPDFCreatorPrinters()
50040  If PDFCreatorPrinters.Count = 0 Then
50050   Exit Function
50060  End If
50070  For i = 1 To PDFCreatorPrinters.Count
50080   If StrComp(PrinterName, PDFCreatorPrinters(i), vbTextCompare) = 0 Then
50090    IsPDFCreatorPrinter = True
50100    Exit Function
50110   End If
50120  Next i
'---ErrPtnr-OnError-START--- DO NOT MODIFY ! ---
Exit Function
ErrPtnr_OnError:
Select Case ErrPtnr.OnError("modPrinter", "IsPDFCreatorPrinter")
Case 0: Resume
Case 1: Resume Next
Case 2: Exit Function
Case 3: End
...
50060  For i = 1 To Printers1.Count
50070   If StrComp("pdfcmon", Printers1(i)(1), vbTextCompare) = 0 Then
50080    AddSortedStr PDFCreatorPrinters, CStr(Printers1(i)(0))
50090   End If
50100  Next i
50110  Set GetPDFCreatorPrinters = PDFCreatorPrinters
'---ErrPtnr-OnError-START--- DO NOT MODIFY ! ---
Exit Function
ErrPtnr_OnError:
